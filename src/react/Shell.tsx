...
const TITLES: Record<string, string> = {
  ...
  '/leads': 'Leads', '/crm': 'CRM', '/links-editor': 'Links', '/link-tracker': 'Rastreador de Links', '/business': 'Negócio', '/users': 'Usuários',
...
function buildNav(role: string | undefined, modulos: string[], permissions: string[] = []): NavEntry[] {
  ...
  add({ to: '/link-tracker', label: 'Rastreador', icon: 'fa-bullseye' });
