...
const PAGE_KEYS = new Set(['orders', 'products', 'categories', 'combos', 'complementos', 'catalog-settings', 'leads', 'crm', 'campaigns', 'farmaqui', 'ecommerce', 'schedule', 'business', 'instances', 'links', 'link-tracker']);
