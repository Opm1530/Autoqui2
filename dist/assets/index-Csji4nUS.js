...
--`+d+"--",R=An.getBlob(b,i,v);if(R===null)throw Qw();const D={name:u.fullPath},L=ca(r,n.host,n._protocol),_="POST",T=n.maxUploadRetryTime,S=new vl(L,_,S_(n,t),T);return S.urlParams=D,S.headers=o,S.body=R.uploadData(),S.errorHandler=Vh(e),S}class N_{constructor(){this.sent_=!1,this.xhr_=new XMLHttpRequest,this.initXhr(),this.errorCode_=ti.NO_ERROR,this.sendPromise_=new Promise(e=>{this.xhr_.addEventListener("abort",()=>{this.errorCode_=ti.ABORT,e()}),this.xhr_.addEventListener("error",()=>{this.errorCode_=ti.NETWORK_ERROR,e()}),this.xhr_.addEventListener("load",()=>{e()})})}send(e,t,i,s,r){if(this.sent_)throw ns("cannot .send() more than once");if(Fn(e)&&i&&(this.xhr_.withCredentials=!0),this.sent_=!0,this.xhr_.open(t,e,!0),r!==void 0)for(const o in r)r.hasOwnProperty(o)&&this.xhr_.setRequestHeader(o,r[o].toString());return s!==void 0?this.xhr_.send(s):this.xhr_.send(),this.sendPromise_}getErrorCode(){if(!this.sent_)throw ns("cannot .getErrorCode() before sending");return this.errorCode_}getStatus(){if(!this.sent_)throw ns("cannot .getStatus() before sending");try{return this.xhr_.status}catch{return-1}}getResponse(){if(!this.sent_)throw ns("cannot .getResponse() before sending");return this.xhr_.response}getErrorText(){if(!this.sent_)throw ns("cannot .getErrorText() before sending");return this.xhr_.statusText}abort(){this.xhr_.abort()}getResponseHeader(e){return this.xhr_.getResponseHeader(e)}addUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.addEventListener("progress",e)}removeUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.removeEventListener("progress",e)}}class M_ extends N_{initXhr(){this.xhr_.responseType="text"}}function bl(){return new M_}class hi{constructor(e,t){this._service=e,t instanceof At?this._location=t:this._location=At.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new hi(e,t)}get root(){const e=new At(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return $h(this._location.path)}get storage(){return this._service}get parent(){const e=w_(this._location.path);if(e===null)return null;const t=new At(this._location.bucket,e);return new hi(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw Xw(e)}}function O_(n,e,t){n._throwIfRoot("uploadBytes");const i=$_(n.storage,n._location,Nh(),new An(e,!0),t);return n.storage.makeRequestWithTokens(i,bl).then(s=>({metadata:s,ref:n}))}function V_(n){n._throwIfRoot("getDownloadURL");const e=P_(n.storage,n._location,Nh());return n.storage.makeRequestWithTokens(e,bl).then(t=>{if(t===null)throw Yw();return t})}function B_(n){n._throwIfRoot("deleteObject");const e=R_(n.storage,n._location);return n.storage.makeRequestWithTokens(e,bl)}function F_(n,e){const t=__(n._location.path,e),i=new At(n._location.bucket,t);return new hi(n.storage,i)}function U_(n){return/^[A-Za-z]+:\/\//.test(n)}function z_(n,e){return new hi(n,e)}function Fh(n,e){if(n instanceof wl){const t=n;if(t._bucket==null)throw Kw();const i=new hi(t,t._bucket);return e!=null?Fh(i,e):i}else return e!==void 0?F_(n,e):n}function j_(n,e){if(e&&U_(e)){if(n instanceof wl)return z_(n,e);throw fo("To use ref(service, url), the first argument must be a Storage instance.")}else return Fh(n,e)}function Fd(n,e){const t=e?.[Ah];return t==null?null:At.makeFromBucketSpec(t,n)}function q_(n,e,t,i={}){n.host=`${e}:${t}`;const s=Fn(e);s&&(go(`https://${n.host}/b`),yo("Storage",!0)),n._isUsingEmulator=!0,n._protocol=s?"https":"http";const{mockUserToken:r}=i;r&&(n._overrideAuthToken=typeof r=="string"?r:cu(r,n.app.options.projectId))}class wl{constructor(e,t,i,s,r,o=!1){this.app=e,this._authProvider=t,this._appCheckProvider=i,this._url=s,this._firebaseVersion=r,this._isUsingEmulator=o,this._bucket=null,this._host=kh,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=Ow,this._maxUploadRetryTime=Vw,this._requests=new Set,s!=null?this._bucket=At.makeFromBucketSpec(s,this._host):this._bucket=Fd(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,this._url!=null?this._bucket=At.makeFromBucketSpec(this._url,e):this._bucket=Fd(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){Bd("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){Bd("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(t!==null)return t.accessToken}return null}async _getAppCheckToken(){if(Tt(this.app)&&this.app.settings.appCheckToken)return this.app.settings.appCheckToken;const e=this._appCheckProvider.getImmediate({optional:!0});return e?(await e.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(e=>e.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new hi(this,e)}_makeRequest(e,t,i,s,r=!0){if(this._deleted)return new Zw(Sh());{const o=d_(e,this._appId,i,s,t,this._firebaseVersion,r,this._isUsingEmulator);return this._requests.add(o),o.getPromise().then(()=>this._requests.delete(o),()=>this._requests.delete(o)),o}}async makeRequestWithTokens(e,t){const[i,s]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,i,s).getPromise()}}const Ud="@firebase/storage",zd="0.14.0";const Uh="storage";function Li(n,e,t){return n=Oe(n),O_(n,e,t)}function ni(n){return n=Oe(n),V_(n)}function H_(n){return n=Oe(n),B_(n)}function ln(n,e){return n=Oe(n),j_(n,e)}function W_(n=_o(),e){n=Oe(n);const i=Fr(n,Uh).getImmediate({identifier:e}),s=au("storage");return s&&G_(i,...s),i}function G_(n,e,t,i={}){q_(n,e,t,i)}function K_(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),i=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new wl(t,i,s,e,mi)}function Q_(){si(new Dn(Uh,K_,"PUBLIC").setMultipleInstances(!0)),Gt(Ud,zd,""),Gt(Ud,zd,"esm2020")}Q_();const zh={apiKey:"AIzaSyAOV2Dz0mrJAIT2DLQsrLCTC2bLO7lkzmI",authDomain:"conectacidade-5e46d.firebaseapp.com",projectId:"conectacidade-5e46d",storageBucket:"conectacidade-5e46d.firebasestorage.app",messagingSenderId:"740343372037",appId:"1:740343372037:web:a74dcf684844bc9167ff6c",measurementId:"G-GH3W7LBTWZ"},_l=wo(zh),Va=Ku(_l),Nt=yw(_l),cn=W_(_l),F={async create(n,e){const t=di(Nt,n);return(await Mw(t,{...e,createdAt:ye.now()})).id},async set(n,e,t){const i=us(Nt,n,e);await Dw(i,{...t,createdAt:ye.now()})},async getAll(n,e){const t=di(Nt,n);let i=pi(t);return e&&(i=pi(t,Xn(e.field,e.operator,e.value))),(await Lw(i)).docs.map(r=>({id:r.id,...r.data()}))},async get(n,e){const t=us(Nt,n,e),i=await Rw(t);return i.exists()?{id:i.id,...i.data()}:null},async update(n,e,t){const i=us(Nt,n,e);await $w(i,t)},async delete(n,e){const t=us(Nt,n,e);await Nw(t)}},Y_=Object.freeze(Object.defineProperty({__proto__:null,dbService:F},Symbol.toStringTag,{value:"Module"}));class J_{currentUser=null;listeners=[];constructor(){Jg(Va,async e=>{if(e)if(e.email==="ginannymoreira@gmail.com")this.currentUser={uid:e.uid,email:e.email,role:"admin"};else try{const t=await F.get("users",e.uid);if(t){const i=t;if(i.companyId){const r=await F.get("companies",i.companyId);if(r&&r.status==="inactive"){await this.logout();const{toast:o}=await za(async()=>{const{toast:l}=await Promise.resolve().then(()=>jd);return{toast:l}},void 0);o.error("Seu acesso de cliente foi desativado. Entre em contato com o administrador.");return}}this.currentUser={uid:e.uid,email:e.email,role:i.role,companyId:i.companyId,storeId:i.storeId,storeIds:i.storeIds}}else{console.warn("User authenticated but not found in DB",e.uid),await this.logout();const{toast:i}=await za(async()=>{const{toast:s}=await Promise.resolve().then(()=>jd);return{toast:s}},void 0);i.error("Sua conta não foi encontrada ou foi removida."),this.currentUser=null}}catch(t){console.error("Error fetching user profile:",t),this.currentUser=null}else this.currentUser=null;this.notifyListeners()})}async login(e,t){await Kg(Va,e,t)}async logout(){await Xg(Va)}async registerUser(e,t){const i=wo(zh,"Secondary"),s=Ku(i);return(await Gg(s,e,t)).user.uid}getCurrentUser(){return this.currentUser}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}notifyListeners(){this.listeners.forEach(e=>e(this.currentUser))}}const ke=new J_,X_=async()=>{const n=ke.getCurrentUser();let e=!1,t=!1,i=!1,s=!1;if(n&&n.companyId)try{const l=(await F.get("companies",n.companyId))?.modulos_ativos||["atendimento"];l.includes("venda")&&(e=!0),l.includes("agendamento")&&(t=!0),l.includes("disparo")&&(i=!0),l.includes("venda_catalogo")&&(s=!0)}catch(r){console.error("Error fetching company for sidebar:",r)}return s?`
    ...
    `;async function s(r,o){const l=document.getElementById("store-statuses-container");if(l)try{const u=await F.get("companies",r);let m=u?.stores||[];const v=await F.getAll("instancias",{field:"empresaId",operator:"==",value:r});if(o.role!=="owner"){const D=o.storeIds||(o.storeId?[o.storeId]:[]);m=m.filter(L=>D.includes(L.id))}if(m.length===0){l.innerHTML=`
                ...
                `;return}let R="";for(const D of m){let L="",_=!1;const T=(D.instancia_id?v.find(A=>A.id===D.instancia_id):null)||v.find(A=>A.lojaId===D.id),S=T?.nome;if(!T||D.active===!1)L=`
                    ...
                    `;else try{const A=await ut.getInstanceStatus(S);if(["open","connected","CONNECTED","ON"].includes(A.state))_=!0,L=`
                            ...
                            `;else{const g=await ut.getQRCode(S);L=`
                                <div style="background: rgba(239, 68, 68, 0.1); padding: 1rem; border-radius: 8px; border-left: 4px solid var(--danger); margin-bottom: 1rem;">
                            ...
                            `}}catch(A){console.error("Error checking instance status in dashboard:",A),L=`
                        ...
                        `}const $=D.frete_ativo!==!1,C=T&&D.active!==!1;R+=`
                ...
                `}if(o.role==="owner"||o.role==="admin"){const D=m.map(S=>S.instancia_id).filter(S=>!!S),L=v.filter(S=>S.lojaId).map(S=>S.id),_=new Set([...D,...L]),T=v.filter(S=>!_.has(S.id));if(T.length>0){R+=`
                    ...
                    `;for(const S of T){let $=!1;try{$=(await ut.getInstanceStatus(S.nome)).connected}catch{}R+=`
        ...
        </span>`:`<span class="badge secondary" style="font-size: 0.7rem; padding: 0.2rem 0.5rem;">${n}</span>`}const lx=async()=>{const n=ke.getCurrentUser();if(!n||!n.companyId)return"<p>Usuário sem empresa.</p>";let e=await F.getAll("pedidos",{field:"empresaId",operator:"==",value:n.companyId});e.sort((A,k)=>{const f=(A.criadoEm?.toDate?.()||new Date(A.criadoEm||0)).getTime();return(k.criadoEm?.toDate?.()||new Date(k.criadoEm||0)).getTime()-f});let i=(await F.get("companies",n.companyId))?.stores||[];if(n.role!=="owner"){const A=n.storeIds||(n.storeId?[n.storeId]:[]);i=i.filter(k=>A.includes(k.id)),e=e.filter(k=>A.includes(k.lojaId))}const s=await F.getAll("leads",{field:"empresaId",operator:"==",value:n.companyId}),r=await F.getAll("loja_config",{field:"empresaId",operator:"==",value:n.companyId}),o=A=>{const k=i.find(f=>f.id===A);return k?k.name:A||"-"},l=A=>{const k=i.find(g=>g.id===A);if(k&&k.active!==!1&&k.instancia_id)return!0;const f=r.find(g=>g.lojaId===A);return f?!!f.instancia_id:!1},d=(A,k)=>{if(k)return k;const f=s.find(g=>g.id===A);return f?f.nome||f.name||"Cliente":A||"Cliente"},u=A=>(s.find(f=>f.id===A)?.telefone||"").split("@")[0];let m="todos";const b=A=>A==="todos"?e:e.filter(k=>(k.status||"em_montagem").toLowerCase()===A),v=A=>A.length===0?'<tr><td colspan="8" style="text-align:center;padding:2.5rem;color:var(--text-muted);">Nenhum pedido encontrado.</td></tr>':A.map(k=>{const f=(k.status||"em_montagem").toLowerCase();return`
            ...
            </tr>`}).join(""),R=A=>{const k=A==="todos"?e.length:e.filter(f=>(f.status||"em_montagem").toLowerCase()===A).length;return`<span class="filter-count" id="count-${A}">${k}</span>`};return setTimeout(()=>D(),100),`
    ...
    `;function D(){const A=di(Nt,"pedidos"),k=pi(A,Xn("empresaId","==",n.companyId));window._ordersUnsubscribe&&window._ordersUnsubscribe();const f=Ps(k,w=>{if(e=w.docs.map(I=>({id:I.id,...I.data()})),n.role!=="owner"){const I=n.storeIds||(n.storeId?[n.storeId]:[]);e=e.filter(E=>I.includes(E.lojaId))}e.sort((I,E)=>{const P=(I.criadoEm?.toDate?.()||new Date(I.criadoEm||0)).getTime();return(E.criadoEm?.toDate?.()||new Date(E.criadoEm||0)).getTime()-P});const h=document.getElementById("orders-tbody");h&&(h.innerHTML=v(b(m)),L()),Gd.forEach(I=>{const E=document.getElementById(`count-${I.key}`);if(E){const P=I.key==="todos"?e.length:e.filter(N=>(N.status||"em_montagem").toLowerCase()===I.key).length;E.textContent=P.toString()}})});window._ordersUnsubscribe=f,document.querySelectorAll("#orders-filter-bar .filter-btn").forEach(w=>{w.addEventListener("click",()=>{document.querySelectorAll("#orders-filter-bar .filter-btn").forEach(I=>I.classList.remove("active")),w.classList.add("active"),m=w.dataset.filter||"todos";const h=document.getElementById("orders-tbody");h&&(h.innerHTML=v(b(m))),L()})}),L();const g=document.getElementById("order-detail-modal");g?.addEventListener("click",w=>{w.target===g&&g.classList.add("hidden")}),document.getElementById("orders-filter-bar")?.parentElement?.parentElement?.addEventListener("click",async w=>{const h=w.target.closest(".view-comprovante-btn");if(h){w.preventDefault(),w.stopPropagation();const I=h.dataset.path;if(!I)return;const E=h.innerHTML;h.disabled=!0,h.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{let P=I;if(!I.startsWith("http")){const N=ln(cn,I);P=await ni(N)}window.open(P,"_blank")}catch(P){console.error("Erro ao abrir comprovante:",P),B.error("Não foi possível carregar o comprovante do storage.")}finally{h.disabled=!1,h.innerHTML=E}}})}function L(){document.querySelectorAll(".action-btn.view").forEach(A=>{A.addEventListener("click",()=>{const k=A.dataset.id,f=e.find(g=>g.id===k);f&&_(f)})})}async function _(A){const k=document.getElementById("order-detail-modal"),f=document.getElementById("order-modal-inner");if(!k||!f)return;const g=A.empresaId||ke.getCurrentUser()?.companyId;if(g&&Array.isArray(A.itens))try{const G=await F.getAll("products",{field:"companyId",operator:"==",value:g});let Y=!1;if(A.itens.forEach(ne=>{const he=(ne.item||"").toLowerCase().trim(),le=G.find(pe=>(pe.name||"").toLowerCase().trim()===he);if(le){const pe=le.promotionalActive&&le.promotionalPrice||le.price;(!ne.preco||ne.preco===0)&&(ne.preco=pe,Y=!0)}}),Y){let ne=0;A.itens.forEach(le=>{const pe=parseFloat(le.preco)||0,xe=parseInt(le.quantidade)||1;ne+=xe*pe});const he=parseFloat(A.valoresAdicionais)||0;A.value=ne+he}}catch(G){console.error("Error syncing prices with catalog:",G)}const y=(A.status||"em_montagem").toLowerCase(),w=y==="finalizado"||y==="cancelado",h=d(A.leadId,A.nome||A.leadName),I=u(A.leadId),E=l(A.lojaId),P=Array.isArray(A.itens)?A.itens.map((G,Y)=>`
                <div class="order-item-row" style="display: flex; justify-content: space-between; align-items: center; padding: 0.8rem 1.25rem; border-bottom: 1px solid rgba(255,255,255,0.05);">
                    <div style="flex: 1; padding-right: 15px;">
                        <span style="font-weight: 600; color: var(--text-main); display: block;">${G.quantidade}x ${G.item}</span>
                        ${G.observacao?`<small style="color: var(--text-dim); display: block; margin-top: 2px;">Obs: ${G.observacao}</small>`:""}
                    </div>
                    ${y==="em_montagem"?`
                        <div style="display:flex;align-items:center;gap:0.75rem; flex-shrink: 0;">
                            <span style="color:var(--text-dim);font-size:0.8rem; font-weight: 600;">R$</span>
                            <input type="number" class="item-price-input" data-index="${Y}" value="${G.preco||0}"
                    ...
                    `:`
                        <span style="color:var(--primary);font-weight:700; font-size: 1rem;">R$ ${(G.preco||0).toFixed(2)}</span>
                    `}
                </div>
            `).join(""):'<p style="color:var(--text-muted); padding: 1.5rem; text-align: center;">Sem itens listados.</p>',N=y==="em_montagem"?`
            <div class="order-item-row" style="margin-top:0.5rem; border-top: 1px solid var(--border-color); padding: 1.25rem; background: rgba(99, 102, 241, 0.03);">
                ...
                <div style="display:flex;align-items:center;gap:0.75rem; flex-shrink: 0;">
                    <span style="color:var(--text-dim);font-size:0.8rem; font-weight: 600;">R$</span>
                    <input type="number" id="detail-additional-value" value="${A.valoresAdicionais||0}"
                        step="0.01" style="width:100px;background:var(--bg-color);border:1px solid var(--border-color);color:white;padding:0.5rem 0.75rem;border-radius:8px;text-align:right;font-size:0.95rem; font-family: monospace; outline: none;">
                </div>
            </div>
        `:A.valoresAdicionais?`
            <div class="order-item-row" style="margin-top:0.5rem; border-top: 1px solid var(--border-color); padding: 1rem 1.25rem;">
                ...
                <span style="color:var(--primary);font-weight:700;">R$ ${(A.valoresAdicionais||0).toFixed(2)}</span>
            </div>
        `:"",z=T(A,y),j=w?"":`
            ...
            <div class="lead-modal-badges">
                ...
                <div class="lead-badge-group">
                    ...
                    <span class="badge secondary">${o(A.lojaId)}</span>
                </div>
                <div class="lead-badge-group">
                    <span class="badge-label">Data</span>
                    <span class="badge secondary" style="font-size:0.78rem;">${Wd(A.criadoEm||A.createdAt)}</span>
                </div>
                <div class="lead-badge-group">
                    <span class="badge-label">${A.source==="catalog"?"Modo de Envio":"Tipo"}</span>
                    ${Kd(A.entrega||"entrega")}
                </div>
            </div>
            ...
            <div class="lead-modal-body">
                ...
                <div class="lead-info-grid">
                    ...
                    <div class="lead-info-item">
                        ...
                        <span class="lead-info-value">${Qd(A.pagamento||A.formaPagamento,A.comprovanteUrl,A.empresaId)}</span>
                    </div>
                    ${A.source==="catalog"?A.entrega==="retirada"?`
        ...
        `,k.classList.remove("hidden"),S(k,A,y)}function T(A,k){const f=A.entrega==="retirada",g=(A.pagamento||A.formaPagamento||"").toLowerCase(),y=g.includes("entrega")||g.includes("dinheiro")||g.includes("maquininha");switch(k){case"em_montagem":return`
                    ...
                    </button>`;default:return""}}function S(A,k,f){const g=f==="finalizado"||f==="cancelado";if(document.getElementById("close-order-modal")?.addEventListener("click",()=>{A.classList.add("hidden")}),f==="em_montagem"){const z=G=>{const Y=parseFloat(G);return isNaN(Y)?0:Y},j=()=>{let G=0;document.querySelectorAll(".item-price-input").forEach(he=>{const le=parseInt(he.dataset.index),pe=k.itens[le]?.quantidade||1;G+=pe*z(he.value)});const Y=z(document.getElementById("detail-additional-value")?.value);G+=Y;const ne=document.getElementById("detail-order-total");ne&&(ne.innerText=`R$ ${G.toFixed(2)}`)};document.querySelectorAll(".item-price-input").forEach(G=>{G.addEventListener("input",j)}),document.getElementById("detail-additional-value")?.addEventListener("input",j),j()}if(g)return;const y=document.getElementById("order-menu-trigger"),w=document.getElementById("order-dropdown");y?.addEventListener("click",z=>{z.stopPropagation(),w?.classList.toggle("hidden")}),document.addEventListener("click",()=>w?.classList.add("hidden"),{once:!0}),w?.querySelectorAll(".lead-dropdown-item").forEach(z=>{z.addEventListener("click",async()=>{w.classList.add("hidden"),z.dataset.menuAction==="atendimento_humano"&&await $(k)})});const h=document.getElementById("btn-intervir"),I=document.getElementById("intervir-area");h?.addEventListener("click",()=>{if(I){const z=I.style.display==="none";I.style.display=z?"block":"none",z&&document.getElementById("intervir-text")?.focus()}}),document.getElementById("btn-intervir-cancel")?.addEventListener("click",()=>{I&&(I.style.display="none");const z=document.getElementById("intervir-text");z&&(z.value="")}),document.getElementById("btn-intervir-send")?.addEventListener("click",async()=>{const z=document.getElementById("intervir-text"),j=z?.value.trim();if(!j){B.warning("Digite uma mensagem antes de enviar.");return}const G=document.getElementById("btn-intervir-send");G.disabled=!0,G.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Enviando...';try{let Y=k.instancia;Y||(Y=(await F.get("companies",n.companyId))?.whatsappInstance?.instanceName||"");const ne=u(k.leadId)||k.leadId;await Jn.sendInterventionMessage(n.companyId,k.leadId,Y,ne,j),B.success("Mensagem enviada com sucesso!"),z.value="",I&&(I.style.display="none")}catch{B.error("Erro ao enviar mensagem."),G.disabled=!1,G.innerHTML='<i class="fa-solid fa-paper-plane"></i> Enviar Mensagem'}});const E=document.getElementById("btn-main-action");E?.addEventListener("click",async()=>{const z=E.dataset.target;if(!z)return;let j="",G="";switch(z){case"aguardando_pagamento":j="Aceitar Pedido",G=`Deseja aceitar o pedido #${k.id.slice(-6).toUpperCase()}?`;break;case"em_preparo":j="Confirmar Pagamento",G="Confirmar que o pagamento foi recebido?";break;case"pedido_pronto":j="Pedido Pronto",G="Marcar pedido como pronto para retirada?";break;case"saiu_para_entrega":j="Saiu para Entrega",G="Marcar pedido como saiu para entrega?";break;case"finalizado":j="Pedido Entregue",G="Marcar pedido como entregue e finalizado?";break}if(await Qe.warning(j,G)){E.disabled=!0,E.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Processando...';try{let ne;if(f==="em_montagem"){const he=He=>{const We=parseFloat(He);return isNaN(We)?0:We};let le=0;const pe=Array.isArray(k.itens)?[...k.itens]:[];document.querySelectorAll(".item-price-input").forEach(He=>{const We=parseInt(He.dataset.index),Je=pe[We]?.quantidade||1,lt=he(He.value);pe[We]&&(pe[We].preco=lt),le+=Je*lt});const xe=he(document.getElementById("detail-additional-value")?.value);le+=xe,ne={value:le,total:le,itens:pe,valoresAdicionais:xe}}z==="em_preparo"&&(ne={...ne,manuallyConfirmed:!0}),await Jn.updateOrderStatus(k,n.companyId,z,void 0,ne),k.status=z,C(k),B.success("Pedido atualizado com sucesso!"),_(k)}catch{B.error("Erro ao atualizar pedido."),E.disabled=!1}}});const P=document.getElementById("btn-cancel"),N=document.getElementById("cancel-container");P?.addEventListener("click",async()=>{if(P.dataset.stage==="confirm"){const z=document.getElementById("cancel-reason")?.value.trim();if(!z){B.warning("Informe o motivo do cancelamento.");return}if(!await Qe.danger("Cancelar Pedido","Tem certeza que deseja cancelar este pedido?"))return;P.disabled=!0,P.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Cancelando...';try{await Jn.updateOrderStatus(k,n.companyId,"cancelado",z),k.status="cancelado",C(k),B.success("Pedido cancelado."),_(k)}catch{B.error("Erro ao cancelar pedido."),P.disabled=!1}}else P.dataset.stage="confirm",P.innerHTML='<i class="fa-solid fa-circle-exclamation"></i> Confirmar Cancelamento',N&&(N.style.display="block",document.getElementById("cancel-reason")?.focus())})}async function $(A){if(await Qe.warning("Ativar Atendimento Humano","Deseja ativar atendimento humano para o lead deste pedido ? O status do pedido não será alterado."))try{await Jn.activateHumanSupport(A.leadId),B.success("Atendimento humano ativado para o lead!")}catch{B.error("Erro ao ativar atendimento humano.")}}function C(A){const k=e.findIndex(g=>g.id===A.id);k>=0&&(e[k]={...e[k],...A});const f=document.getElementById("orders-tbody");f&&(f.innerHTML=v(b(m))),L()}},or=n=>n.imageUrl?n.imageUrl:n.imagemPath&&n.downloadToken?`https://firebasestorage.googleapis.com/v0/b/conectacidade-5e46d.firebasestorage.app/o/${encodeURIComponent(n.imagemPath)}?alt=media&token=${n.downloadToken}`:null,cx=async()=>{const n=ke.getCurrentUser();if(!n||!n.companyId)return"<p>Usuário sem empresa.</p>";const t=await F.get("companies",n.companyId),i=t?.modulos_ativos||[],s=i.includes("venda")||i.includes("agendamento")||i.includes("venda_catalogo"),r=i.includes("agendamento"),o=r?"Serviço":"Produto",l=r?"Serviços":"Produtos";let d=t?.stores||[];const u=n.role?.toLowerCase()==="owner",m=n.storeIds||(n.storeId?[n.storeId]:[]);u||(d=d.filter(P=>m.includes(P.id)));let b=u?"all":m.length===1?m[0]:"employee_all",v=new Map,R=null;if(!s)return`
            <div class="card">
        ...
        `;let D=await F.getAll("products",{field:"companyId",operator:"==",value:n.companyId}),L=await F.getAll("categories",{field:"companyId",operator:"==",value:n.companyId});const _=P=>{const N=P.storeIds||(P.storeId?[P.storeId]:[]);return N.length===0?"Sem Loja":N.map(z=>{const j=d.find(G=>G.id===z);return j?j.name:"Desconhecida"}).join(", ")},T=()=>{let P=D;return b!=="all"&&b!=="employee_all"?P=D.filter(N=>N.storeIds&&N.storeIds.includes(b)||N.storeId===b):b==="employee_all"&&(P=D.filter(N=>N.storeIds&&N.storeIds.some(z=>m.includes(z))||N.storeId&&m.includes(N.storeId))),P.length===0?`<tr><td colspan="7" style="text-align:center">Nenhum ${o.toLowerCase()} encontrado.</td></tr>`:P.map(N=>`
            <tr data-product-id="${N.id}">
                <td><input type="checkbox" class="product-checkbox" data-id="${N.id}" onchange="window.updateBulkBar()"></td>
                <td>
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ${or(N)?`<img src="${or(N)}" style="width: 40px; height: 40px; object-fit: cover; border-radius: 4px;">`:'<div style="width: 40px; height: 40px; background: #333; border-radius: 4px; display: flex; align-items: center; justify-content: center;"><i class="fa-solid fa-box"></i></div>'}
                        <span style="font-weight: 600;">${N.name}</span>
                    </div>
                </td>
                <td><div style="max-width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="${_(N)}">${_(N)}</div></td>
                <td>R$ ${N.price?.toFixed(2)}</td>
                <td>
                    ${N.stock===null||N.stock===void 0?'<span class="badge info" title="Sem controle">&#8734; Ilimitado</span>':N.stock>10?`<span class="badge success">${N.stock} un.</span>`:N.stock>0?`<span class="badge" style="background:rgba(234,179,8,0.15);color:#eab308;border:1px solid rgba(234,179,8,0.3);">${N.stock} un.</span>`:'<span class="badge danger">Esgotado</span>'}
                </td>
                <td><span class="badge ${N.active?"success":"danger"}">${N.active?"Ativo":"Inativo"}</span></td>
                <td>
                    <div class="actions">
                        <button class="action-btn" onclick="window.editProduct('${N.id}')" title="Editar"><i style="color: #FFF;" class="fa-solid fa-pen-to-square"></i></button>
                        <button class="action-btn" onclick="window.toggleProductStatus('${N.id}', ${N.active})" title="${N.active?"Desativar":"Ativar"}">${N.active?'<i style="color: #FFF;" class="fa-solid fa-ban"></i>':'<i style="color: #FFF;" class="fa-solid fa-check"></i>'}</button>
                        <button class="action-btn" onclick="window.deleteProduct('${N.id}')" title="Excluir"><i style="color: #FFF;" class="fa-solid fa-trash"></i></button>
                    </div>
                </td>
            </tr>
        `).join("")},S=()=>{const P=document.querySelector(".data-table tbody");P&&(P.innerHTML=T(),$())},$=()=>{const P=document.querySelectorAll(".product-checkbox:checked"),N=document.getElementById("bulk-actions-container"),z=document.getElementById("bulk-count");N&&z&&(P.length>0?(N.classList.remove("hidden"),z.innerText=`${P.length} item(ns) selecionado(s)`):N.classList.add("hidden"))},C=()=>{const P='<option value="">Sem Categoria</option>'+L.map(N=>`<option value="${N.id}">${N.name}</option>`).join("");document.querySelectorAll(".item-category, #bulk-assign-cat").forEach(N=>{const z=N.value;N.innerHTML=P,N.value=z})},A=()=>{const P=document.getElementById("categories-list");if(P){if(L.length===0){P.innerHTML='<p style="text-align:center; color:var(--text-dim);">Nenhuma categoria criada.</p>';return}P.innerHTML=L.map(N=>`
            <div class="category-item">
                <div style="display:flex; align-items:center; gap:10px;">
                    <i class="fa-solid ${N.icon}" style="color:var(--primary); width:20px; text-align:center;"></i>
                    <span id="cat-name-text-${N.id}">${N.name}</span>
                </div>
                <div style="display:flex; gap:5px;">
                    <button class="action-btn" style="background:rgba(255,255,255,0.05); border:1px solid var(--border-color);" onclick="window.openEditCategoryModal('${N.id}', '${N.name.replace(/'/g,"\\'")}')"><i class="fa-solid fa-pen"></i></button>
                    <button class="action-btn" style="background:rgba(239,68,68,0.1); border:1px solid rgba(239,68,68,0.2); color:#ef4444;" onclick="window.deleteCategory('${N.id}')"><i class="fa-solid fa-trash"></i></button>
                </div>
            </div>
        `).join("")}},k=P=>{const N=document.getElementById("catalog-link-container"),z=document.getElementById("catalog-url-display"),j=document.getElementById("btn-open-catalog");if(!(!N||!z||!j))if(P==="all"||P==="employee_all")N.classList.add("hidden");else{const G=`${window.location.origin}/catalog/${P}`;z.value=G,j.href=G,N.classList.remove("hidden")}},f=async(P,N)=>{const z=`img_${Date.now()}_${Math.random().toString(36).substr(2,5)}`,j=ln(cn,`products/${N}/${z}_${P.name}`);await Li(j,P);const G=await ni(j),Y=new URL(G);return{imagemPath:j.fullPath,downloadToken:Y.searchParams.get("token")||""}},g=(P,N="",z="",j=null,G=!1,Y="",ne="",he="",le=null)=>{const pe=L.map(xe=>`<option value="${xe.id}" ${xe.id===he?"selected":""}>${xe.name}</option>`).join("");return`
                 ...
                 <div class="item-details">
                    <div class="input-row">
                        <div class="field">
                            ...
                            <input type="text" name="name-${P}" value="${N}" class="item-name" placeholder="${r?"Ex: Corte de Cabelo":"Ex: Tênis Esportivo Nitro"}" required>
                        </div>
                        <div class="field price-field">
                            <label>Preço (R$)</label>
                            <input type="number" name="price-${P}" value="${z}" class="item-price" placeholder="0,00" step="0.01" required>
                        </div>
                    </div>
                    ...
                    <div class="input-row" style="margin-top: 12px;">
                        ...
                        <div class="field price-field">
                            ...
                            <input type="number" name="stock-${P}" value="${le??""}" class="item-stock" placeholder="Ilimitado" min="0" step="1">
                        </div>
                    </div>
                    ...
                    <div class="promotional-section" style="margin-top: 15px; padding-top: 10px; border-top: 1px dashed var(--border-color);">
                        <label class="promotional-toggle" style="display: flex; align-items: center; gap: 8px; cursor: pointer; color: var(--primary); font-weight: 600; font-size: 0.85rem;">
                            <input type="checkbox" name="promotional-active-${P}" class="promotional-checkbox" ${G?"checked":""} style="width: 16px; height: 16px;">
                            <i class="fa-solid fa-tag"></i> Ativar Promoção
                        </label>
                        
                        <div class="promotional-fields ${G?"":"hidden"}" id="promotional-fields-${P}" style="margin-top: 10px; border-radius: 8px; background: rgba(99, 102, 241, 0.05); padding: 12px; border: 1px solid rgba(99, 102, 241, 0.2);">
                            <div class="input-row">
                                <div class="field">
                                    <label>Título da Promoção</label>
                                    <input type="text" name="promotional-name-${P}" value="${Y}" placeholder="Ex: Oferta Relâmpago!" class="promotional-name-input">
                                </div>
                                <div class="field price-field">
                                    <label>Preço Promo (R$)</label>
                                    <input type="number" name="promotional-price-${P}" value="${ne}" placeholder="0,00" step="0.01" class="promotional-price-input">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        `},y=P=>{const N=document.querySelector(`#card-${P} .btn-change-img`),z=document.getElementById(`file-${P}`);N&&z&&(N.addEventListener("click",()=>z.click()),z.addEventListener("change",()=>{if(z.files&&z.files[0]){const Y=z.files[0];v.set(P,Y);const ne=new FileReader;ne.onload=he=>{const le=document.getElementById(`preview-wrapper-${P}`);le&&(le.innerHTML=`<img src="${he.target?.result}" class="preview-img">
                                                 <div class="upload-progress-overlay hidden" id="progress-${P}"><div class="spinner-small"></div></div>`)},ne.readAsDataURL(Y)}}));const j=document.querySelector(`input[name="promotional-active-${P}"]`),G=document.getElementById(`promotional-fields-${P}`);j&&G&&j.addEventListener("change",()=>{j.checked?G.classList.remove("hidden"):G.classList.add("hidden")})},w=P=>{const N=document.getElementById("products-list-container"),z=document.getElementById("empty-list-msg");!N||!z||Array.from(P).forEach(j=>{const G=`prod_${Date.now()}_${Math.random().toString(36).substr(2,5)}`;v.set(G,j);const Y=j.name.replace(/\.[^/.]+$/,"").replace(/-|_/g," "),ne=g(G,Y,"");N.insertAdjacentHTML("beforeend",ne),z.style.display="none",y(G);const he=new FileReader;he.onload=le=>{const pe=document.getElementById(`preview-wrapper-${G}`);pe&&(pe.innerHTML=`<img src="${le.target?.result}" class="preview-img">
                                          <div class="upload-progress-overlay hidden" id="progress-${G}"><div class="spinner-small"></div></div>`)},he.readAsDataURL(j)})};window.editProduct=async P=>{const N=D.find(z=>z.id===P);if(N){R=P,v.clear(),document.getElementById("modal-title").innerText=`Editar ${o}`,document.getElementById("bulk-upload-section").style.display="none",u&&document.querySelectorAll('#multi-store-container input[type="checkbox"]').forEach(Y=>{Y.checked=(N.storeIds||[]).includes(Y.value)});const z=document.getElementById("products-list-container"),j=document.getElementById("empty-list-msg");if(z&&j){z.innerHTML="",j.style.display="none";const G=or(N);z.innerHTML=g("edit-item",N.name,N.price,G,N.promotionalActive,N.promotionalName,N.promotionalPrice,N.categoryId,N.stock),setTimeout(()=>y("edit-item"),0)}document.getElementById("product-modal").classList.remove("hidden")}},window.toggleProductStatus=async(P,N)=>{try{await F.update("products",P,{active:!N});const z=D.find(j=>j.id===P);z&&(z.active=!N),S(),B.success(`${o} ${N?"desativado":"ativado"} com sucesso!`)}catch(z){B.error("Erro ao atualizar status: "+z)}},window.deleteProduct=async P=>{if(await Qe.danger(`Excluir ${o}`,`Tem certeza que deseja EXCLUIR este ${o.toLowerCase()}? Esta ação não pode ser desfeita.`))try{const z=D.find(j=>j.id===P);if(z){const j=or(z),G=z.imagemPath;if(j||G)try{const Y=G?ln(cn,G):ln(cn,j);await H_(Y)}catch(Y){console.warn("Could not delete image from storage:",Y)}}await F.delete("products",P),D=D.filter(j=>j.id!==P),S(),B.success(`${o} excluído com sucesso!`)}catch(z){B.error("Erro ao excluir: "+z)}},window.openProductModal=()=>{R=null,v.clear();const P=document.getElementById("modal-title"),N=document.getElementById("bulk-upload-section"),z=document.getElementById("products-list-container"),j=document.getElementById("empty-list-msg");P&&(P.innerText=`Adicionar ${l}`),N&&(N.style.display="block"),z&&(z.innerHTML=""),j&&(j.style.display="block"),u&&document.querySelectorAll('#multi-store-container input[type="checkbox"]').forEach(Y=>Y.checked=!1),document.getElementById("product-modal")?.classList.remove("hidden")},window.closeModals=()=>{document.getElementById("product-modal")?.classList.add("hidden"),document.getElementById("category-modal")?.classList.add("hidden"),document.getElementById("edit-cat-name-modal")?.classList.add("hidden"),document.getElementById("migration-modal")?.classList.add("hidden")},window.handleBulkFileSelection=P=>{P.files&&(w(P.files),P.value="")},window.addManualItem=()=>{const P=`manual_${Date.now()}`,N=document.getElementById("products-list-container"),z=document.getElementById("empty-list-msg");if(N&&z){const j=g(P);N.insertAdjacentHTML("beforeend",j),z.style.display="none",y(P)}},window.removeProductItem=P=>{const N=document.getElementById(`card-${P}`);N&&N.remove(),v.delete(P);const z=document.getElementById("products-list-container");if(z&&z.children.length===0){const j=document.getElementById("empty-list-msg");j&&(j.style.display="block")}},window.saveProducts=async()=>{const P=document.getElementById("btn-save-products-trigger");if(!P)return;P.disabled=!0;const N=P.innerHTML;P.innerHTML='<div class="spinner-small"></div> <span>Salvando...</span>';const j=document.getElementById("products-list-container")?.querySelectorAll(".product-item-card");if(!j||j.length===0){B.warning(`Adicione pelo menos um ${o.toLowerCase()}.`),P.disabled=!1,P.innerHTML=N;return}let G=[];if(u){const Y=document.querySelectorAll('#multi-store-container input[name="store-ids"]:checked');G=Array.from(Y).map(ne=>ne.value)}else n.storeId?G=[n.storeId]:n.storeIds&&n.storeIds.length>0&&(G=n.storeIds);if(G.length===0){B.warning("Selecione pelo menos uma loja para este(s) produto(s)."),P.disabled=!1,P.innerHTML=N;return}try{for(const Y of Array.from(j)){const ne=Y.id.replace("card-",""),he=Y.querySelector(".item-name").value,le=parseFloat(Y.querySelector(".item-price").value),pe=Y.querySelector(".item-category").value,xe=Y.querySelector(".promotional-checkbox").checked,He=Y.querySelector(".promotional-name-input").value,We=parseFloat(Y.querySelector(".promotional-price-input").value)||0,Je=Y.querySelector(".item-stock").value,lt=Je!==""?parseInt(Je):null,mt=document.getElementById(`progress-${ne}`);mt&&mt.classList.remove("hidden");let St={};v.has(ne)&&(St=await f(v.get(ne),n.companyId));const wt={name:he,price:le||0,categoryId:pe,storeIds:G,companyId:n.companyId,active:!0,promotionalActive:xe,promotionalName:He,promotionalPrice:We,stock:lt,...St};if(R&&ne==="edit-item"){await F.update("products",R,wt);const et=D.findIndex(ge=>ge.id===R);et!==-1&&(D[et]={...D[et],...wt})}else{const et=await F.create("products",wt);D.push({id:et,...wt})}mt&&mt.classList.add("hidden")}B.success(`${l} salvo(s) com sucesso!`),window.closeModals(),S(),P.disabled=!1,P.innerHTML=N}catch(Y){console.error("Error saving products:",Y),B.error(`Erro ao salvar ${l.toLowerCase()}.`),P.disabled=!1,P.innerHTML=N}},window.saveCategory=async P=>{P.preventDefault();const N=document.getElementById("cat-name"),z=document.getElementById("cat-icon"),j=N.value.trim(),G=z.value;if(j)try{const Y=await F.create("categories",{name:j,icon:G,companyId:n.companyId});L.push({id:Y,name:j,icon:G,companyId:n.companyId}),N.value="",A(),C(),B.success("Categoria criada com sucesso!")}catch{B.error("Erro ao criar categoria.")}},window.deleteCategory=async P=>{if(await Qe.warning("Excluir Categoria",'Tem certeza? Produtos nesta categoria ficarão "Sem Categoria".'))try{await F.delete("categories",P),L=L.filter(N=>N.id!==P),A(),C(),D.forEach(N=>{N.categoryId===P&&(N.categoryId="")}),B.success("Categoria excluída.")}catch{B.error("Erro ao excluir categoria.")}},window.openEditCategoryModal=(P,N)=>{const z=document.getElementById("edit-cat-name-input");z&&(z.value=N,z.dataset.catId=P,document.getElementById("edit-cat-name-modal")?.classList.remove("hidden"))},window.updateCategoryName=async()=>{const P=document.getElementById("edit-cat-name-input"),N=P.dataset.catId,z=P.value.trim();if(N&&z)try{await F.update("categories",N,{name:z});const j=L.find(G=>G.id===N);j&&(j.name=z),A(),C(),document.getElementById("edit-cat-name-modal")?.classList.add("hidden"),B.success("Nome atualizado!")}catch{B.error("Erro ao atualizar nome.")}},window.openCategoryModal=()=>{A();const P=document.getElementById("icon-picker");P&&(P.innerHTML=h.map(N=>`
                <div class="icon-option ${N==="fa-tag"?"selected":""}" data-icon="${N}" onclick="window.selectCategoryIcon(this, '${N}')">
                    <i class="fa-solid ${N}"></i>
                </div>
            `).join("")),document.getElementById("category-modal")?.classList.remove("hidden")},window.selectCategoryIcon=(P,N)=>{const z=document.getElementById("icon-picker");z&&(z.querySelectorAll(".icon-option").forEach(j=>j.classList.remove("selected")),P.classList.add("selected"),document.getElementById("cat-icon").value=N)},window.setStoreFilter=(P,N)=>{document.querySelectorAll(".filter-pill").forEach(z=>z.classList.remove("active")),N.classList.add("active"),b=P,k(P),S()},window.toggleAllCheckboxes=P=>{const N=P.checked;document.querySelectorAll(".product-checkbox").forEach(z=>z.checked=N),$()},window.updateBulkBar=$,window.applyBulkCategory=async()=>{const P=document.getElementById("bulk-assign-cat").value;if(!P){B.warning("Selecione uma categoria.");return}const N=Array.from(document.querySelectorAll(".product-checkbox:checked")).map(j=>j.dataset.id),z=document.getElementById("btn-bulk-save");z&&(z.innerHTML='<div class="spinner-small"></div>');try{await Promise.all(N.map(j=>F.update("products",j,{categoryId:P}))),D.forEach(j=>{N.includes(j.id)&&(j.categoryId=P)}),B.success(`${N.length} produtos atualizados!`),window.cancelBulkActions(),S()}catch{B.error("Erro ao processar em massa.")}finally{z&&(z.innerText="Aplicar")}},window.cancelBulkActions=()=>{document.querySelectorAll(".product-checkbox").forEach(N=>N.checked=!1);const P=document.getElementById("select-all-products");P&&(P.checked=!1),$()};const h=["fa-utensils","fa-burger","fa-pizza-slice","fa-ice-cream","fa-coffee","fa-beer","fa-wine-glass","fa-apple-whole","fa-carrot","fa-bowl-food","fa-cake-candles","fa-candy-cane","fa-cookie","fa-glass-water","fa-mug-hot","fa-bag-shopping","fa-shirt","fa-shoe-prints","fa-glasses","fa-watch","fa-laptop","fa-mobile-screen","fa-gamepad","fa-headphones","fa-camera","fa-tv","fa-microchip","fa-car","fa-bicycle","fa-plane","fa-bus","fa-train","fa-ship","fa-anchor","fa-heart","fa-star","fa-bolt","fa-fire","fa-leaf","fa-tree","fa-sun","fa-moon","fa-droplet","fa-cloud","fa-music","fa-film","fa-book","fa-pencil","fa-palette","fa-briefcase","fa-home","fa-medkit","fa-dumbbell","fa-basketball","fa-soccer-ball","fa-baseball","fa-volleyball","fa-tag"];setTimeout(()=>{k(b);const P=document.getElementById("btn-copy-catalog");P&&(P.onclick=()=>{const G=document.getElementById("catalog-url-display")?.value;G&&navigator.clipboard.writeText(G).then(()=>B.success("Link do catálogo copiado!"))});const N=document.getElementById("btn-bulk-save"),z=document.getElementById("btn-bulk-cancel");N&&(N.onclick=()=>window.applyBulkCategory()),z&&(z.onclick=()=>window.cancelBulkActions());const j=document.getElementById("bulk-upload-section");j&&(j.addEventListener("dragover",G=>{G.preventDefault(),j.classList.add("drag-active")}),j.addEventListener("dragleave",()=>j.classList.remove("drag-active")),j.addEventListener("drop",G=>{G.preventDefault(),j.classList.remove("drag-active"),G.dataTransfer?.files&&w(G.dataTransfer.files)}))},100);const I=`
    ...
    `,m=()=>{const v=document.querySelector(".data-table tbody");v&&(v.innerHTML=d())};return window.editEmployee=v=>{const R=o.find(D=>D.id===v||D.uid===v);if(R){if(document.getElementById("emp-uid").value=R.id,document.getElementById("emp-name").value=R.name,document.getElementById("emp-email").value=R.email,s){const D=R.storeIds||(R.storeId?[R.storeId]:[]);s.setValues(D)}document.getElementById("emp-password").required=!1,document.getElementById("pwd-hint").style.display="block",document.getElementById("emp-email").disabled=!0,document.getElementById("modal-title").innerText="Editar Colaborador",document.getElementById("employee-modal").classList.remove("hidden")}},window.toggleEmployeeStatus=async(v,R)=>{try{await F.update("users",v,{active:!R});const D=o.find(L=>L.id===v);D&&(D.active=!R),m(),B.success(`Colaborador ${R?"desativado":"ativado"} com sucesso!`)}catch(D){B.error("Erro ao atualizar status: "+D)}},window.deleteEmployee=async v=>{if(await Qe.danger("Excluir Colaborador","Tem certeza que deseja EXCLUIR este colaborador? Esta ação não pode ser desfeita."))try{await F.delete("users",v),o=o.filter(D=>D.id!==v),m(),B.success("Colaborador excluído com sucesso!")}catch(D){B.error("Erro ao excluir: "+D)}},setTimeout(()=>{b(n.companyId)},100),`
        ...
        ${u}
    `;function b(v){const R=document.getElementById("employee-modal"),D=document.getElementById("btn-new-employee"),L=document.querySelector(".close-modal"),_=document.getElementById("create-employee-form"),T=i.map(S=>({value:S.id,label:S.name}));s=new jh("employee-stores-select",T,[],()=>{},"Selecione as lojas..."),D&&R&&(D.onclick=()=>{document.getElementById("emp-uid").value="",document.getElementById("create-employee-form").reset(),document.getElementById("emp-password").required=!0,document.getElementById("pwd-hint").style.display="none",document.getElementById("emp-email").disabled=!1,document.getElementById("modal-title").innerText="Novo Colaborador",s&&s.setValues([]),R.classList.remove("hidden")}),L&&R&&(L.onclick=()=>R.classList.add("hidden")),_&&(_.onsubmit=async S=>{S.preventDefault();const $=document.getElementById("emp-uid").value,C=document.getElementById("emp-name").value,A=document.getElementById("emp-email").value,k=document.getElementById("emp-password").value,f=s?s.getValues():[];try{if($){const g={name:C,storeIds:f.length>0?f:[]};await F.update("users",$,g);const y=o.find(w=>w.id===$);y&&Object.assign(y,g),B.success("Colaborador atualizado com sucesso!")}else{const g=await ke.registerUser(A,k),y={uid:g,name:C,email:A,role:"employee",companyId:v,storeIds:f.length>0?f:[],active:!0,permissions:["orders","products"]};await F.set("users",g,y),o.push({id:g,...y}),B.success("Colaborador adicionado com sucesso!")}R&&R.classList.add("hidden"),m()}catch(g){console.error(g),B.error("Erro: "+g)}})}},px=()=>`
...
⚠️ ATENÇÃO: Todos os usuários (dono e funcionários) serão BLOQUEADOS de fazer login!`),await Qe.warning(`${R.charAt(0).toUpperCase()+R.slice(1)} Cliente`,D))try{await F.update("companies",m,{status:v});const _=n.find(T=>T.id===m);_&&(_.status=v),o(),B.success(`Cliente ${v==="inactive"?"desativado":"ativado"} com sucesso!`)}catch(_){B.error("Erro ao atualizar status: "+_)}};const l=(m=null)=>{const b=document.getElementById("stores-list");if(!b)return;const v=document.createElement("div");v.className="store-row",m&&(v.dataset.id=m.id,v.dataset.active=m.active!==void 0?m.active:"true",v.dataset.freteAtivo=m.frete_ativo!==void 0?m.frete_ativo:"true",v.dataset.instanciaId=m.instancia_id||""),v.innerHTML=`
    ...
    `,m=()=>{const L=document.querySelector(".data-table tbody");L&&(L.innerHTML=o())};let b=null,v=null;const R=()=>{b&&clearInterval(b),v&&clearInterval(v),b=null,v=null};window.refreshApp=()=>{window.location.reload()},window.shareQR=L=>{const _=`${window.location.origin}/qr/${L}`;navigator.clipboard.writeText(_),B.success("Link de conexão copiado para a área de transferência!")},window.deleteInstance=async(L,_)=>{if(await Qe.danger("Excluir Instância",`Tem certeza que deseja excluir a instância "${_}"? Isso irá desconectar o WhatsApp.`))try{await ut.deleteInstance(_),await F.delete("instancias",L),s=s.filter(S=>S.id!==L),m(),B.success("Instância excluída com sucesso.")}catch(S){B.error("Erro ao excluir instância: "+S)}},window.logoutInstance=async(L,_)=>{if(await Qe.warning("Desconectar WhatsApp",`Deseja realmente desconectar o WhatsApp da instância "${_}"?`))try{if(B.info("Desconectando..."),await ut.logoutInstance(_)){await F.update("instancias",L,{status:"desconectado"});const $=s.find(C=>C.id===L);$&&($.status="desconectado"),m(),B.success("Desconectado com sucesso.")}else B.error("Não foi possível desconectar pela API. Verifique se a instância está ativa.")}catch(S){B.error("Erro ao desconectar: "+S)}},window.connectInstance=async L=>{const _=document.getElementById("qrcode-modal"),T=document.getElementById("qrcode-container");if(_&&T){_.classList.remove("hidden"),T.innerHTML='<i class="fa-solid fa-spinner fa-spin fa-2x"></i>';const S=async()=>{try{const A=await ut.getQRCode(L);A&&A.base64?T.innerHTML=`<img src="${A.base64}" style="width: 100%; height: 100%; object-fit: contain;">`:(await ut.getInstanceStatus(L)).connected?C():T.innerHTML="<p>Erro ao obter QR Code. Verifique se a instância está ativa.</p>"}catch(A){console.error("Error fetching QR:",A)}},$=async()=>{try{(await ut.getInstanceStatus(L)).connected&&C()}catch(A){console.error("Error checking status:",A)}},C=async()=>{R(),B.success("WhatsApp conectado com sucesso!"),_.classList.add("hidden");const A=s.find(k=>k.nome===L);A&&(await F.update("instancias",A.id,{status:"conectado"}),A.status="conectado",m())};await S(),b=setInterval(S,4e4),v=setInterval($,3e3)}},setTimeout(()=>{D(t.id,i)},100);function D(L,_){const T=document.getElementById("btn-new-instance"),S=document.getElementById("new-instance-modal"),$=document.getElementById("close-new-modal"),C=document.getElementById("create-instance-form"),A=document.getElementById("qrcode-modal"),k=document.getElementById("close-qr-modal"),f=document.getElementById("btn-done-qrcode");T&&(T.onclick=()=>{if(s.length>=_){B.error("Limite de instâncias atingido.");return}S?.classList.remove("hidden")}),$&&S&&($.onclick=()=>S.classList.add("hidden")),C&&(C.onsubmit=async g=>{g.preventDefault();let w=document.getElementById("instance-name").value.trim();w=w.replace(/[^a-zA-Z0-9]/g,"_").toLowerCase();const h=`${w}_${L.substring(0,5)}`;try{if(await ut.instanceExists(h)){B.warning("Já existe uma instância com esse nome. Tente outro.");return}B.info("Criando instância, aguarde..."),await ut.createInstance(h);const E={empresaId:L,lojaId:null,nome:h,numero:null,status:"desconectado",funcao:null,webhookUrl:null,upsert:!1},P=await F.create("instancias",E);s.push({id:P,...E,createdAt:{toDate:()=>new Date}}),B.success("Instância criada! Agora vincule-a a uma loja nas configurações."),S?.classList.add("hidden"),m(),window.connectInstance(h)}catch(I){B.error("Erro ao criar instância: "+I)}}),k&&A&&(k.onclick=()=>{R(),A.classList.add("hidden")}),f&&A&&(f.onclick=async()=>{R(),A.classList.add("hidden"),window.location.reload()})}return`
        <div class="page-header">
...
Aguardamos você!`},{key:"pagamento_confirmado",label:"Pagamento Confirmado",icon:"fa-credit-card",default:"Olá {{nome_lead}}! 💳 Pagamento confirmado! Seu pedido #{{numero_pedido}} está sendo preparado."},{key:"pedido_pronto",label:"Pedido Pronto (Retirada)",icon:"fa-box",default:"Olá {{nome_lead}}! 📦 Seu pedido #{{numero_pedido}} já está pronto para retirada!"},{key:"saiu_para_entrega",label:"Saiu para Entrega",icon:"fa-truck",default:"🚚 Olá {{nome_lead}}! Seu pedido #{{numero_pedido}} saiu para entrega no endereço: {{endereco_entrega}}"},{key:"pedido_entregue",label:"Pedido Entregue",icon:"fa-flag-checkered",default:"🏁 Olá {{nome_lead}}! Seu pedido #{{numero_pedido}} foi entregue. Obrigado pela preferência!"},{key:"pedido_cancelado",label:"Pedido Cancelado",icon:"fa-xmark",default:"Olá {{nome_lead}}! Seu pedido #{{numero_pedido}} foi cancelado."}],vx=async()=>{const n=ke.getCurrentUser();if(!n||!n.companyId)return"<p>Acesso negado.</p>";const e=n.companyId,i=await F.getAll("instancias",{field:"empresaId",operator:"==",value:e}),r=await F.get("companies",e);let o=r?.stores||[];if(n.role!=="owner"){const S=n.storeIds||(n.storeId?[n.storeId]:[]);o=o.filter($=>S.includes($.id))}if(o.length===0)return'<p style="padding: 2rem;">Nenhuma loja encontrada para configuração.</p>';let l=o[0].id;const d=()=>`
    ...
    `;function R(){const S=()=>{document.querySelectorAll(".btn-store-tab").forEach($=>{$.addEventListener("click",()=>{l=$.dataset.id;const C=document.getElementById("tabs-container");C&&(C.innerHTML=d(),S()),D()})})};S()}function D(){const S=u();if(!S)return;const $=b(l),C=$?.mensagens_automaticas||{},A=$?.prompt_ia||S.prompt_ia||"",k=document.getElementById("config-content-area");if(!k)return;const f=()=>'<option value="">Nenhuma</option>'+i.map(y=>{const w=S.instancia_id===y.id,h=o.some(I=>I.id!==l&&I.instancia_id===y.id);return`<option value="${y.id}" ${w?"selected":""} ${h?"disabled":""}>
        ...
        `).join("");k.innerHTML=`
            ...
            <div class="card" style="margin-bottom: 1.5rem;">
                ...
                <textarea id="prompt-ia" class="msg-textarea" rows="4" placeholder="Ex: Você é o assistente virtual da Loja X...">${A}</textarea>
        ...
        `,document.body.appendChild(t),t.querySelector("#close-support")?.addEventListener("click",()=>{t.remove()})}async showNewOrder(e){const t=e.source==="catalog";Array.isArray(e.itens)||(Array.isArray(e.items)?e.itens=e.items.map(D=>({item:D.name||D.item||"",quantidade:D.qty||D.quantidade||1,preco:D.price||D.preco||0,subtotal:D.subtotal||0})):e.itens=[]);const i=e.empresaId||ke.getCurrentUser()?.companyId;if(i&&Array.isArray(e.itens)&&!t)try{const D=await F.getAll("products",{field:"companyId",operator:"==",value:i});let L=!1;if(e.itens.forEach(_=>{const T=(_.item||"").toLowerCase().trim(),S=D.find($=>($.name||"").toLowerCase().trim()===T);if(S){const $=S.promotionalActive&&S.promotionalPrice||S.price;(!_.preco||_.preco===0)&&(_.preco=$,L=!0)}}),L){let _=0;e.itens.forEach(S=>{const $=parseFloat(S.preco)||0,C=parseInt(S.quantidade)||1;_+=C*$});const T=parseFloat(e.valoresAdicionais)||0;e.value=_+T}}catch(D){console.error("Error syncing prices with catalog:",D)}this.newOrderSound.play().catch(()=>{});const s=document.createElement("div");s.className="order-modal",s.id=`modal-${e.id}`;const r=Array.isArray(e.itens)&&e.itens.length>0?e.itens.map((D,L)=>`
        ...
        `,document.body.appendChild(s);const l=D=>{const L=parseFloat(D);return isNaN(L)?0:L},d=()=>{let D=0;document.querySelectorAll(".notif-item-price-input").forEach(T=>{const S=parseInt(T.dataset.index),$=(e.itens||[])[S]?.quantidade||1;D+=$*l(T.value)});const L=l(document.getElementById("notif-additional-value")?.value);D+=L;const _=document.getElementById("notif-order-total");_&&(_.innerText=`R$ ${D.toFixed(2)}`)};document.querySelectorAll(".notif-item-price-input").forEach(D=>{D.addEventListener("input",d)}),document.getElementById("notif-additional-value")?.addEventListener("input",d);const u=s.querySelector("#accept-order"),m=s.querySelector("#reject-order"),b=s.querySelector("#confirm-reject"),v=s.querySelector("#reject-reason-container"),R=s.querySelector("#reject-reason");u?.addEventListener("click",async()=>{const D=ke.getCurrentUser(),L=e.empresaId||D?.companyId;if(!L){B.error("Empresa não identificada.");return}u.disabled=!0,u.textContent="⌛ Processando...";try{let _=0,T=Array.isArray(e.itens)?[...e.itens]:[];if(t)T.forEach(f=>{_+=(f.quantidade||1)*(f.preco||0)});else{const f=y=>{const w=parseFloat(y);return isNaN(w)?0:w};document.querySelectorAll(".notif-item-price-input").forEach(y=>{const w=parseInt(y.dataset.index),h=T[w]?.quantidade||1,I=f(y.value);T[w]&&(T[w].preco=I),_+=h*I});const g=f(document.getElementById("notif-additional-value")?.value);_+=g}const S={value:_,total:_,itens:T,valoresAdicionais:t?0:parseFloat(document.getElementById("notif-additional-value")?.value)||0},$=e.entrega==="retirada",C=e.pagamento||e.formaPagamento||e.paymentMethod||"",A=C.includes("entrega")||C.includes("dinheiro")||C.includes("maquininha")||C==="na_entrega";let k=$&&A?"em_preparo":"aguardando_pagamento";t&&A&&(k="em_preparo"),await Jn.updateOrderStatus(e,L,k,void 0,S),B.success("Pedido aceito!"),s.remove()}catch(_){B.error("Erro ao aceitar pedido: "+_),u.disabled=!1,u.innerHTML='<i class="fa fa-check"></i> Aceitar'}}),m?.addEventListener("click",()=>{m.classList.add("hidden"),u.classList.add("hidden"),b.classList.remove("hidden"),v.style.display="block",R.focus()}),b?.addEventListener("click",async()=>{const D=R.value.trim();if(!D){B.warning("Informe o motivo da recusa."),R.style.borderColor="red";return}const L=ke.getCurrentUser(),_=e.empresaId||L?.companyId;if(!_){B.error("Empresa não identificada.");return}b.disabled=!0,b.textContent="⌛ Processando...";try{await Jn.updateOrderStatus(e,_,"cancelado",D),B.success("Pedido recusado e cliente notificado."),s.remove()}catch(T){B.error("Erro ao recusar pedido: "+T),b.disabled=!1,b.textContent="Confirmar Recusa"}})}showPaymentConfirmed(){this.paymentSound.play().catch(()=>{});const e=document.createElement("div");e.className="order-modal",e.innerHTML=`
        ...
        `,document.body.appendChild(e),e.querySelector("#close-payment")?.addEventListener("click",()=>{e.remove()}),setTimeout(()=>{e.parentNode&&e.remove()},3e3)}orderStatusMap=new Map;setupLeadsListener(e){const t=di(Nt,"leads"),i=r=>{if(r.type!=="modified"&&r.type!=="added")return;const o=r.doc.data(),l=r.doc.id,d="lead_"+l,u=(o.statusAtendimento||"").toLowerCase(),m=(o.estado||"").toLowerCase(),b=u==="atendimento_humano"||u==="em_atendimento_humano"||m==="atendimento_humano";if(this.isLeadsInitialLoad){b&&this.notifiedSupportIds.add(d);return}if(b&&!this.notifiedSupportIds.has(d)){if(window.location.pathname.includes("/catalog/")||window.location.pathname.includes("/qr/"))return;const v=ke.getCurrentUser();if(v&&v.role!=="owner"&&v.role!=="admin"){const R=v.storeIds||(v.storeId?[v.storeId]:[]);if(console.log("OrderNotification - Checking Lead Store isolation:",{userStoreIds:R,leadLojaId:o.lojaId}),R.length>0&&o.lojaId&&!R.includes(o.lojaId))return}this.showHumanSupportAlert({...o,id:l,leadId:o.telefone||l,customerName:this.formatCustomerName(o)}),this.notifiedSupportIds.add(d)}else!b&&this.notifiedSupportIds.has(d)&&this.notifiedSupportIds.delete(d)},s=pi(t,Xn("empresaId","==",e),Xn("statusAtendimento","in",["atendimento_humano","em_atendimento_humano"]));this.unsubscribeLeads=Ps(s,r=>{r.docChanges().forEach(i),this.isLeadsInitialLoad&&(this.isLeadsInitialLoad=!1)}),setTimeout(()=>{this.isLeadsInitialLoad&&(this.isLeadsInitialLoad=!1)},3e3)}startListening(){if(this.unsubscribe)return;const e=ke.getCurrentUser();if(!e||!e.companyId)return;if(!["admin","owner","employee","staff"].includes(e.role||"")){console.log("OrderNotification - Unauthorized role for notifications:",e.role);return}const i=e.companyId,s=di(Nt,"pedidos"),r=pi(s,Xn("empresaId","==",i),Sw("criadoEm","desc"),Cw(50));this.unsubscribe=Ps(r,o=>{o.docChanges().forEach(l=>{const d=l.doc.data(),u=(d.status||"em_montagem").toLowerCase(),m=l.doc.id,b=this.orderStatusMap.get(m);if(this.isInitialLoad){this.orderStatusMap.set(m,u);return}if(this.orderStatusMap.set(m,u),!(d.empresaId&&d.empresaId!==i)&&!(window.location.pathname.includes("/catalog/")||window.location.pathname.includes("/qr/"))){if(e&&e.role!=="owner"&&e.role!=="admin"){const v=e.storeIds||(e.storeId?[e.storeId]:[]);if(console.log("OrderNotification - Checking Store isolation:",{userStoreIds:v,orderLojaId:d.lojaId}),v.length>0&&d.lojaId&&!v.includes(d.lojaId))return}if(u==="em_preparo"&&b==="aguardando_pagamento"&&(d.manuallyConfirmed||this.showPaymentConfirmed()),u==="atendimento_humano"){const v="pedido_"+m;this.notifiedSupportIds.has(v)||(this.showHumanSupportAlert({...d,id:m,customerName:this.formatCustomerName(d)}),this.notifiedSupportIds.add(v));return}if(l.type==="added"){if(["cancelado","finalizado"].includes(u))return;this.showNewOrder({id:l.doc.id,...d,customerName:this.formatCustomerName(d),endereco:d.endereco||"Endereço não informado",description:Array.isArray(d.itens)?d.itens.map(R=>`${R.quantidade}x ${R.item}`).join(", "):"Sem itens",value:d.value||d.total||0,leadId:d.leadId,empresaId:d.empresaId,instancia:d.instancia,itens:d.itens,valoresAdicionais:d.valoresAdicionais})}}}),this.isInitialLoad&&(this.isInitialLoad=!1)}),this.setupLeadsListener(i)}stopListening(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null,this.isInitialLoad=!0),this.unsubscribeLeads&&(this.unsubscribeLeads(),this.unsubscribeLeads=null,this.isLeadsInitialLoad=!0),this.notifiedSupportIds.clear(),this.orderStatusMap.clear()}}const Jd=new bx,wx={novo:{label:"Novo",cls:"badge info"},cliente_ativo:{label:"Cliente Ativo",cls:"badge success"},inativo:{label:"Inativo",cls:"badge secondary"},bloqueado:{label:"Bloqueado",cls:"badge danger"}},_x={bot:{label:"Bot",icon:'<i class="fa-solid fa-robot"></i>',cls:"badge primary"},em_atendimento_humano:{label:"Atendimento Humano",icon:'<i class="fa-solid fa-user"></i>',cls:"badge warning"},finalizado:{label:"Finalizado",icon:'<i class="fa-solid fa-check"></i>',cls:"badge success"},abandonado:{label:"Abandonado",icon:'<i class="fa-solid fa-warning"></i>',cls:"badge secondary"}};function Xd(n){const e=(n||"novo").toLowerCase(),t=wx[e]||{label:n||"Novo",cls:"badge info"};return`<span class="${t.cls}">${t.label}</span>`}function Zd(n){const e=(n||"bot").toLowerCase(),t=_x[e]||{label:n||"Bot",icon:'<i class="fa-solid fa-robot"></i>',cls:"badge primary"};return`<span class="${t.cls}">${t.icon} ${t.label}</span>`}function Fa(n){return n?n.toDate?n.toDate().toLocaleString("pt-BR"):new Date(n).toLocaleString("pt-BR"):"-"}const xx=async()=>{const n=ke.getCurrentUser();if(!n||!n.companyId)return"<p>Usuário sem empresa.</p>";let e=await F.getAll("leads",{field:"empresaId",operator:"==",value:n.companyId});const t=n.storeIds||(n.storeId?[n.storeId]:[]);n.role!=="owner"&&(e=e.filter(_=>_.lojaId&&t.includes(_.lojaId)));const s=(await F.get("companies",n.companyId))?.modulos_ativos||[],r=s.includes("venda_catalogo")&&!s.includes("atendimento");let o="todos";const l=_=>_.length===0?`<tr><td colspan="${r?4:5}" style="text-align:center;padding:2.5rem;color:var(--text-muted);">Nenhum lead encontrado.</td></tr>`:_.map(T=>{const S=(T.statusLead||"novo").toLowerCase(),$=(T.statusAtendimento||"bot").toLowerCase(),C=$==="atendimento_humano"?"em_atendimento_humano":$,A=(T.telefone||"").split("@")[0];return`
                ...
                <td>
                    <div style="display:flex;align-items:center;gap:0.75rem;">
                        ...
                        <div>
                            ...
                            <div style="font-size:0.78rem;color:var(--text-muted);">${A}</div>
                        </div>
                    </div>
                </td>
                <td>${Xd(S)}</td>
            ...
            </tr>`}).join(""),d=_=>_==="todos"?e:_==="humano"?e.filter(T=>{const S=(T.statusAtendimento||"").toLowerCase();return S==="em_atendimento_humano"||S==="atendimento_humano"}):_==="bloqueado"?e.filter(T=>(T.statusLead||"").toLowerCase()==="bloqueado"):_==="bot"?e.filter(T=>(T.statusAtendimento||"bot").toLowerCase()==="bot"):e;return setTimeout(()=>u(),100),`
        <div class="leads-page-header">
            <div class="leads-filter-bar">
                ...
                <button class="filter-btn" data-filter="humano"><i class="fa-solid fa-user"></i> Atendimento Humano <span class="filter-count" id="count-lead-humano">${e.filter(_=>{const T=(_.statusAtendimento||"").toLowerCase();return T==="em_atendimento_humano"||T==="atendimento_humano"}).length}</span></button>
                `}
    ...
    `;function u(){if(n){const T=di(Nt,"leads"),S=pi(T,Xn("empresaId","==",n.companyId));window._leadsUnsubscribe&&window._leadsUnsubscribe();const $=Ps(S,C=>{e=C.docs.map(g=>({id:g.id,...g.data()}));const A=n.storeIds||(n.storeId?[n.storeId]:[]);n.role!=="owner"&&(e=e.filter(g=>g.lojaId&&A.includes(g.lojaId)));const k=document.getElementById("leads-tbody");k&&(k.innerHTML=l(d(o)),m());const f={todos:e.length,bot:e.filter(g=>(g.statusAtendimento||"bot").toLowerCase()==="bot").length,humano:e.filter(g=>{const y=(g.statusAtendimento||"").toLowerCase();return y==="em_atendimento_humano"||y==="atendimento_humano"}).length,bloqueado:e.filter(g=>(g.statusLead||"").toLowerCase()==="bloqueado").length};Object.entries(f).forEach(([g,y])=>{const w=document.getElementById(`count-lead-${g}`);w&&(w.textContent=y.toString())})});window._leadsUnsubscribe=$}document.querySelectorAll(".leads-filter-bar .filter-btn").forEach(T=>{T.addEventListener("click",()=>{document.querySelectorAll(".leads-filter-bar .filter-btn").forEach($=>$.classList.remove("active")),T.classList.add("active"),o=T.dataset.filter||"todos";const S=document.getElementById("leads-tbody");S&&(S.innerHTML=l(d(o))),m()})}),m();const _=document.getElementById("lead-detail-modal");_?.addEventListener("click",T=>{T.target===_&&_.classList.add("hidden")})}function m(){document.querySelectorAll(".action-btn.view").forEach(_=>{_.addEventListener("click",async()=>{const T=_.dataset.id,S=e.find($=>$.id===T);S&&b(S)})})}function b(_){const T=document.getElementById("lead-detail-modal"),S=document.getElementById("lead-modal-inner");if(!T||!S)return;const $=(_.statusLead||"novo").toLowerCase(),C=(_.statusAtendimento||"bot").toLowerCase(),A=C==="atendimento_humano"?"em_atendimento_humano":C,k=$==="bloqueado",f=(_.telefone||"").split("@")[0];let g="";!k&&!r&&(A==="bot"?g=`<button id="lead-action-primary" class="btn-lead-action" data-action="assumir">
                    <i class="fa-solid fa-user"></i> Assumir Atendimento
                </button>`:A==="em_atendimento_humano"?g=`<button id="lead-action-primary" class="btn-lead-action danger" data-action="finalizar">
        ...
        `,T.classList.remove("hidden"),document.getElementById("close-lead-modal")?.addEventListener("click",()=>{T.classList.add("hidden")});const w=document.getElementById("lead-menu-trigger"),h=document.getElementById("lead-dropdown");w?.addEventListener("click",I=>{I.stopPropagation(),h?.classList.toggle("hidden")}),document.addEventListener("click",()=>h?.classList.add("hidden"),{once:!0}),h?.querySelectorAll(".lead-dropdown-item").forEach(I=>{I.addEventListener("click",async()=>{h.classList.add("hidden");const E=I.dataset.menuAction;await R(E,_)})}),document.getElementById("lead-action-primary")?.addEventListener("click",async function(){const I=this.dataset.action;await D(I,_)})}function v(_,T){const S=[];return _==="bloqueado"?S.push({label:"Desbloquear Lead",icon:'<i class="fa-solid fa-unlock"></i>',action:"desbloquear"}):S.push({label:"Bloquear Lead",icon:'<i class="fa-solid fa-lock"></i>',action:"bloquear",danger:!0}),S}async function R(_,T){if(_==="bloquear"){if(!await Qe.danger("Bloquear Lead",`Deseja bloquear o lead ${T.nome||T.telefone}? Ele não poderá receber atendimento enquanto bloqueado.`))return;try{await F.update("leads",T.id,{statusLead:"bloqueado",statusAtendimento:"finalizado",estado:"finalizado",updatedAt:ye.now()}),T.statusLead="bloqueado",T.statusAtendimento="finalizado",T.estado="finalizado",B.success("Lead bloqueado e atendimento finalizado."),L(T),b(T)}catch{B.error("Erro ao bloquear lead.")}}if(_==="desbloquear"){if(!await Qe.warning("Desbloquear Lead",`Deseja desbloquear o lead ${T.nome||T.telefone}?`))return;try{await F.update("leads",T.id,{statusLead:"cliente_ativo",updatedAt:ye.now()}),T.statusLead="cliente_ativo",B.success("Lead desbloqueado com sucesso."),L(T),b(T)}catch{B.error("Erro ao desbloquear lead.")}}}async function D(_,T){const S=document.getElementById("lead-action-primary");if(_==="assumir"){if(!await Qe.warning("Assumir Atendimento",`Deseja assumir o atendimento humano do lead ${T.nome||T.telefone}?`))return;S.disabled=!0,S.textContent='<i class="fa-solid hourglass"></i> Processando...';try{await F.update("leads",T.id,{statusAtendimento:"em_atendimento_humano",estado:"atendimento_humano",updatedAt:ye.now()}),T.statusAtendimento="em_atendimento_humano",T.estado="atendimento_humano",B.success("Atendimento humano iniciado."),L(T),b(T)}catch{B.error("Erro ao assumir atendimento."),S.disabled=!1,S.textContent='<i class="fa-solid user"></i> Assumir Atendimento'}}if(_==="finalizar"){if(!await Qe.warning("Finalizar Atendimento",`Deseja finalizar o atendimento do lead ${T.nome||T.telefone}?`))return;S.disabled=!0,S.textContent='<i class="fa-solid hourglass"></i> Processando...';try{await F.update("leads",T.id,{statusAtendimento:"finalizado",estado:"finalizado",updatedAt:ye.now()}),T.statusAtendimento="finalizado",T.estado="finalizado",B.success("Atendimento finalizado."),L(T),b(T)}catch{B.error("Erro ao finalizar atendimento."),S.disabled=!1,S.textContent='<i class="fa-solid check"></i> Finalizar Atendimento'}}if(_==="novo_atendimento"){if(!await Qe.warning("Iniciar Novo Atendimento",`Deseja iniciar um novo atendimento humano para ${T.nome||T.telefone}?`))return;S.disabled=!0,S.textContent='<i class="fa-solid hourglass"></i> Processando...';try{await F.update("leads",T.id,{statusAtendimento:"em_atendimento_humano",estado:"atendimento_humano",updatedAt:ye.now()}),T.statusAtendimento="em_atendimento_humano",T.estado="atendimento_humano",B.success("Novo atendimento humano iniciado."),L(T),b(T)}catch{B.error("Erro ao iniciar atendimento."),S.disabled=!1,S.textContent='<i class="fa-solid refresh"></i> Iniciar Novo Atendimento'}}}function L(_){const T=e.findIndex($=>$.id===_.id);T>=0&&(e[T]={...e[T],..._});const S=document.getElementById("leads-tbody");S&&(S.innerHTML=l(d(o))),m()}};function Ex(n){if(!n)return null;if(typeof n.toDate=="function")return n.toDate().getTime();if(n.seconds)return n.seconds*1e3;const e=new Date(n).getTime();return isNaN(e)?null:e}function Ix(n){const e=Ex(n);if(e===null)return{label:"Sem registro",color:"#6b7280"};const t=Date.now()-e,i=Math.floor(t/(1e3*60*60*24)),s=Math.floor(t/(1e3*60*60)),r=Math.floor(t/(1e3*60));let o;r<60?o=r<=1?"Agora há pouco":`há ${r} min`:s<24?o=`há ${s}h`:i===1?o="Ontem":o=`há ${i} dias`;const l=i<7?"#22c55e":i<30?"#f59e0b":"#ef4444";return{label:o,color:l}}const Tx=async()=>{const n=ke.getCurrentUser();if(!n||!n.companyId)return"<p>Usuário sem empresa.</p>";const e=n.companyId,[t,i,s]=await Promise.all([F.get("companies",e),F.getAll("instancias",{field:"empresaId",operator:"==",value:e}),F.getAll("leads",{field:"empresaId",operator:"==",value:e})]);let r=[],o="nova";const l=()=>i.length===0?'<option value="">Nenhuma instância cadastrada</option>':i.map(_=>{const T=_.status==="conectado"||_.status==="open",S=t?.stores?.find(C=>C.instancia_id===_.id),$=!!S;return`<option value="${_.id}" 
                        data-status="${_.status}" 
                        ${$?"disabled":""} 
                        style="${$?"color: var(--text-muted);":""}">
                ${_.nome} ${T?'<i class="fa-solid fa-circle-check" style="color: var(--primary);"></i>':'<i class="fa-solid fa-circle-xmark" style="color: var(--danger);"></i>'} ${S?`(EM USO: ${S.name})`:""}
            </option>`}).join(""),d=()=>r.length===0?'<tr><td colspan="8" style="text-align:center; padding: 2rem; color: var(--text-muted);">Nenhuma campanha realizada ainda.</td></tr>':r.sort((_,T)=>{const S=_.data_agendamento?.seconds||_.data_inicio?.seconds||0;return(T.data_agendamento?.seconds||T.data_inicio?.seconds||0)-S}).map(_=>{const T=_.total_leads>0?Math.round((_.enviados+_.falhas)/_.total_leads*100):0,S=_.data_agendamento?new Date(_.data_agendamento.seconds*1e3).toLocaleString("pt-BR",{dateStyle:"short",timeStyle:"short"}):null;return`
                <tr>
                    <td>
    ...
    `;return setTimeout(()=>v(),100),u;function m(){return`
        ...
        `}function v(){const _=document.getElementById("campaign-view-container");if(!_)return;const T=di(Nt,"campanhas"),S=pi(T,Xn("cliente_id","==",e));window._campaignsUnsubscribe&&window._campaignsUnsubscribe();const $=Ps(S,f=>{if(r=f.docs.map(g=>({id:g.id,...g.data()})),o==="historico"){const g=document.getElementById("campaigns-tbody");g&&(g.innerHTML=d(),D())}});window._campaignsUnsubscribe=$;const C=()=>{o==="nova"?(_.innerHTML=m(),R()):(_.innerHTML=b(),D())},A=document.getElementById("tab-nova"),k=document.getElementById("tab-historico");A?.addEventListener("click",()=>{o="nova",A.classList.add("active"),k?.classList.remove("active"),C()}),k?.addEventListener("click",()=>{o="historico",k.classList.add("active"),A?.classList.remove("active"),C()}),C()}function R(){let _=1;const T=15;let S=new Set,$=s,C=[""];const A=document.getElementById("campaign-name"),k=document.getElementById("select-instance"),f=document.getElementById("btn-start-campaign"),g=document.getElementById("lead-search"),y=document.getElementById("lead-filter-store"),w=document.getElementById("lead-filter-status"),h=document.getElementById("lead-filter-activity"),I=document.getElementById("leads-table-body"),E=document.getElementById("select-all-leads"),P=document.getElementById("pagination-info"),N=document.getElementById("prev-page"),z=document.getElementById("next-page"),j=document.getElementById("selected-count-display"),G=document.getElementById("messages-list"),Y=document.getElementById("btn-add-message"),ne=()=>{const ge=g.value.toLowerCase(),ae=y.value,Pe=w.value,Se=h?parseInt(h.value||"0"):0,ce=Date.now(),Te=Se>0?ce-Se*24*60*60*1e3:null;$=s.filter(re=>{const Ie=!ge||(re.nome||"").toLowerCase().includes(ge)||(re.telefone||"").includes(ge),st=!ae||re.lojaId===ae,Rt=!Pe||(re.statusLead||"novo")===Pe;let Ft=!0;if(Te!==null){const Ut=re.updatedAt||re.criadoEm||re.createdAt;let V=null;Ut&&(typeof Ut.toDate=="function"?V=Ut.toDate().getTime():Ut.seconds?V=Ut.seconds*1e3:V=new Date(Ut).getTime()),Ft=V!==null&&V>=Te}return Ie&&st&&Rt&&Ft}),_=1,he()},he=()=>{if(!I||!P)return;const ge=(_-1)*T,ae=Math.min(ge+T,$.length),Pe=$.slice(ge,ae);I.innerHTML=Pe.map(ce=>{const Te=S.has(ce.id),re=t?.stores?.find(st=>st.id===ce.lojaId)?.name||"N/A",Ie=Ix(ce.updatedAt||ce.criadoEm||ce.createdAt);return`
                    <tr>
                        <td><input type="checkbox" class="lead-checkbox" data-id="${ce.id}" ${Te?"checked":""}></td>
                        ...
                        <td>
                            <span style="display:inline-flex;align-items:center;gap:5px;font-size:0.78rem;color:var(--text-muted);">
                                <span style="width:7px;height:7px;border-radius:50%;background:${Ie.color};flex-shrink:0;"></span>
                                <span style="color:${Ie.color};font-weight:600;">${Ie.label}</span>
                            </span>
                        </td>
                    </tr>
                `}).join(""),P.textContent=`Mostrando ${ge+1}-${ae} de ${$.length}`,j&&(j.textContent=S.size.toString());const Se=Pe.length>0&&Pe.every(ce=>S.has(ce.id));E&&(E.checked=Se),document.querySelectorAll(".lead-checkbox").forEach(ce=>{ce.addEventListener("change",Te=>{const re=Te.target.dataset.id;Te.target.checked?S.add(re):S.delete(re),j&&(j.textContent=S.size.toString()),pe()})}),pe()},le=()=>{G&&(G.innerHTML=C.map((ge,ae)=>`
                <div class="message-block" data-index="${ae}">
                    ...
                    <textarea class="form-control msg-textarea" rows="5" placeholder="Digite sua mensagem aqui..." data-index="${ae}" style="width: 100%; box-sizing: border-box;">${ge}</textarea>
                    <div style="display: flex; justify-content: flex-end; margin-top: 5px;">
                        <span class="char-count" style="font-size: 0.7rem; color: var(--text-muted);">${ge.length} caracteres</span>
                    </div>
                </div>
            `).join(""),document.querySelectorAll(".btn-remove-msg").forEach(ge=>{const ae=ge;ae.addEventListener("click",()=>{const Pe=parseInt(ae.dataset.index||"0");C.splice(Pe,1),le(),pe()})}),document.querySelectorAll(".msg-textarea").forEach(ge=>{const ae=ge;ae.addEventListener("input",()=>{const Pe=parseInt(ae.dataset.index||"0");C[Pe]=ae.value;const Se=ae.parentElement?.querySelector(".char-count");Se&&(Se.textContent=`${ae.value.length} caracteres`),pe()}),ae.addEventListener("dragover",Pe=>Pe.preventDefault()),ae.addEventListener("drop",Pe=>{Pe.preventDefault();const Se=Pe.dataTransfer.getData("text/plain");if(!Se)return;const ce=ae.selectionStart||ae.value.length,Te=ae.selectionEnd||ae.value.length,re=ae.value.slice(0,ce)+Se+ae.value.slice(Te);ae.value=re;const Ie=parseInt(ae.dataset.index||"0");C[Ie]=re,pe()})}))},pe=()=>{const ge=!!k.value,ae=S.size>0,Pe=C.every(re=>re.trim().length>0),Se=k.options[k.selectedIndex],ce=Se?.dataset.status==="conectado"||Se?.dataset.status==="open";let Te=!0;if(xe==="scheduled"){const re=lt?.value;(!re||new Date(re).getTime()<=Date.now())&&(Te=!1)}f.disabled=!(ge&&ce&&ae&&Pe&&Te)};g?.addEventListener("input",ne),y?.addEventListener("change",ne),w?.addEventListener("change",ne),h?.addEventListener("change",ne),A?.addEventListener("input",pe),N?.addEventListener("click",()=>{_>1&&(_--,he())}),z?.addEventListener("click",()=>{_<Math.ceil($.length/T)&&(_++,he())}),E?.addEventListener("change",ge=>{const ae=(_-1)*T,Pe=Math.min(ae+T,$.length),Se=$.slice(ae,Pe);ge.target.checked?Se.forEach(ce=>S.add(ce.id)):Se.forEach(ce=>S.delete(ce.id)),he()}),Y?.addEventListener("click",()=>{C.push(""),le(),pe()}),document.querySelectorAll(".var-chip").forEach(ge=>{const ae=ge;ae.addEventListener("dragstart",Pe=>{Pe.dataTransfer.setData("text/plain",ae.dataset.var||"")})});let xe="now";k?.addEventListener("change",pe);const He=document.getElementById("btn-send-now"),We=document.getElementById("btn-send-scheduled"),Je=document.getElementById("schedule-datetime-wrap"),lt=document.getElementById("schedule-datetime"),mt=document.getElementById("schedule-error"),St=()=>{xe==="scheduled"?f.innerHTML='<i class="fa-solid fa-calendar-clock" style="margin-right: 8px;"></i> Agendar Campanha':f.innerHTML='<i class="fa-solid fa-paper-plane" style="margin-right: 8px;"></i> Iniciar Campanha Agora'},wt=ge=>String(ge).padStart(2,"0"),et=new Date;et.setMinutes(et.getMinutes()+5),lt.min=`${et.getFullYear()}-${wt(et.getMonth()+1)}-${wt(et.getDate())}T${wt(et.getHours())}:${wt(et.getMinutes())}`,He?.addEventListener("click",()=>{xe="now",He.classList.add("active"),We?.classList.remove("active"),Je&&(Je.style.display="none"),mt&&(mt.style.display="none"),St(),pe()}),We?.addEventListener("click",()=>{xe="scheduled",We.classList.add("active"),He?.classList.remove("active"),Je&&(Je.style.display="block"),St(),pe()}),lt?.addEventListener("change",()=>{mt&&(mt.style.display="none"),pe()}),f?.addEventListener("click",async()=>{if(xe==="scheduled"){const ce=lt?.value;if(!ce||new Date(ce).getTime()<=Date.now()){mt&&(mt.style.display="block");return}}const ge=xe==="scheduled",ae=ge?new Date(lt.value):new Date,Pe=ge?`Confirma o agendamento para ${ae.toLocaleString("pt-BR")} com ${S.size} leads?`:`Deseja iniciar o disparo imediato para ${S.size} leads com ${C.length} variações de mensagem?`;if(await Qe.warning(ge?"Agendar Campanha":"Iniciar Campanha",Pe))try{f.disabled=!0,f.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Salvando...';const ce={cliente_id:e,instancia_id:k.value,nome:A?.value?.trim()||`Campanha MB ${new Date().toLocaleDateString()} ${new Date().toLocaleTimeString()}`,mensagens:C,total_leads:S.size,lead_ids:Array.from(S),enviados:0,falhas:0,status:"agendada",agendamento_imediato:!ge,data_agendamento:ye.fromDate(ae),data_inicio:null,config:{delay_min:parseInt(document.getElementById("delay-min").value||"20"),delay_max:parseInt(document.getElementById("delay-max").value||"60")}};await F.create("campanhas",ce),B.success(ge?"Campanha agendada com sucesso!":"Campanha criada! O disparo será iniciado em instantes."),window.location.reload()}catch(ce){B.error("Erro ao salvar campanha: "+ce),f.disabled=!1,St()}}),he(),le()}function D(){document.querySelectorAll(".view-details").forEach(S=>{S.addEventListener("click",()=>{const $=S.dataset.id,C=r.find(A=>A.id===$);C&&L(C)})}),document.querySelectorAll(".cancel-campaign").forEach(S=>{S.addEventListener("click",async()=>{const $=S.dataset.id;if(!r.find(k=>k.id===$))return;if(await Qe.danger("Cancelar Campanha","Você tem certeza que deseja cancelar esta campanha? Ela será interrompida e nenhum outro envio será feito."))try{await F.update("campanhas",$,{status:"cancelada"}),B.success("Campanha cancelada com sucesso.")}catch(k){B.error("Erro ao cancelar a campanha."),console.error("Erro ao cancelar campanha:",k)}})});const _=document.getElementById("close-detail-modal"),T=document.getElementById("campaign-detail-modal");_?.addEventListener("click",()=>T?.classList.add("hidden"))}function L(_){const T=document.getElementById("campaign-detail-modal"),S=document.getElementById("campaign-detail-content");if(!T||!S)return;const $=_.total_leads>0?Math.round((_.enviados+_.falhas)/_.total_leads*100):0;S.innerHTML=`
            ...
            <div class="card" style="background: var(--surface-hover); border: 1px solid var(--border-color); padding: 1.5rem;">
                ...
                ${(_.mensagens?.length?_.mensagens:_.mensagem?[_.mensagem]:["(sem mensagem)"]).map((C,A)=>`
                        <div style="
                            background: rgba(255,255,255,0.03);
                            border: 1px solid var(--border-color);
                            border-radius: 10px;
                        ...
                        ">
                            <div style="font-size: 0.7rem; font-weight: 700; color: var(--primary); text-transform: uppercase; margin-bottom: 0.5rem; letter-spacing: 0.05em;">
                                <i class="fa-solid fa-comment"></i> Mensagem #${A+1}
                            </div>
                            <div style="white-space: pre-wrap; font-size: 0.92rem; line-height: 1.65; color: var(--text-main); font-family: inherit;">${C}</div>
                        </div>
                    `).join("")}
            </div>
        `,T.classList.remove("hidden")}},_i={agendado:{label:"Agendado",color:"#6366f1",icon:"fa-clock"},confirmado:{label:"Confirmado",color:"#10b981",icon:"fa-circle-check"},concluido:{label:"Concluído",color:"#64748b",icon:"fa-flag-checkered"},cancelado:{label:"Cancelado",color:"#ef4444",icon:"fa-ban"}},It=n=>String(n).padStart(2,"0"),is=n=>{const[e,t,i]=n.split("-");return`${i}/${t}/${e}`},ss=n=>n?.toLocaleString("pt-BR",{style:"currency",currency:"BRL"})??"R$ 0,00",rs=()=>{const n=new Date;return`${n.getFullYear()}-${It(n.getMonth()+1)}-${It(n.getDate())}`},kx=async()=>{const n=ke.getCurrentUser();if(!n||!n.companyId)return"<p>Usuário sem empresa.</p>";const e=n.companyId;if(!((await F.get("companies",e))?.modulos_ativos||[]).includes("agendamento"))return`
        ...
        </div>`},S=()=>{const h=m(l),I=h.reduce((E,P)=>E+(P.servicePrice||0),0);return`
        ...
        <div class="sched-stats-row">
            ...
            <div class="sched-stat"><i class="fa-solid fa-circle-check" style="color:#10b981"></i> <strong>${h.filter(E=>E.status==="confirmado").length}</strong> confirmados</div>
        </div>
        ...
        <div class="sched-week-grid">
            ${h.map(E=>{const P=I.filter(j=>j.date===E);return`
                <div class="sched-week-col ${E===rs()?"today":""} ${E===l?"selected":""}" data-date="${E}" onclick="window.selectWeekDay('${E}')">
                    <div class="sched-week-col-header">
                        <span class="sched-wday">${D(E)}</span>
                        <span class="sched-wdate">${E.split("-")[2]}</span>
        ...
        </div>`},C=()=>{const h=[...o].sort((P,N)=>P.date.localeCompare(N.date)||P.time.localeCompare(N.time)),I=h.filter(P=>P.date>=rs()&&P.status!=="cancelado"),E=h.filter(P=>P.date<rs()||P.status==="cancelado");return`
        ...
        <div class="sched-list-section" style="margin-top:2rem; opacity:0.7;">
            <div class="sched-list-title"><i class="fa-solid fa-history"></i> Histórico (${E.length})</div>
            ${E.slice(0,10).map(P=>`
                <div class="sched-list-row">
        ...
        </div>`:""}`},A=Array.from({length:28},(h,I)=>{const E=Math.floor(I/2)+8,P=I%2===0?"00":"30";return`${It(E)}:${P}`}),k=`
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                    ...
                    <div class="form-group">
                        ...
                        <select id="sched-time" class="form-input">
                            ${A.map(h=>`<option value="${h}">${h}</option>`).join("")}
                        </select>
                    </div>
                </div>
                <div class="form-group">
    ...
    </div>`;setTimeout(()=>w(),100);const f=()=>{const h=document.getElementById("sched-view-content");h&&(d==="day"?h.innerHTML=S():d==="week"?h.innerHTML=$():h.innerHTML=C(),g())},g=()=>{document.getElementById("prev-day")?.addEventListener("click",()=>{const h=new Date(l+"T12:00:00");h.setDate(h.getDate()-1),l=`${h.getFullYear()}-${It(h.getMonth()+1)}-${It(h.getDate())}`,f()}),document.getElementById("next-day")?.addEventListener("click",()=>{const h=new Date(l+"T12:00:00");h.setDate(h.getDate()+1),l=`${h.getFullYear()}-${It(h.getMonth()+1)}-${It(h.getDate())}`,f()}),document.getElementById("prev-week")?.addEventListener("click",()=>{const h=new Date(l+"T12:00:00");h.setDate(h.getDate()-7),l=`${h.getFullYear()}-${It(h.getMonth()+1)}-${It(h.getDate())}`,f()}),document.getElementById("next-week")?.addEventListener("click",()=>{const h=new Date(l+"T12:00:00");h.setDate(h.getDate()+7),l=`${h.getFullYear()}-${It(h.getMonth()+1)}-${It(h.getDate())}`,f()}),document.getElementById("btn-add-for-day")?.addEventListener("click",()=>{y()})};function y(h){const I=document.getElementById("sched-modal");if(!I)return;const E=document.getElementById("sched-modal-title"),P=document.getElementById("sched-client-name"),N=document.getElementById("sched-client-phone"),z=document.getElementById("sched-service"),j=document.getElementById("sched-date"),G=document.getElementById("sched-time"),Y=document.getElementById("sched-duration"),ne=document.getElementById("sched-status"),he=document.getElementById("sched-notes"),le=document.getElementById("save-sched-btn");h?(E.innerText="Editar Agendamento",P.value=h.clientName,N.value=h.clientPhone,z.value=h.serviceId,j.value=h.date,G.value=h.time,Y.value=String(h.duration||30),ne.value=h.status,he.value=h.notes||"",le.setAttribute("data-edit-id",h.id)):(E.innerText="Novo Agendamento",P.value="",N.value="",z.value="",j.value=l,G.value="09:00",Y.value="30",ne.value="agendado",he.value="",le.removeAttribute("data-edit-id")),I.classList.remove("hidden")}function w(){document.getElementById("btn-new-appointment")?.addEventListener("click",()=>y()),document.getElementById("close-sched-modal")?.addEventListener("click",()=>{document.getElementById("sched-modal")?.classList.add("hidden")}),document.getElementById("cancel-sched-modal")?.addEventListener("click",()=>{document.getElementById("sched-modal")?.classList.add("hidden")}),document.getElementById("sched-service")?.addEventListener("change",h=>{const I=h.target,P=I.options[I.selectedIndex].dataset.duration;P&&(document.getElementById("sched-duration").value=P)}),document.getElementById("save-sched-btn")?.addEventListener("click",async()=>{const h=document.getElementById("sched-client-name"),I=document.getElementById("sched-client-phone"),E=document.getElementById("sched-service"),P=document.getElementById("sched-date"),N=document.getElementById("sched-time"),z=document.getElementById("sched-duration"),j=document.getElementById("sched-status"),G=document.getElementById("sched-notes"),Y=document.getElementById("save-sched-btn");if(!h.value.trim()){B.warning("Informe o nome do cliente.");return}if(!E.value){B.warning("Selecione um serviço.");return}if(!P.value){B.warning("Informe a data.");return}const ne=E.options[E.selectedIndex],he={serviceId:E.value,serviceName:ne.text.split(" — ")[0],servicePrice:parseFloat(ne.dataset.price||"0")},le={companyId:e,clientName:h.value.trim(),clientPhone:I.value.trim(),...he,date:P.value,time:N.value,duration:parseInt(z.value)||30,status:j.value,notes:G.value.trim()||void 0},pe=Y.getAttribute("data-edit-id");Y.disabled=!0,Y.innerHTML='<div class="spinner-small"></div> Salvando...';try{if(pe){await F.update("agendamentos",pe,le);const xe=o.findIndex(He=>He.id===pe);xe!==-1&&(o[xe]={id:pe,...le}),B.success("Agendamento atualizado!")}else{const xe=await F.create("agendamentos",le);o.push({id:xe,...le}),B.success("Agendamento criado com sucesso!")}document.getElementById("sched-modal")?.classList.add("hidden"),f()}catch(xe){B.error("Erro ao salvar agendamento: "+xe)}finally{Y.disabled=!1,Y.innerHTML='<i class="fa-solid fa-save"></i> Salvar'}}),document.querySelectorAll(".sched-view-tab").forEach(h=>{h.addEventListener("click",()=>{document.querySelectorAll(".sched-view-tab").forEach(I=>I.classList.remove("active")),h.classList.add("active"),d=h.dataset.view,f()})}),document.getElementById("sched-date-jump")?.addEventListener("change",h=>{l=h.target.value,f()}),document.getElementById("btn-today")?.addEventListener("click",()=>{l=rs(),document.getElementById("sched-date-jump").value=l,f()}),window.editAppointment=h=>{const I=o.find(E=>E.id===h);I&&y(I)},window.confirmAppointment=async h=>{try{await F.update("agendamentos",h,{status:"confirmado"});const I=o.find(E=>E.id===h);I&&(I.status="confirmado"),f(),B.success("Agendamento confirmado!")}catch{B.error("Erro ao confirmar.")}},window.completeAppointment=async h=>{try{await F.update("agendamentos",h,{status:"concluido"});const I=o.find(E=>E.id===h);I&&(I.status="concluido"),f(),B.success("Agendamento concluído!")}catch{B.error("Erro ao concluir.")}},window.cancelAppointment=async h=>{if(await Qe.danger("Excluir Agendamento","Deseja excluir este agendamento? Esta ação não pode ser desfeita."))try{await F.delete("agendamentos",h),o=o.filter(E=>E.id!==h),f(),B.success("Agendamento excluído.")}catch{B.error("Erro ao excluir.")}},window.selectWeekDay=h=>{l=h,d="day",document.querySelectorAll(".sched-view-tab").forEach(I=>{I.classList.toggle("active",I.dataset.view==="day")}),document.getElementById("sched-date-jump").value=h,f()},f()}return`
    <style>
    ...
    `},eu=async n=>{try{const e=await F.getAll("loja_config",{field:"lojaId",operator:"==",value:n});let t=e[0]?.empresaId,i=null,s=null;if(t&&(i=await F.get("companies",t),i&&(s=i.stores?.find(V=>V.id===n))),!s){const V=await F.getAll("companies");for(const M of V){const q=M.stores?.find(K=>K.id===n);if(q){i=M,s=q;break}}}if(!i||!s)return`
            ...
            `;const o=(i.modulos_ativos||[]).includes("venda_catalogo"),l=await F.getAll("products",{field:"companyId",operator:"==",value:i.id}),d=await F.getAll("categories",{field:"companyId",operator:"==",value:i.id}),u=e[0]||{},m=u.design||{},b=m.primaryColor||"#6366f1",v=m.secondaryColor||"#0f172a",R=m.textColor||"#ffffff",D=m.priceColor||"#ffffff",L=m.logoUrl||"",_=m.pixKey||"";let T=m.whatsapp||"";if(!T)try{if(s.instancia_id){const V=await F.get("instancias",s.instancia_id);V?.numero&&(T=V.numero.replace(/\D/g,""))}}catch(V){console.warn("Could not fetch instance details:",V)}const S=!!i.mercadoPagoToken&&u.mercadoPagoActive!==!1,$=l.filter(V=>V.active!==!1&&(V.storeIds?.includes(n)||V.storeId===n)),C=$.filter(V=>V.promotionalActive),A=m.themeId||"classico",k=m.bannerUrl||"",f=m.bannerMobileUrl||"",g=d.map(V=>({...V,products:$.filter(M=>M.categoryId===V.id)})).filter(V=>V.products.length>0),y=$.filter(V=>!V.categoryId||!d.find(M=>M.id===V.categoryId)),w=V=>V.imageUrl?V.imageUrl:V.imagemPath&&V.downloadToken?`https://firebasestorage.googleapis.com/v0/b/conectacidade-5e46d.firebasestorage.app/o/${encodeURIComponent(V.imagemPath)}?alt=media&token=${V.downloadToken}`:"https://via.placeholder.com/300?text=Sem+Imagem";let h=new Map;const I=m.taxaFixaNome||"",E=parseFloat(m.taxaFixaValor)||0,P=m.taxaTipo||"fixo",N=u?.cupons||[],z=`cat_user_${i.id}`,j=JSON.parse(localStorage.getItem(z)||"{}");let G=null;const Y=()=>{let V=0;return h.forEach(({product:M,qty:q})=>{const K=M.promotionalActive&&M.promotionalPrice||M.price;V+=K*q}),V},ne=V=>E?P==="percent"?V*E/100:E:0,he=V=>G?G.tipo==="percent"?V*G.desconto/100:G.desconto:0,le=()=>{const V=Y();return V+ne(V)-he(V)},pe=()=>{if(h.size===0)return'<p style="text-align:center;color:#94a3b8;padding:20px 0;">Seu carrinho está vazio.</p>';let V="";return h.forEach(({product:M,qty:q},K)=>{const J=M.promotionalActive&&M.promotionalPrice||M.price;V+=`
                <div style="display:flex;justify-content:space-between;align-items:center;padding:12px 0;border-bottom:1px solid rgba(255,255,255,0.08);">
                    <div style="flex:1;">
                        ...
                        <p style="margin:4px 0 0;color:#94a3b8;font-size:0.8rem;">R$ ${J.toFixed(2)} cada</p>
                    </div>
                    <div style="display:flex;align-items:center;gap:10px;">
                        ...
                        <button onclick="window.catQtyChange('${K}',1)" style="width:28px;height:28px;border-radius:50%;background:var(--primary-cat);color:white;border:none;cursor:pointer;font-size:1rem;display:flex;align-items:center;justify-content:center;">+</button>
                ...
                </div>`}),V},xe=()=>{const V=Y(),M=ne(V),q=he(V),K=V+M-q;let J="";return h.forEach(({product:ee,qty:de})=>{const ve=ee.promotionalActive&&ee.promotionalPrice||ee.price;J+=`<div style="display:flex;justify-content:space-between;font-size:0.88rem;padding:4px 0;"><span>${de}x ${ee.name}</span><span>R$ ${(ve*de).toFixed(2)}</span></div>`}),M>0&&(J+=`<div style="display:flex;justify-content:space-between;font-size:0.85rem;padding:4px 0;color:#94a3b8;"><span><i class="fa-solid fa-truck" style="margin-right:4px;"></i>${I||"Taxa"}</span><span>+ R$ ${M.toFixed(2)}</span></div>`),q>0&&G&&(J+=`<div style="display:flex;justify-content:space-between;font-size:0.85rem;padding:4px 0;color:#10b981;"><span><i class="fa-solid fa-tag" style="margin-right:4px;"></i>Cupom ${G.codigo}</span><span>- R$ ${q.toFixed(2)}</span></div>`),J+=`<div style="display:flex;justify-content:space-between;font-weight:800;font-size:1rem;border-top:1px solid rgba(255,255,255,0.1);margin-top:8px;padding-top:8px;"><span>Total</span><span style="color:var(--primary-cat);">R$ ${K.toFixed(2)}</span></div>`,J},He={dom:"Domingo",seg:"Segunda-feira",ter:"Terça-feira",qua:"Quarta-feira",qui:"Quinta-feira",sex:"Sexta-feira",sab:"Sábado"},We=()=>["dom","seg","ter","qua","qui","sex","sab"][new Date().getDay()],Je=V=>{const M=u.horario_funcionamento?.[V]||s.horarios?.[V]||{};return{ativo:M.ativo??M.aberto??V!=="dom",inicio:M.inicio||M.abertura||"08:00",fim:M.fim||M.fechamento||"18:00"}},lt=V=>{const M=u.horario_entrega?.[V]||s.horario_entrega?.[V]||{};return console.log(M),{ativo:M.ativo??M.aberto??V!=="dom",inicio:M.inicio||M.abertura||"08:00",fim:M.fim||M.fechamento||"18:00"}},St=(()=>{const V=We(),M=lt(V);if(!M.ativo)return!1;const q=new Date,K=q.getHours()*60+q.getMinutes(),[J,ee]=M.inicio.split(":").map(Number),[de,ve]=M.fim.split(":").map(Number);return K>=J*60+ee&&K<=de*60+ve})(),wt=()=>{const V=We(),M=Je(V);if(!M.ativo)return!1;const q=new Date,K=q.getHours()*60+q.getMinutes(),[J,ee]=M.inicio.split(":").map(Number),[de,ve]=M.fim.split(":").map(Number);return K>=J*60+ee&&K<=de*60+ve},et=()=>{const V=["dom","seg","ter","qua","qui","sex","sab"],M=new Date().getDay(),q=new Date,K=q.getHours()*60+q.getMinutes(),J=V[M],ee=Je(J);if(ee.ativo){const[de,ve]=ee.inicio.split(":").map(Number),Ce=de*60+ve;if(K<Ce)return`Hoje às ${ee.inicio}`}for(let de=1;de<=7;de++){const ve=(M+de)%7,Ce=V[ve],Be=Je(Ce);if(Be.ativo)return de===1?`Amanhã às ${Be.inicio}`:`${He[Ce]} às ${Be.inicio}`}return"em breve"},ge=wt(),ae=()=>{const V=We(),M=Je(V);if(!M.ativo)return'<span style="color:#ef4444;"><i class="fa-solid fa-door-closed"></i> Fechado no momento</span>';const q=new Date,K=q.getHours()*60+q.getMinutes(),[J,ee]=M.inicio.split(":").map(Number),[de,ve]=M.fim.split(":").map(Number),Ce=J*60+ee,Be=de*60+ve;return K>=Ce&&K<=Be?`<span style="color:#10b981;"><i class="fa-solid fa-door-open"></i> Aberto agora</span> <span style="opacity:0.6;margin-left:4px;">• Fecha às ${M.fim}</span>`:K<Ce?`<span style="color:#ef4444;"><i class="fa-solid fa-door-closed"></i> Fechado no momento</span> <span style="opacity:0.6;margin-left:4px;">• Abre às ${M.inicio}</span>`:'<span style="color:#ef4444;"><i class="fa-solid fa-door-closed"></i> Fechado no momento</span>'},Pe=()=>{let V="";return["dom","seg","ter","qua","qui","sex","sab"].forEach(M=>{const q=Je(M);q.ativo?V+=`<div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,0.05);"><span style="color:var(--text-muted);">${He[M]}</span><span style="font-weight:600;">${q.inicio} às ${q.fim}</span></div>`:V+=`<div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,0.05);"><span style="color:var(--text-muted);">${He[M]}</span><span style="color:#ef4444;font-size:0.8rem;font-weight:600;">Fechado</span></div>`}),V},Se=()=>{const V=document.getElementById("cart-badge"),M=document.getElementById("cart-total"),q=document.getElementById("cart-items"),K=document.getElementById("cart-float-btn"),J=document.getElementById("cart-total-float"),ee=document.getElementById("cart-badge-float");let de=0;h.forEach(({qty:ve})=>de+=ve),V&&(V.textContent=de.toString()),ee&&(ee.textContent=de.toString()),K&&(K.style.display=de>0?"flex":"none"),M&&(M.textContent=`R$ ${le().toFixed(2)}`),J&&(J.textContent=`R$ ${le().toFixed(2).replace(".",",")}`),q&&(q.innerHTML=pe())};window.openStoreInfo=()=>ce("store-info-modal"),window.closeStoreInfo=()=>Te("store-info-modal"),window.catInit=()=>{const V=document.getElementById("checkout-name"),M=document.getElementById("checkout-phone"),q=document.getElementById("checkout-address");V&&j.name&&(V.value=j.name),M&&j.phone&&(M.value=j.phone),q&&j.address&&(q.value=j.address),M&&M.addEventListener("input",K=>{let J=K.target.value.replace(/\D/g,"");J.length>11&&(J=J.slice(0,11)),K.target.value=J})},setTimeout(()=>window.catInit(),500);const ce=V=>{const M=document.getElementById(V);M&&(M.style.display="flex")},Te=V=>{const M=document.getElementById(V);M&&(M.style.display="none")};if(o){window.showClosedAlert=M=>{const q=document.getElementById("closed-alert-title"),K=document.getElementById("closed-alert-desc"),J=document.getElementById("closed-alert-time-section"),ee=document.getElementById("next-open-time"),de=document.getElementById("closed-alert-icon");M==="store"?(q&&(q.textContent="Loja Fechada"),K&&(K.textContent="No momento não estamos aceitando pedidos."),J&&(J.style.display="block"),ee&&(ee.textContent=et()),de&&(de.className="fa-solid fa-store-slash")):M==="delivery"&&(q&&(q.textContent="Entrega Desativada"),K&&(K.textContent="O serviço de entrega está desativado no momento. Por favor, escolha a opção de Retirada se disponível."),J&&(J.style.display="none"),de&&(de.className="fa-solid fa-motorcycle")),ce("closed-alert-modal")},window.catAddToCart=M=>{const q=$.find(de=>de.id===M);if(!q||q.stock===0)return;const K=h.get(M),J=q.stock??1/0;if((K?.qty||0)>=J){alert(`Estoque máximo atingido (${q.stock} un.)`);return}h.set(M,{product:q,qty:(K?.qty||0)+1}),Se();const ee=document.getElementById(`btn-add-${M}`);ee&&(ee.textContent="✓ Adicionado",setTimeout(()=>{ee&&(ee.textContent="+ Adicionar")},1e3))},window.catQtyChange=(M,q)=>{const K=h.get(M);if(!K)return;const J=K.qty+q;J<=0?h.delete(M):K.qty=Math.min(J,K.product.stock??1/0),Se()},window.catRemoveItem=M=>{h.delete(M),Se()},window.openCart=()=>{Se(),ce("cart-modal")},window.closeCart=()=>Te("cart-modal"),window.goToDelivery=()=>{if(h.size!==0){if(!ge){window.showClosedAlert("store");return}Te("cart-modal"),ce("delivery-modal")}},window.closeDelivery=()=>Te("delivery-modal"),window.selectDelivery=M=>{window.catDeliveryType=M,document.querySelectorAll(".delivery-card").forEach(J=>{J.style.borderColor="rgba(255,255,255,0.1)",J.style.background="transparent"});const q=document.getElementById(`delivery-card-${M}`);q&&(q.style.borderColor="var(--primary-cat)",q.style.background="rgba(99,102,241,0.08)");const K=document.getElementById("btn-go-customer");K&&(K.disabled=!1,K.style.opacity="1",K.style.cursor="pointer")},window.goToCustomer=()=>{const M=window.catDeliveryType;if(!M)return;if(M==="entrega"&&!St){window.showClosedAlert("delivery");return}Te("delivery-modal");const q=document.getElementById("address-group");q&&(q.style.display=M==="entrega"?"block":"none"),ce("customer-modal")},window.closeCustomer=()=>Te("customer-modal"),window.goToPayment=()=>{const M=document.getElementById("checkout-name")?.value.trim(),q=document.getElementById("checkout-phone")?.value.trim(),K=document.getElementById("checkout-address")?.value.trim(),J=window.catDeliveryType;if(!M||!q){alert("Preencha nome e telefone.");return}if(q.length<10){alert("Telefone inválido. Use o formato DD000000000");return}if(J==="entrega"&&!K){alert("Preencha o endereço de entrega.");return}const ee={name:M,phone:q,address:K||""};window.catCustomer=ee,localStorage.setItem(z,JSON.stringify(ee)),Te("customer-modal");const de=document.getElementById("payment-order-summary");de&&(de.innerHTML=xe());const ve=document.getElementById("cat-coupon-section");ve&&(ve.style.display=N.length>0?"block":"none");const Ce=document.getElementById("btn-pay-pix-manual"),Be=document.getElementById("btn-pay-pix-mp");Ce&&(Ce.style.display=_?"flex":"none"),Be&&(Be.style.display=S?"flex":"none"),ce("payment-modal")},window.closePayment=()=>Te("payment-modal"),window.catApplyCoupon=()=>{const M=(document.getElementById("cat-coupon-input")?.value||"").trim().toUpperCase(),q=N.find(ve=>ve.codigo===M&&ve.ativo!==!1),K=Y(),J=document.getElementById("cat-coupon-msg");if(!q){J&&(J.textContent="Cupom inválido ou expirado.",J.style.color="#ef4444");return}if(q.valorMinimo>0&&K<q.valorMinimo){J&&(J.textContent=`Gasto mínimo de R$ ${q.valorMinimo.toFixed(2)} necessário.`,J.style.color="#ef4444");return}G=q;const ee=he(K);J&&(J.textContent=`✓ Cupom aplicado! Desconto: R$ ${ee.toFixed(2)}`,J.style.color="#10b981");const de=document.getElementById("payment-order-summary");de&&(de.innerHTML=xe())},window.catToggleCoupon=()=>{const M=document.getElementById("cat-coupon-input-wrapper"),q=document.getElementById("cat-coupon-toggle-label");if(M){const K=M.style.display==="block";M.style.display=K?"none":"block",q&&(q.textContent=K?"Tenho um cupom de desconto":"Ocultar cupom")}},window.catFilterClassic=M=>{document.querySelectorAll(".cat-selector-item").forEach(K=>{const J=K.getAttribute("onclick")||"";K.classList.toggle("active",J.includes("'"+M+"'"))});const q=document.getElementById("classic-promo-section");M==="all"?(q&&(q.style.display=C.length>0?"block":"none"),document.querySelectorAll("[data-classic-cat]").forEach(K=>K.style.display="block")):M==="promo"?(q&&(q.style.display="block"),document.querySelectorAll("[data-classic-cat]").forEach(K=>K.style.display="none")):(q&&(q.style.display="none"),document.querySelectorAll("[data-classic-cat]").forEach(K=>{K.style.display=K.dataset.classicCat===M?"block":"none"}))},window.catFilterCat=M=>{document.querySelectorAll(".cat-sidebar-link").forEach(J=>{J.classList.remove("active"),J.setAttribute("aria-pressed","false")});const q=document.querySelector(`.cat-sidebar-link[onclick*="'${M}'"]`);q&&(q.classList.add("active"),q.setAttribute("aria-pressed","true"));const K=M==="all";document.querySelectorAll("[data-catgroup]").forEach(J=>{J.style.display=K||J.dataset.catgroup===M?"":"none"})},window.catSearch=M=>{M=M.trim().toLowerCase(),document.querySelectorAll("[data-catgroup]").forEach(q=>{q.style.display=""}),M&&document.querySelectorAll(".product-card").forEach(q=>{const K=(q.querySelector("h3")?.textContent||"").toLowerCase();q.style.display=K.includes(M)?"":"none"})};const V=async(M,q)=>{const K=q.replace(/\D/g,""),ee=(await F.getAll("leads",{field:"empresaId",operator:"==",value:i.id})).find(ve=>{const Ce=(ve.telefone||ve.whatsapp||"").replace(/\D/g,"").replace("@c.us","");return Ce&&Ce===K});return ee?(ee.statusLead!=="cliente_ativo"&&await F.update("leads",ee.id,{statusLead:"cliente_ativo"}),ee.id):await F.create("leads",{nome:M,telefone:K,whatsapp:K,empresaId:i.id,lojaId:n,origem:"catalogo",statusLead:"cliente_ativo",criadoEm:new Date().toISOString()})};window.confirmOrderDelivery=async()=>{const M=document.getElementById("btn-pay-delivery");M&&(M.disabled=!0,M.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Processando...');try{const{name:q,phone:K,address:J}=window.catCustomer,ee=window.catDeliveryType,de=Array.from(h.entries()).map(([Me,{product:me,qty:Re}])=>{const $e=me.promotionalActive&&me.promotionalPrice||me.price;return{productId:Me,name:me.name,qty:Re,price:$e,subtotal:$e*Re}});for(const[Me,{qty:me}]of Array.from(h.entries())){const Re=$.find($e=>$e.id===Me);Re&&Re.stock!=null&&await F.update("products",Me,{stock:Math.max(0,Re.stock-me)})}const ve=Y(),Ce=ne(ve),Be=he(ve),Lt=ve+Ce-Be,_t=await V(q,K),zt=await F.create("pedidos",{lojaId:n,storeId:n,companyId:i.id,empresaId:i.id,clientName:q,clientPhone:K,endereco:J,entrega:ee,leadId:_t,nome:q,items:de,total:Lt,taxaAplicada:Ce,taxaNome:I,desconto:Be,codigoCupom:G?.codigo||null,paymentMethod:"na_entrega",pagamento:"na_entrega",status:"em_preparo",source:"catalog",criadoEm:new Date().toISOString()});try{console.log("Order created silently, waiting for operator approval.",zt)}catch(Me){console.error("Error in order creation log:",Me)}h.clear(),G=null,Te("payment-modal");const tt=document.getElementById("confirmation-modal"),tn=document.getElementById("order-id-display"),xt=document.getElementById("pix-info-section");tt&&(tt.style.display="flex"),tn&&(tn.textContent=zt.slice(0,8).toUpperCase()),xt&&(xt.style.display="none"),Se()}catch(q){console.error(q),alert("Erro ao processar pedido. Tente novamente."),M&&(M.disabled=!1,M.innerHTML="🤝 Pagar na Entrega / Retirada")}},window.showPixManual=()=>{Te("payment-modal");const M=document.getElementById("pix-manual-summary");M&&(M.innerHTML=xe());const q=document.getElementById("pix-key-value");q&&(q.textContent=_),ce("pix-manual-modal")},window.closePixManual=()=>Te("pix-manual-modal"),window.copyPixKey=()=>{navigator.clipboard.writeText(_).then(()=>{const M=document.getElementById("btn-copy-pix");M&&(M.textContent="✓ Copiado!",setTimeout(()=>{M.textContent="Copiar"},2e3))})},window.confirmPixManual=async()=>{const M=document.getElementById("btn-confirm-pix-manual");M&&(M.disabled=!0,M.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Confirmando...');try{const{name:q,phone:K,address:J}=window.catCustomer,ee=window.catDeliveryType,de=Array.from(h.entries()).map(([Re,{product:$e,qty:gt}])=>{const nn=$e.promotionalActive&&$e.promotionalPrice||$e.price;return{productId:Re,name:$e.name,qty:gt,price:nn,subtotal:nn*gt}});let ve="";const Ce=document.getElementById("pix-comprovante-input");if(Ce?.files?.[0]){const Re=Ce.files[0],$e=Date.now(),gt=`comprovantes/${i.id}/${$e}_${Re.name}`,nn=ln(cn,gt);await Li(nn,Re),ve=await ni(nn)}for(const[Re,{qty:$e}]of Array.from(h.entries())){const gt=$.find(nn=>nn.id===Re);gt&&gt.stock!=null&&await F.update("products",Re,{stock:Math.max(0,gt.stock-$e)})}const Be=Y(),Lt=ne(Be),_t=he(Be),zt=Be+Lt-_t,tt=await V(q,K),tn=await F.create("pedidos",{lojaId:n,storeId:n,companyId:i.id,empresaId:i.id,clientName:q,clientPhone:K,endereco:J,entrega:ee,leadId:tt,nome:q,items:de,total:zt,taxaAplicada:Lt,taxaNome:I,desconto:_t,codigoCupom:G?.codigo||null,paymentMethod:"pix_manual",pagamento:"pagamento_no_pix",comprovanteUrl:ve,status:"aguardando_pagamento",source:"catalog",criadoEm:new Date().toISOString()});h.clear(),G=null,Te("pix-manual-modal");const xt=document.getElementById("confirmation-modal"),Me=document.getElementById("order-id-display");xt&&(xt.style.display="flex"),Me&&(Me.textContent=tn.slice(0,8).toUpperCase());const me=document.getElementById("pix-info-section");me&&(me.style.display="none"),Se()}catch(q){console.error(q),alert("Erro ao confirmar pedido. Tente novamente."),M&&(M.disabled=!1,M.innerHTML='<i class="fa-solid fa-check"></i> Confirmar Pagamento PIX')}},window.confirmPixMercadoPago=async()=>{const M=document.getElementById("btn-pay-pix-mp");M&&(M.disabled=!0,M.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Gerando PIX...');try{const{name:q,phone:K,address:J}=window.catCustomer,ee=window.catDeliveryType,de=Array.from(h.entries()).map(([Me,{product:me,qty:Re}])=>{const $e=me.promotionalActive&&me.promotionalPrice||me.price;return{productId:Me,name:me.name,qty:Re,price:$e,subtotal:$e*Re}}),ve=Y(),Ce=ne(ve),Be=he(ve),Lt=ve+Ce-Be,zt=await fetch("https://n8n.vps.pequi.digital/webhook/autoqui-pix-catalog",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({companyId:i.id,storeId:n,items:de,total:Lt,clientName:q,clientPhone:K,accessToken:i.mercadoPagoToken})}),tt=zt.ok?await zt.json():null;for(const[Me,{qty:me}]of Array.from(h.entries())){const Re=$.find($e=>$e.id===Me);Re&&Re.stock!=null&&await F.update("products",Me,{stock:Math.max(0,Re.stock-me)})}const tn=await V(q,K),xt=await F.create("pedidos",{lojaId:n,storeId:n,companyId:i.id,empresaId:i.id,clientName:q,clientPhone:K,endereco:J,entrega:ee,leadId:tn,nome:q,items:de,total:Lt,taxaAplicada:Ce,taxaNome:I,desconto:Be,codigoCupom:G?.codigo||null,paymentMethod:"pix_mercadopago",pagamento:"pagamento_no_pix",mpPaymentId:tt?.payment_id||"",status:"aguardando_pagamento",source:"catalog",criadoEm:new Date().toISOString()});if(h.clear(),G=null,Te("payment-modal"),tt?.qr_code_base64||tt?.qr_code_text){const Me=document.getElementById("mp-qr-img"),me=document.getElementById("mp-qr-code"),Re=document.getElementById("mp-pix-summary");Me&&tt.qr_code_base64&&(Me.src=`data:image/png;base64,${tt.qr_code_base64}`,Me.style.display="block"),me&&tt.qr_code_text&&(me.textContent=tt.qr_code_text,window._mpQrCodeText=tt.qr_code_text),Re&&(Re.innerHTML=xe()),ce("mp-pix-modal")}else{const Me=document.getElementById("confirmation-modal"),me=document.getElementById("order-id-display");Me&&(Me.style.display="flex"),me&&(me.textContent=xt.slice(0,8).toUpperCase())}Se()}catch(q){console.error(q),alert("Erro ao gerar PIX. Tente novamente."),M&&(M.disabled=!1,M.innerHTML="⚡ Pagar via Mercado Pago (PIX)")}},window.closeMpPix=()=>Te("mp-pix-modal"),window.copyMpQrCode=()=>{const M=window._mpQrCodeText||"";navigator.clipboard.writeText(M).then(()=>{const q=document.getElementById("btn-copy-mp-qr");q&&(q.textContent="✓ Copiado!",setTimeout(()=>{q.textContent="Copiar código"},2e3))})},window.previewComprovante=M=>{const q=document.getElementById("comprovante-preview"),K=document.getElementById("comprovante-label");if(M.files?.[0]){const J=new FileReader;J.onload=ee=>{q&&(q.src=ee.target?.result,q.style.display="block"),K&&(K.textContent=M.files[0].name)},J.readAsDataURL(M.files[0])}}}const re=(V,M=!1)=>{const q=M&&V.promotionalName||V.name,K=M&&V.promotionalPrice||V.price,J=M?V.price:null,ee=V.stock===0;return o?`
                <div class="product-card" style="${ee?"opacity:0.6;":""}">
                    <div class="card-image">
                        <img src="${w(V)}" alt="${q}" loading="lazy">
                    ...
                    <div class="card-info">
                        ...
                        <div class="price-container">
                            ...
                            ${J?`<span class="original-price">R$ ${J.toFixed(2)}</span>`:""}
                        </div>
                        ${V.stock!=null&&!ee&&V.stock<=10?`<p style="font-size:0.75rem;color:#eab308;margin:6px 0 0;">⚠️ Apenas ${V.stock} restante${V.stock!==1?"s":""}</p>`:""}
                        <button id="btn-add-${V.id}" onclick="window.catAddToCart('${V.id}')" ${ee?"disabled":""}
                ...
                </div>`},Ie="display:none;position:fixed;inset:0;z-index:9000;background:rgba(0,0,0,0.75);align-items:center;justify-content:center;backdrop-filter:blur(4px);",st="background:#1e293b;border-radius:24px;width:92%;max-width:460px;padding:28px;",Rt=(V,M)=>`
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
                <h3 style="margin:0;font-size:1.1rem;font-weight:700;display:flex;align-items:center;gap:10px;">${V}</h3>
            ...
            </div>`,Ft=(V,M,q,K="")=>`<button id="${V}" onclick="${M}" style="width:100%;padding:14px;border-radius:14px;background:var(--primary-cat);color:white;border:none;cursor:pointer;font-weight:700;font-size:1rem;${K}">${q}</button>`,Ut=o?`
            <!-- CART MODAL -->
            <div id="cart-modal" style="${Ie}align-items:flex-end;overflow-y:auto;">
                <div style="background:#1e293b;border-radius:24px 24px 0 0;width:100%;max-width:520px;max-height:85vh;display:flex;flex-direction:column;padding:24px;overflow:hidden;">
                    ${Rt('<i class="fa-solid fa-cart-shopping"></i> Meu Carrinho',"window.closeCart()")}
                    ...
                    <div style="border-top:1px solid rgba(255,255,255,0.1);padding-top:16px;margin-top:16px;">
                        ...
                        ${Ft("btn-go-delivery","window.goToDelivery()",'<i class="fa-solid fa-arrow-right"></i> Finalizar Pedido')}
                    </div>
                </div>
            </div>

            <!-- DELIVERY MODAL -->
            <div id="delivery-modal" style="${Ie}">
                <div style="${st}">
                    ${Rt('<i class="fa-solid fa-box"></i> Como deseja receber?',"window.closeDelivery()")}
                    ...
                    ${Ft("btn-go-customer","window.goToCustomer()",'<i class="fa-solid fa-arrow-right"></i> Continuar',"opacity:0.4;cursor:not-allowed;")}
                </div>
            </div>

            <!-- CUSTOMER MODAL -->
            <div id="customer-modal" style="${Ie}">
                <div style="${st}max-height:90vh;overflow-y:auto;">
                    ${Rt('<i class="fa-solid fa-user"></i> Seus Dados',"window.closeCustomer()")}
                    ...
                    ${Ft("btn-go-payment","window.goToPayment()","Escolher Pagamento →","margin-top:8px;")}
                </div>
            </div>

            <!-- PAYMENT MODAL -->
            <div id="payment-modal" style="${Ie}">
                <div style="${st}">
                    ${Rt('<i class="fa-solid fa-credit-card"></i> Forma de Pagamento',"window.closePayment()")}
            ...
            <!-- PIX MANUAL MODAL -->
            <div id="pix-manual-modal" style="${Ie}">
                <div style="${st}max-height:90vh;overflow-y:auto;">
                    ${Rt('<i class="fa-brands fa-pix"></i> Pagamento via PIX',"window.closePixManual()")}
                    ...
                    ${Ft("btn-confirm-pix-manual","window.confirmPixManual()",'<i class="fa-solid fa-check"></i> Confirmar Pagamento PIX')}
                </div>
            </div>

            <!-- MERCADO PAGO PIX MODAL -->
            <div id="mp-pix-modal" style="${Ie}">
                <div style="${st}max-height:90vh;overflow-y:auto;">
                    ${Rt('<i class="fa-solid fa-qrcode"></i> PIX — Mercado Pago',"window.closeMpPix()")}
            ...
            <div id="store-info-modal" style="${Ie}">
                <div style="${st}max-width:500px;">
                    ${Rt('<i class="fa-solid fa-circle-info"></i> Informações da Loja',"window.closeStoreInfo()")}
            ...
            <div class="catalog-body">
                ...
                <header class="header">
                    ...
                    <div class="store-status-card">
                        ...
                        <div style="color:var(--text-muted);display:flex;align-items:center;justify-content:center;gap:6px;">
                            <i class="fa-solid fa-motorcycle"></i> ${St!==!1?"Entrega e Retirada":"Apenas Retirada"}
                        </div>
                        `:""}
                    </div>
                </header>
                ...
                ${A==="banner"?`
                    ...
                    <main class="section-container" style="padding-top:20px;">
                        ${C.length>0?`<div class="section-title"><i class="fa-solid fa-bolt-lightning" aria-hidden="true"></i><span>Ofertas do Dia</span><div class="line"></div></div><div class="product-grid" role="list">${C.map(V=>re(V,!0)).join("")}</div>`:""}
                        ${g.map(V=>`<div class="section-title"><i class="fa-solid ${V.icon||"fa-tag"}" aria-hidden="true"></i><span>${V.name}</span><div class="line"></div></div><div class="product-grid" role="list">${V.products.map(M=>re(M,!1)).join("")}</div>`).join("")}
                        ${y.length>0?`<div class="section-title"><i class="fa-solid fa-box" aria-hidden="true"></i><span>Outros</span><div class="line"></div></div><div class="product-grid" role="list">${y.map(V=>re(V,!1)).join("")}</div>`:""}
                    ...
                    <div class="cat-moderno-header">
                        ...
                        <div class="cat-moderno-info">
                            ...
                            <div class="cat-moderno-status-row">
                                ${ae()} 
                                ${ge?`<span class="badge" style="background:rgba(148,163,184,0.1);color:#475569;border:1px solid rgba(148,163,184,0.2);margin-left:8px;font-size:0.8rem;padding:4px 10px;border-radius:6px;font-weight:700;">${St!==!1?"Entrega e Retirada":"Apenas Retirada"}</span>`:""}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cat-modern-layout" style="padding-top:20px;">
                        <aside class="cat-sidebar-sticky" style="position:sticky;top:20px;height:fit-content;" aria-label="Categorias">
                            ...
                            <nav class="cat-sidebar">
                                ...
                                ${g.map(V=>`<button class="cat-sidebar-link" onclick="window.catFilterCat('${V.id}')"><i class="fa-solid ${V.icon||"fa-tag"}" aria-hidden="true"></i> ${V.name}</button>`).join("")}
                        ...
                        <div>
                            <div id="cat-moderno-content">
                                ${C.length>0?`<div class="section-title" data-catgroup="promo"><i class="fa-solid fa-bolt-lightning" aria-hidden="true"></i><span>Ofertas do Dia</span><div class="line"></div></div><div class="product-grid" data-catgroup="promo" role="list">${C.map(V=>re(V,!0)).join("")}</div>`:""}
                                ${g.map(V=>`<div class="section-title" data-catgroup="${V.id}"><i class="fa-solid ${V.icon||"fa-tag"}" aria-hidden="true"></i><span>${V.name}</span><div class="line"></div></div><div class="product-grid" data-catgroup="${V.id}" role="list">${V.products.map(M=>re(M,!1)).join("")}</div>`).join("")}
                                ${y.length>0?`<div class="section-title" data-catgroup="outros"><i class="fa-solid fa-box" aria-hidden="true"></i><span>Outros</span><div class="line"></div></div><div class="product-grid" data-catgroup="outros" role="list">${y.map(V=>re(V,!1)).join("")}</div>`:""}
                    ...
                    <main class="section-container">
                        <div class="cat-selector-wrapper">
                            <div class="cat-selector-scroll">
                                ...
                                ${g.map(V=>`
                                <button class="cat-selector-item" onclick="window.catFilterClassic('${V.id}')">
                                    <div class="cat-selector-icon-wrap"><i class="fa-solid ${V.icon||"fa-tag"}"></i></div>
                                    <span class="cat-selector-label">${V.name}</span>
                                </button>`).join("")}
                                ${y.length>0?`
                        ...
                        <div id="classic-promo-section" style="${C.length>0?"":"display:none;"}">
                            ...
                            <div class="product-grid" role="list">${C.map(V=>re(V,!0)).join("")}</div>
                        </div>

                        <div id="classic-categories-container">
                            ${g.map(V=>`
                                <div class="section-container-cat" data-classic-cat="${V.id}">
                                    <div class="section-title"><i class="fa-solid ${V.icon||"fa-tag"}" aria-hidden="true"></i><span>${V.name}</span><div class="line"></div></div>
                                    <div class="product-grid" role="list">${V.products.map(M=>re(M,!1)).join("")}</div>
                                </div>
                            `).join("")}
                            ${y.length>0?`
                                <div class="section-container-cat" data-classic-cat="outros">
                                    ...
                                    <div class="product-grid" role="list">${y.map(V=>re(V,!1)).join("")}</div>
                                </div>
                            `:""}
                        </div>
    ...
    `;function b(){const L=()=>{document.querySelectorAll(".btn-store-tab").forEach(_=>{_.addEventListener("click",()=>{l=_.dataset.id;const T=document.getElementById("cat-tabs-container");T&&(T.innerHTML=u(),L()),v()})})};L()}function v(){const L=document.getElementById("cat-config-content-area");if(!L)return;const _=d(l),T=_?.design||{},S=_?.mensagens_automaticas||{},$=`${window.location.origin}/catalog/${l}`,C=_?.instancia_id||i.find(f=>f.id===l)?.instancia_id||"",A=(f,g)=>{const y=_?.[g]||{};return Ua.map(w=>{const h=y[w.key]||{},I=h.ativo??h.aberto??w.key!=="dom",E=h.inicio||h.abertura||"08:00",P=h.fim||h.fechamento||"18:00";return`
                <div class="horario-row ${I?"":"inactive"}" id="${f}-row-${w.key}">
                    ...
                    <div class="horario-inputs ${I?"":"hidden"}" id="${f}-inputs-${w.key}">
                        <input type="time" class="time-input" id="${f}-open-${w.key}" value="${E}">
                        <span style="color:var(--text-dim);font-size:0.8rem;">até</span>
                ...
                <div style="border-top:1px solid var(--border-color);padding-top:1.25rem;margin-bottom:1.25rem;">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:12px;">
                        <div class="field">
                            ...
                            <input type="text" id="cat-taxa-nome" value="${T.taxaFixaNome||""}" class="time-input" style="width:100%;" placeholder="Ex: Taxa de entrega">
                        </div>
                        <div class="field">
                            <label class="config-label">Valor</label>
                            <input type="number" id="cat-taxa-valor" value="${T.taxaFixaValor||"0"}" class="time-input" style="width:100%;" placeholder="0.00" min="0" step="0.01">
                        </div>
                    </div>
                    <div style="display:flex;gap:8px;margin-bottom:8px;">
                        <button id="btn-taxa-fixo" onclick="window.catSetTaxaTipo('fixo')" style="
                            ...
                            background:${(T.taxaTipo||"fixo")==="fixo"?"var(--primary)":"var(--surface-hover)"};
                            color:${(T.taxaTipo||"fixo")==="fixo"?"white":"var(--text-main)"};
                            border:1px solid ${(T.taxaTipo||"fixo")==="fixo"?"var(--primary)":"var(--border-color)"};
                        "><i class="fa-solid fa-dollar-sign"></i> Fixa (R$)</button>
                        <button id="btn-taxa-percent" onclick="window.catSetTaxaTipo('percent')" style="
                            flex:1;padding:0.5rem;border-radius:8px;cursor:pointer;font-weight:600;font-size:0.85rem;
                            background:${T.taxaTipo==="percent"?"var(--primary)":"var(--surface-hover)"};
                            color:${T.taxaTipo==="percent"?"white":"var(--text-main)"};
                            border:1px solid ${T.taxaTipo==="percent"?"var(--primary)":"var(--border-color)"};
                        "><i class="fa-solid fa-percent"></i> Percentual (%)</button>
                    </div>
                    <input type="hidden" id="cat-taxa-tipo" value="${T.taxaTipo||"fixo"}">
        ...
        `,setTimeout(()=>{R()},50)}function R(L){const _=i;document.getElementById("btn-copy-cat-link")?.addEventListener("click",()=>{const C=document.getElementById("cat-link-display");C?.value&&navigator.clipboard.writeText(C.value).then(()=>B.success("Link copiado!"))});const T=(C,A)=>{const k=document.getElementById(C),f=document.getElementById(A);k?.addEventListener("input",()=>{f&&(f.value=k.value)}),f?.addEventListener("input",()=>{k&&(k.value=f.value)})};T("cat-primary-color","cat-primary-color-hex"),T("cat-secondary-color","cat-secondary-color-hex"),T("cat-text-color","cat-text-color-hex"),T("cat-price-color","cat-price-color-hex"),T("cat-product-bg-color","cat-product-bg-color-hex"),document.getElementById("cat-logo-file")?.addEventListener("change",C=>{const A=C.target.files?.[0];if(A){const k=new FileReader;k.onload=f=>{const g=document.getElementById("cat-logo-preview-wrapper");g&&(g.innerHTML=`<img src="${f.target?.result}" style="width:100%;height:100%;object-fit:contain;">`)},k.readAsDataURL(A)}}),document.getElementById("cat-instance-select")?.addEventListener("change",async C=>{const A=C.target.value,k=_.map(f=>f.id===l?{...f,instancia_id:A||null}:f);try{B.info("Salvando instância..."),await F.update("companies",e,{stores:k});const f=_.find(w=>w.id===l);f&&(f.instancia_id=A);const g=d(l);if(g)await F.update("loja_config",g.id,{instancia_id:A||null}),g.instancia_id=A;else{const w=await F.create("loja_config",{empresaId:e,lojaId:l,instancia_id:A||null});o.push({id:w,empresaId:e,lojaId:l,instancia_id:A})}const y=await F.getAll("instancias",{field:"lojaId",operator:"==",value:l});for(const w of y)await F.update("instancias",w.id,{lojaId:null,funcao:null});A&&await F.update("instancias",A,{lojaId:l,funcao:"Catálogo Vendas"}),B.success("Instância vinculada com sucesso!")}catch(f){B.error("Erro ao salvar instância."),console.error(f)}}),window.catSelectTheme=C=>{const A=document.getElementById("cat-theme-id");A&&(A.value=C),document.querySelectorAll(".theme-card").forEach(f=>f.classList.remove("active")),document.querySelectorAll(".theme-card").forEach(f=>{f.getAttribute("onclick")?.includes(`'${C}'`)&&f.classList.add("active")})};const S=(C,A)=>{document.getElementById(C)?.addEventListener("change",k=>{const f=k.target.files?.[0];if(f){const g=new FileReader;g.onload=y=>{const w=document.getElementById(A);w&&(w.innerHTML=`<img src="${y.target?.result}" style="width:100%;height:100%;object-fit:cover;">`)},g.readAsDataURL(f)}})};S("cat-banner-desktop-file","banner-desktop-preview"),S("cat-banner-mobile-file","banner-mobile-preview"),document.getElementById("btn-save-cat-aparencia")?.addEventListener("click",async()=>{const C=document.getElementById("btn-save-cat-aparencia");C.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Salvando...';try{const A=document.getElementById("cat-primary-color-hex").value,k=document.getElementById("cat-secondary-color-hex").value,f=document.getElementById("cat-text-color-hex").value,g=document.getElementById("cat-price-color-hex").value,y=document.getElementById("cat-product-bg-color-hex").value,w=document.getElementById("cat-theme-id")?.value||"classico",h=document.getElementById("cat-logo-file").files?.[0],I=document.getElementById("cat-banner-desktop-file")?.files?.[0],E=document.getElementById("cat-banner-mobile-file")?.files?.[0],P=d(l);let N=P?.design?.logoUrl||"",z=P?.design?.bannerUrl||"",j=P?.design?.bannerMobileUrl||"";if(h){const Y=ln(cn,`logos/${e}/${l}_logo`);await Li(Y,h),N=await ni(Y)}if(I){const Y=ln(cn,`banners/${e}/${l}_desktop`);await Li(Y,I),z=await ni(Y)}if(E){const Y=ln(cn,`banners/${e}/${l}_mobile`);await Li(Y,E),j=await ni(Y)}const G={...P?.design||{},primaryColor:A,secondaryColor:k,textColor:f,priceColor:g,productBgColor:y,logoUrl:N,themeId:w,bannerUrl:z,bannerMobileUrl:j};await D({design:G}),B.success("Aparência salva!"),C.innerHTML='<i class="fa-solid fa-check"></i> Salvo!',C.classList.add("saved"),setTimeout(()=>{C.innerHTML='<i class="fa-solid fa-floppy-disk"></i> Salvar Aparência',C.classList.remove("saved")},2e3)}catch{B.error("Erro ao salvar aparência."),C.innerHTML='<i class="fa-solid fa-floppy-disk"></i> Salvar Aparência'}}),document.getElementById("btn-save-cat-func")?.addEventListener("click",async()=>{const C=document.getElementById("btn-save-cat-func");C.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Salvando...';try{const A={};Ua.forEach(({key:k})=>{const f=document.querySelector(`.func-toggle[data-dia="${k}"]`)?.checked,g=document.getElementById(`func-open-${k}`)?.value||"08:00",y=document.getElementById(`func-close-${k}`)?.value||"18:00";A[k]={ativo:f,inicio:g,fim:y}}),await D({horario_funcionamento:A}),B.success("Horários de funcionamento salvos!"),C.innerHTML='<i class="fa-solid fa-check"></i> Salvo!',C.classList.add("saved"),setTimeout(()=>{C.innerHTML='<i class="fa-solid fa-floppy-disk"></i> Salvar Horários',C.classList.remove("saved")},2e3)}catch{B.error("Erro ao salvar horários."),C.innerHTML='<i class="fa-solid fa-floppy-disk"></i> Salvar Horários'}}),document.getElementById("btn-save-cat-entrega")?.addEventListener("click",async()=>{const C=document.getElementById("btn-save-cat-entrega");C.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Salvando...';try{const A={};Ua.forEach(({key:k})=>{const f=document.querySelector(`.entrega-toggle[data-dia="${k}"]`)?.checked,g=document.getElementById(`entrega-open-${k}`)?.value||"08:00",y=document.getElementById(`entrega-close-${k}`)?.value||"18:00";A[k]={ativo:f,inicio:g,fim:y}}),await D({horario_entrega:A}),B.success("Horários de entrega salvos!"),C.innerHTML='<i class="fa-solid fa-check"></i> Salvo!',C.classList.add("saved"),setTimeout(()=>{C.innerHTML='<i class="fa-solid fa-floppy-disk"></i> Salvar Horários de Entrega',C.classList.remove("saved")},2e3)}catch{B.error("Erro ao salvar horários de entrega."),C.innerHTML='<i class="fa-solid fa-floppy-disk"></i> Salvar Horários de Entrega'}}),document.querySelectorAll(".cat-save-single-msg").forEach(C=>{C.addEventListener("click",async()=>{const A=C.dataset.msgKey,k=document.getElementById(`cat-msg-${A}`)?.value||"",y={...d(l)?.mensagens_automaticas||{},[A]:k};try{C.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>',await D({mensagens_automaticas:y}),B.success("Mensagem salva!"),C.innerHTML='<i class="fa-solid fa-check"></i> Salvo!',C.classList.add("saved"),setTimeout(()=>{C.innerHTML='<i class="fa-solid fa-floppy-disk"></i> Salvar',C.classList.remove("saved")},2e3)}catch{B.error("Erro ao salvar mensagem."),C.innerHTML='<i class="fa-solid fa-floppy-disk"></i> Salvar'}})}),document.querySelectorAll(".var-chip").forEach(C=>{C.addEventListener("dragstart",A=>{A.dataTransfer?.setData("text/plain",C.dataset.var||"")}),C.addEventListener("click",()=>{navigator.clipboard.writeText(C.dataset.var||"").then(()=>B.info("Variável copiada!"))})}),document.querySelectorAll(".msg-textarea").forEach(C=>{C.addEventListener("dragover",A=>A.preventDefault()),C.addEventListener("drop",A=>{A.preventDefault();const k=A.dataTransfer?.getData("text/plain")||"",f=C,g=f.selectionStart,y=f.selectionEnd;f.value=f.value.substring(0,g)+k+f.value.substring(y),f.selectionStart=f.selectionEnd=g+k.length,f.focus()})}),document.getElementById("btn-save-cat-pagamento")?.addEventListener("click",async()=>{const C=document.getElementById("btn-save-cat-pagamento");C.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Salvando...';try{const A=d(l),k=document.getElementById("cat-whatsapp").value.replace(/\D/g,""),f=document.getElementById("cat-pix-key").value.trim(),g=document.getElementById("cat-taxa-nome").value.trim(),y=parseFloat(document.getElementById("cat-taxa-valor").value||"0")||0,w=document.getElementById("cat-taxa-tipo").value||"fixo",h=document.getElementById("mp-active-toggle")?.checked,I={...A?.design||{},whatsapp:k,pixKey:f,taxaFixaNome:g,taxaFixaValor:y,taxaTipo:w};await D({design:I,mercadoPagoActive:h}),B.success("Configurações de pagamento salvas!"),C.innerHTML='<i class="fa-solid fa-check"></i> Salvo!',C.classList.add("saved"),setTimeout(()=>{C.innerHTML='<i class="fa-solid fa-floppy-disk"></i> Salvar Pagamento',C.classList.remove("saved")},2e3)}catch{B.error("Erro ao salvar pagamento."),C.innerHTML='<i class="fa-solid fa-floppy-disk"></i> Salvar Pagamento'}}),window.catSetTaxaTipo=C=>{const A=document.getElementById("cat-taxa-tipo");A&&(A.value=C);const k=document.getElementById("btn-taxa-fixo"),f=document.getElementById("btn-taxa-percent");k&&(k.style.background=C==="fixo"?"var(--primary)":"var(--surface-hover)",k.style.color=C==="fixo"?"white":"var(--text-main)",k.style.borderColor=C==="fixo"?"var(--primary)":"var(--border-color)"),f&&(f.style.background=C==="percent"?"var(--primary)":"var(--surface-hover)",f.style.color=C==="percent"?"white":"var(--text-main)",f.style.borderColor=C==="percent"?"var(--primary)":"var(--border-color)")},document.getElementById("btn-add-cupom")?.addEventListener("click",async()=>{const C=(document.getElementById("new-cupom-code").value||"").trim().toUpperCase(),A=parseFloat(document.getElementById("new-cupom-valor").value||"0"),k=document.getElementById("new-cupom-tipo").value||"percent",f=parseFloat(document.getElementById("new-cupom-min").value||"0")||0;if(!C||!A){B.error("Preencha código e valor do cupom.");return}const y=[...d(l)?.cupons||[],{codigo:C,desconto:A,tipo:k,valorMinimo:f,ativo:!0}];await D({cupons:y}),B.success(`Cupom ${C} adicionado!`),v()}),window.catDeleteCupom=async C=>{const k=[...d(l)?.cupons||[]].filter((f,g)=>g!==C);await D({cupons:k}),B.success("Cupom removido."),v()};const $=(C,A,k,f)=>{document.querySelectorAll(`.${C}`).forEach(g=>{g.addEventListener("change",()=>{const y=g.dataset.dia,w=g.checked;document.getElementById(`${A}-row-${y}`)?.classList.toggle("inactive",!w),document.getElementById(`${A}-inputs-${y}`)?.classList.toggle("hidden",!w);const h=document.getElementById(`${A}-status-${y}`);h&&(h.innerText=w?k:f,h.style.color=w?"var(--success)":"var(--text-dim)")})})};$("func-toggle","func","Aberto","Fechado"),$("entrega-toggle","entrega","Disponível","Indisponível")}async function D(L){const _=d(l);if(_)await F.update("loja_config",_.id,L),Object.assign(_,L);else{const T=await F.create("loja_config",{empresaId:e,lojaId:l,...L});o.push({id:T,empresaId:e,lojaId:l,...L})}}},Lx=()=>`
    <style>
        :root {
            --lp-bg: #030712;
            --lp-primary: #6366f1;
    ...
    <\/script>
    `,Dx=async()=>{const n=ke.getCurrentUser(),e=n?.role?.toLowerCase()==="admin"||n?.email==="ginannymoreira@gmail.com";if(!n||!e)return"<p>Acesso negado.</p>";const s=(await F.getAll("companies")).flatMap(o=>(o.stores||[]).map(l=>({...l,companyName:o.name,companyId:o.id}))),r=()=>s.map(o=>`<option value="${o.id}" data-company-id="${o.companyId}">${o.name} (${o.companyName})</option>`).join("");return window.performMigration=async()=>{const o=document.getElementById("migration-source-store"),l=document.getElementById("migration-target-store"),d=o.value,u=o.selectedOptions[0]?.dataset.companyId,m=l.value,b=l.selectedOptions[0]?.dataset.companyId;if(!d||!m){B.warning("Selecione as lojas de origem e destino.");return}if(d===m){B.warning("A loja de origem e destino não podem ser a mesma.");return}if(!await Qe.warning("Confirmar Migração","Isso irá duplicar todos os produtos da loja de origem para a loja de destino. Continuar?"))return;const R=document.getElementById("btn-run-migration");R.disabled=!0,R.innerHTML='<div class="spinner-small"></div> Migrando...';try{const L=(await F.getAll("products",{field:"companyId",operator:"==",value:u})).filter(T=>T.storeIds&&T.storeIds.includes(d)||T.storeId===d);if(L.length===0){B.info("Nenhum produto encontrado na loja de origem."),R.disabled=!1,R.innerText="Iniciar Migração";return}let _=0;for(const T of L){const{id:S,...$}=T;$.companyId=b,$.storeIds=[m],delete $.lojaId,delete $.createdAt,await F.create("products",$),_++}B.success(`${_} produtos migrados com sucesso!`)}catch(D){console.error(D),B.error("Erro durante a migração: "+D)}finally{R.disabled=!1,R.innerText="Iniciar Migração"}},`
        <div class="page-header">
