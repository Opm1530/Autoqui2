...
--`+c+"--",R=Pn.getBlob(w,i,b);if(R===null)throw Jw();const M={name:u.fullPath},D=hr(s,n.host,n._protocol),v="POST",k=n.maxUploadRetryTime,S=new xl(D,v,P_(n,t),k);return S.urlParams=M,S.headers=o,S.body=R.uploadData(),S.errorHandler=zh(e),S}class O_{constructor(){this.sent_=!1,this.xhr_=new XMLHttpRequest,this.initXhr(),this.errorCode_=ri.NO_ERROR,this.sendPromise_=new Promise(e=>{this.xhr_.addEventListener("abort",()=>{this.errorCode_=ri.ABORT,e()}),this.xhr_.addEventListener("error",()=>{this.errorCode_=ri.NETWORK_ERROR,e()}),this.xhr_.addEventListener("load",()=>{e()})})}send(e,t,i,a,s){if(this.sent_)throw ra("cannot .send() more than once");if(Wn(e)&&i&&(this.xhr_.withCredentials=!0),this.sent_=!0,this.xhr_.open(t,e,!0),s!==void 0)for(const o in s)s.hasOwnProperty(o)&&this.xhr_.setRequestHeader(o,s[o].toString());return a!==void 0?this.xhr_.send(a):this.xhr_.send(),this.sendPromise_}getErrorCode(){if(!this.sent_)throw ra("cannot .getErrorCode() before sending");return this.errorCode_}getStatus(){if(!this.sent_)throw ra("cannot .getStatus() before sending");try{return this.xhr_.status}catch{return-1}}getResponse(){if(!this.sent_)throw ra("cannot .getResponse() before sending");return this.xhr_.response}getErrorText(){if(!this.sent_)throw ra("cannot .getErrorText() before sending");return this.xhr_.statusText}abort(){this.xhr_.abort()}getResponseHeader(e){return this.xhr_.getResponseHeader(e)}addUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.addEventListener("progress",e)}removeUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.removeEventListener("progress",e)}}class V_ extends O_{initXhr(){this.xhr_.responseType="text"}}function El(){return new V_}class yi{constructor(e,t){this._service=e,t instanceof Nt?this._location=t:this._location=Nt.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new yi(e,t)}get root(){const e=new Nt(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Oh(this._location.path)}get storage(){return this._service}get parent(){const e=x_(this._location.path);if(e===null)return null;const t=new Nt(this._location.bucket,e);return new yi(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw e_(e)}}function B_(n,e,t){n._throwIfRoot("uploadBytes");const i=M_(n.storage,n._location,Vh(),new Pn(e,!0),t);return n.storage.makeRequestWithTokens(i,El).then(a=>({metadata:a,ref:n}))}function F_(n){n._throwIfRoot("getDownloadURL");const e=L_(n.storage,n._location,Vh());return n.storage.makeRequestWithTokens(e,El).then(t=>{if(t===null)throw Xw();return t})}function z_(n){n._throwIfRoot("deleteObject");const e=D_(n.storage,n._location);return n.storage.makeRequestWithTokens(e,El)}function U_(n,e){const t=E_(n._location.path,e),i=new Nt(n._location.bucket,t);return new yi(n.storage,i)}function j_(n){return/^[A-Za-z]+:\/\//.test(n)}function q_(n,e){return new yi(n,e)}function jh(n,e){if(n instanceof Il){const t=n;if(t._bucket==null)throw Yw();const i=new yi(t,t._bucket);return e!=null?jh(i,e):i}else return e!==void 0?U_(n,e):n}function H_(n,e){if(e&&j_(e)){if(n instanceof Il)return q_(n,e);throw vo("To use ref(service, url), the first argument must be a Storage instance.")}else return jh(n,e)}function qd(n,e){const t=e?.[Ph];return t==null?null:Nt.makeFromBucketSpec(t,n)}function W_(n,e,t,i={}){n.host=`${e}:${t}`;const a=Wn(e);a&&(wo(`https://${n.host}/b`),_o("Storage",!0)),n._isUsingEmulator=!0,n._protocol=a?"https":"http";const{mockUserToken:s}=i;s&&(n._overrideAuthToken=typeof s=="string"?s:pu(s,n.app.options.projectId))}class Il{constructor(e,t,i,a,s,o=!1){this.app=e,this._authProvider=t,this._appCheckProvider=i,this._url=a,this._firebaseVersion=s,this._isUsingEmulator=o,this._bucket=null,this._host=Ch,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=Bw,this._maxUploadRetryTime=Fw,this._requests=new Set,a!=null?this._bucket=Nt.makeFromBucketSpec(a,this._host):this._bucket=qd(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,this._url!=null?this._bucket=Nt.makeFromBucketSpec(this._url,e):this._bucket=qd(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){jd("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){jd("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(t!==null)return t.accessToken}return null}async _getAppCheckToken(){if(Dt(this.app)&&this.app.settings.appCheckToken)return this.app.settings.appCheckToken;const e=this._appCheckProvider.getImmediate({optional:!0});return e?(await e.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(e=>e.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new yi(this,e)}_makeRequest(e,t,i,a,s=!0){if(this._deleted)return new t_(Rh());{const o=p_(e,this._appId,i,a,t,this._firebaseVersion,s,this._isUsingEmulator);return this._requests.add(o),o.getPromise().then(()=>this._requests.delete(o),()=>this._requests.delete(o)),o}}async makeRequestWithTokens(e,t){const[i,a]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,i,a).getPromise()}}const Hd="@firebase/storage",Wd="0.14.0";const qh="storage";function Ni(n,e,t){return n=Ve(n),B_(n,e,t)}function oi(n){return n=Ve(n),F_(n)}function G_(n){return n=Ve(n),z_(n)}function un(n,e){return n=Ve(n),H_(n,e)}function K_(n=To(),e){n=Ve(n);const i=qs(n,qh).getImmediate({identifier:e}),a=cu("storage");return a&&Q_(i,...a),i}function Q_(n,e,t,i={}){W_(n,e,t,i)}function Y_(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),i=n.getProvider("auth-internal"),a=n.getProvider("app-check-internal");return new Il(t,i,a,e,vi)}function J_(){ci(new Bn(qh,Y_,"PUBLIC").setMultipleInstances(!0)),Xt(Hd,Wd,""),Xt(Hd,Wd,"esm2020")}J_();const Hh={apiKey:"AIzaSyAOV2Dz0mrJAIT2DLQsrLCTC2bLO7lkzmI",authDomain:"conectacidade-5e46d.firebaseapp.com",projectId:"conectacidade-5e46d",storageBucket:"conectacidade-5e46d.firebasestorage.app",messagingSenderId:"740343372037",appId:"1:740343372037:web:a74dcf684844bc9167ff6c",measurementId:"G-GH3W7LBTWZ"},Tl=Io(Hh),Ur=Ju(Tl),Ut=bw(Tl),pn=K_(Tl),B={async create(n,e){const t=fi(Ut,n);return(await Vw(t,{...e,createdAt:ge.now()})).id},async set(n,e,t){const i=fa(Ut,n,e);await Nw(i,{...t,createdAt:ge.now()})},async getAll(n,e){const t=fi(Ut,n);let i=On(t);if(e)if(Array.isArray(e)){const s=e.map(o=>Vn(o.field,o.operator,o.value));i=On(t,...s)}else i=On(t,Vn(e.field,e.operator,e.value));return(await $w(i)).docs.map(s=>({id:s.id,...s.data()}))},async get(n,e){const t=fa(Ut,n,e),i=await Dw(t);return i.exists()?{id:i.id,...i.data()}:null},async update(n,e,t){const i=fa(Ut,n,e);await Mw(i,t)},async delete(n,e){const t=fa(Ut,n,e);await Ow(t)}},X_=Object.freeze(Object.defineProperty({__proto__:null,dbService:B},Symbol.toStringTag,{value:"Module"}));class Z_{currentUser=null;listeners=[];constructor(){Zg(Ur,async e=>{if(e)if(e.email==="ginannymoreira@gmail.com")this.currentUser={uid:e.uid,email:e.email,role:"admin"};else try{const t=await B.get("users",e.uid);if(t){const i=t;if(i.companyId){const s=await B.get("companies",i.companyId);if(s&&s.status==="inactive"){await this.logout();const{toast:o}=await _s(async()=>{const{toast:l}=await Promise.resolve().then(()=>Gd);return{toast:l}},void 0);o.error("Seu acesso de cliente foi desativado. Entre em contato com o administrador.");return}}this.currentUser={uid:e.uid,email:e.email,role:i.role,companyId:i.companyId,storeId:i.storeId,storeIds:i.storeIds}}else{console.warn("User authenticated but not found in DB",e.uid),await this.logout();const{toast:i}=await _s(async()=>{const{toast:a}=await Promise.resolve().then(()=>Gd);return{toast:a}},void 0);i.error("Sua conta não foi encontrada ou foi removida."),this.currentUser=null}}catch(t){console.error("Error fetching user profile:",t),this.currentUser=null}else this.currentUser=null;this.notifyListeners()})}async login(e,t){await Yg(Ur,e,t)}async logout(){await ey(Ur)}async registerUser(e,t){const i=Io(Hh,"Secondary"),a=Ju(i);return(await Qg(a,e,t)).user.uid}getCurrentUser(){return this.currentUser}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(t=>t!==e)}}notifyListeners(){this.listeners.forEach(e=>e(this.currentUser))}}const Ae=new Z_,ex=async()=>{const n=Ae.getCurrentUser();let e=!1,t=!1,i=!1,a=!1;if(n&&n.companyId)try{const l=(await B.get("companies",n.companyId))?.modulos_ativos||["atendimento"];l.includes("venda")&&(e=!0),l.includes("agendamento")&&(t=!0),l.includes("disparo")&&(i=!0),l.includes("venda_catalogo")&&(a=!0)}catch(s){console.error("Error fetching company for sidebar:",s)}return a?`
    ...
    `;function M(){const T=fi(Ut,"pedidos"),A=On(T,Vn("empresaId","==",n.companyId));window._ordersUnsubscribe&&window._ordersUnsubscribe();const f=$a(A,x=>{if(e=x.docs.map(g=>({id:g.id,...g.data()})),n.role!=="owner"){const g=n.storeIds||(n.storeId?[n.storeId]:[]);e=e.filter(_=>g.includes(_.lojaId))}e.sort((g,_)=>{const L=(g.criadoEm?.toDate?.()||new Date(g.criadoEm||0)).getTime();return(_.criadoEm?.toDate?.()||new Date(_.criadoEm||0)).getTime()-L});const E=document.getElementById("orders-tbody");E&&(E.innerHTML=b(w(h)),D()),Yd.forEach(g=>{const _=document.getElementById(`count-${g.key}`);if(_){const L=g.key==="todos"?e.length:e.filter(P=>(P.status||"em_montagem").toLowerCase()===g.key).length;_.textContent=L.toString()}})});window._ordersUnsubscribe=f,document.querySelectorAll("#orders-filter-bar .filter-btn").forEach(x=>{x.addEventListener("click",()=>{document.querySelectorAll("#orders-filter-bar .filter-btn").forEach(g=>g.classList.remove("active")),x.classList.add("active"),h=x.dataset.filter||"todos";const E=document.getElementById("orders-tbody");E&&(E.innerHTML=b(w(h))),D()})}),D();const m=document.getElementById("order-detail-modal");m?.addEventListener("click",x=>{x.target===m&&m.classList.add("hidden")}),document.getElementById("orders-filter-bar")?.parentElement?.parentElement?.addEventListener("click",async x=>{const E=x.target.closest(".view-comprovante-btn");if(E){x.preventDefault(),x.stopPropagation();const g=E.dataset.path;if(!g)return;const _=E.innerHTML;E.disabled=!0,E.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{let L=g;if(!g.startsWith("http")){const P=un(pn,g);L=await oi(P)}window.open(L,"_blank")}catch(L){console.error("Erro ao abrir comprovante:",L),V.error("Não foi possível carregar o comprovante do storage.")}finally{E.disabled=!1,E.innerHTML=_}}})}function D(){document.querySelectorAll(".action-btn.view").forEach(T=>{T.addEventListener("click",()=>{const A=T.dataset.id,f=e.find(m=>m.id===A);f&&v(f)})})}async function v(T){const A=document.getElementById("order-detail-modal"),f=document.getElementById("order-modal-inner");if(!A||!f)return;!T.itens&&Array.isArray(T.items)&&(T.itens=T.items.map(Z=>({item:Z.item||Z.name||"",quantidade:Z.quantidade||Z.qty||1,preco:Z.preco||Z.price||0,observacao:Z.observacao||""}))),A.classList.remove("hidden"),f.innerHTML=`
        ...
        `;const m=T.clientPhone?T.clientPhone.replace(/\D/g,""):u(T.leadId)||T.leadId,y=T.source==="catalog"||!!T.taxaNome,x=T.empresaId||Ae.getCurrentUser()?.companyId;if(x&&Array.isArray(T.itens))try{const Z=await B.getAll("products",{field:"companyId",operator:"==",value:x});let se=!1;if(T.itens.forEach(ce=>{const le=(ce.item||"").toLowerCase().trim(),pe=Z.find(ye=>(ye.name||"").toLowerCase().trim()===le);if(pe){const ye=pe.promotionalActive&&pe.promotionalPrice||pe.price;(!ce.preco||ce.preco===0)&&(ce.preco=ye,se=!0)}}),se){let ce=0;T.itens.forEach(ye=>{const Oe=parseFloat(ye.preco)||0,Ne=parseInt(ye.quantidade)||1;ce+=Ne*Oe});const le=parseFloat(T.valoresAdicionais)||0,pe=parseFloat(T.taxaAplicada||T.taxaEntrega)||0;T.value=ce+le+pe}}catch(Z){console.error("Error syncing prices with catalog:",Z)}const E=(T.status||"em_montagem").toLowerCase(),g=E==="finalizado"||E==="cancelado",_=c(T.leadId,T.nome||T.leadName),L=l(T.lojaId),P=Array.isArray(T.itens)?T.itens.map((Z,se)=>`
...
Aguardamos você!`},{key:"pagamento_confirmado",label:"Pagamento Confirmado",icon:"fa-credit-card",default:"Olá {{nome_lead}}! 💳 Pagamento confirmado! Seu pedido #{{numero_pedido}} está sendo preparado."},{key:"pedido_pronto",label:"Pedido Pronto (Retirada)",icon:"fa-box",default:"Olá {{nome_lead}}! 📦 Seu pedido #{{numero_pedido}} já está pronto para retirada!"},{key:"saiu_para_entrega",label:"Saiu para Entrega",icon:"fa-truck",default:"🚚 Olá {{nome_lead}}! Seu pedido #{{numero_pedido}} saiu para entrega no endereço: {{endereco_entrega}}"},{key:"pedido_entregue",label:"Pedido Entregue",icon:"fa-flag-checkered",default:"🏁 Olá {{nome_lead}}! Seu pedido #{{numero_pedido}} foi entregue. Obrigado pela preferência!"},{key:"pedido_cancelado",label:"Pedido Cancelado",icon:"fa-xmark",default:"Olá {{nome_lead}}! Seu pedido #{{numero_pedido}} foi cancelado."}],wx=async()=>{const n=Ae.getCurrentUser();if(!n||!n.companyId)return"<p>Acesso negado.</p>";const e=n.companyId,i=await B.getAll("instancias",{field:"empresaId",operator:"==",value:e}),s=await B.get("companies",e);let o=s?.stores||[];if(n.role!=="owner"){const S=n.storeIds||(n.storeId?[n.storeId]:[]);o=o.filter($=>S.includes($.id))}if(o.length===0)return'<p style="padding: 2rem;">Nenhuma loja encontrada para configuração.</p>';let l=o[0].id;const c=()=>`
    ...
    `},iu=async n=>{try{const e=await B.getAll("loja_config",{field:"lojaId",operator:"==",value:n});let t=e[0]?.empresaId,i=null,a=null;if(t&&(i=await B.get("companies",t),i&&(a=i.stores?.find(F=>F.id===n))),!a){const F=await B.getAll("companies");for(const N of F){const z=N.stores?.find(G=>G.id===n);if(z){i=N,a=z;break}}}if(!i||!a)return`
            ...
            `;const o=(i.modulos_ativos||[]).includes("venda_catalogo"),l=await B.getAll("products",{field:"companyId",operator:"==",value:i.id}),c=await B.getAll("categories",{field:"companyId",operator:"==",value:i.id}),u=e[0]||{},h=u.design||{},w=h.primaryColor||"#6366f1",b=h.secondaryColor||"#0f172a",R=h.textColor||"#ffffff",M=h.priceColor||"#ffffff",D=h.logoUrl||"",v=h.pixKey||"",k=(F,N,z)=>{if(typeof document>"u")return;if(document.title=F,[{name:"description",content:N},{property:"og:title",content:F},{property:"og:description",content:N},{property:"og:image",content:z},{property:"og:type",content:"website"},{property:"og:url",content:window.location.href},{name:"twitter:card",content:"summary_large_image"},{name:"twitter:title",content:F},{name:"twitter:description",content:N},{name:"twitter:image",content:z}].forEach(W=>{const te=W.name?`meta[name="${W.name}"]`:`meta[property="${W.property}"]`;let ne=document.querySelector(te);ne||(ne=document.createElement("meta"),W.name&&ne.setAttribute("name",W.name),W.property&&ne.setAttribute("property",W.property),document.head.appendChild(ne)),ne.setAttribute("content",W.content)}),D){let W=document.querySelector("link[rel~='icon']");W||(W=document.createElement("link"),W.rel="icon",document.head.appendChild(W)),W.href=D}},S=a.name||"Catálogo",$=h.metaDescription||`Confira os produtos de ${S} em nosso catálogo digital.`,C=h.logoUrl||window.location.origin+"/logo.png";k(S,$,C),console.log(`[Catalog] Meta tags updated for: ${S}`);let T=h.whatsapp||"";if(!T)try{if(a.instancia_id){const F=await B.get("instancias",a.instancia_id);F?.numero&&(T=F.numero.replace(/\D/g,""))}}catch(F){console.warn("Could not fetch instance details:",F)}const A=!!i.mercadoPagoToken&&u.mercadoPagoActive!==!1,f=l.filter(F=>F.active!==!1&&(F.storeIds?.includes(n)||F.storeId===n)).sort((F,N)=>(F.name||"").localeCompare(N.name||"")),m=f.filter(F=>F.promotionalActive),y=h.themeId||"classico",x=h.bannerUrl||"",E=h.bannerMobileUrl||"",g=c.map(F=>({...F,products:f.filter(N=>N.categoryId===F.id)})).filter(F=>F.products.length>0).sort((F,N)=>(F.name||"").localeCompare(N.name||"")),_=f.filter(F=>!F.categoryId||!c.find(N=>N.id===F.categoryId)),L=F=>F.imageUrl?F.imageUrl:F.imagemPath&&F.downloadToken?`https://firebasestorage.googleapis.com/v0/b/conectacidade-5e46d.firebasestorage.app/o/${encodeURIComponent(F.imagemPath)}?alt=media&token=${F.downloadToken}`:"https://via.placeholder.com/300?text=Sem+Imagem";let P=new Map;try{const F=localStorage.getItem(`cat_cart_${n}`);F&&(P=new Map(JSON.parse(F)))}catch{}const K=u?.bairrosEntrega||[],j=[];K&&Array.isArray(K)&&(K.forEach(F=>{(F.bairros||"").split(",").map(z=>z.trim()).filter(Boolean).forEach(z=>j.push({nome:z,preco:parseFloat(F.preco)||0}))}),j.sort((F,N)=>F.nome.localeCompare(N.nome)));const Q=u?.cupons||[],J=`cat_user_${i.id}`,Z=JSON.parse(localStorage.getItem(J)||"{}");let se=null;const ce=()=>{let F=0;return P.forEach(({product:N,qty:z})=>{const G=N.promotionalActive&&N.promotionalPrice||N.price;F+=G*z}),F},le=()=>window.catDeliveryType==="retirada"?0:window.catTaxaBairro||0,pe=()=>window.catDeliveryType==="retirada"?"Retirada":window.catSelectedBairro?`Entrega (${window.catSelectedBairro})`:"Taxa de Entrega",ye=F=>se?se.tipo==="percent"?F*se.desconto/100:se.desconto:0,Oe=()=>{const F=ce();return F+le()-ye(F)},Ne=()=>{if(P.size===0)return'<p style="text-align:center;color:#94a3b8;padding:20px 0;">Seu carrinho está vazio.</p>';let F="";return P.forEach(({product:N,qty:z},G)=>{const W=N.promotionalActive&&N.promotionalPrice||N.price;F+=`
                ...
                </div>`}),F},ke=()=>{const F=ce(),N=le(),z=ye(F),G=F+N-z;let W="";return P.forEach(({product:te,qty:ne})=>{const be=te.promotionalActive&&te.promotionalPrice||te.price;W+=`<div style="display:flex;justify-content:space-between;font-size:0.88rem;padding:4px 0;"><span>${ne}x ${te.name}</span><span>R$ ${(be*ne).toFixed(2)}</span></div>`}),N>0&&(W+=`<div style="display:flex;justify-content:space-between;font-size:0.85rem;padding:4px 0;color:#94a3b8;"><span><i class="fa-solid fa-truck" style="margin-right:4px;"></i>${pe()}</span><span>+ R$ ${N.toFixed(2)}</span></div>`),z>0&&se&&(W+=`<div style="display:flex;justify-content:space-between;font-size:0.85rem;padding:4px 0;color:#10b981;"><span><i class="fa-solid fa-tag" style="margin-right:4px;"></i>Cupom ${se.codigo}</span><span>- R$ ${z.toFixed(2)}</span></div>`),W+=`<div style="display:flex;justify-content:space-between;font-weight:800;font-size:1rem;border-top:1px solid rgba(255,255,255,0.1);margin-top:8px;padding-top:8px;"><span>Total</span><span style="color:#6366f1;">R$ ${G.toFixed(2)}</span></div>`,W},je={dom:"Domingo",seg:"Segunda-feira",ter:"Terça-feira",qua:"Quarta-feira",qui:"Quinta-feira",sex:"Sexta-feira",sab:"Sábado"},_t=()=>["dom","seg","ter","qua","qui","sex","sab"][new Date().getDay()],ut=F=>{const N=u.horario_funcionamento?.[F]||a.horarios?.[F]||{};return{ativo:N.ativo??N.aberto??F!=="dom",inicio:N.inicio||N.abertura||"08:00",fim:N.fim||N.fechamento||"18:00"}},De=F=>{const N=u.horario_entrega?.[F]||a.horario_entrega?.[F]||{};return console.log(N),{ativo:N.ativo??N.aberto??F!=="dom",inicio:N.inicio||N.abertura||"08:00",fim:N.fim||N.fechamento||"18:00"}},ae=(()=>{const F=_t(),N=De(F);if(!N.ativo)return!1;const z=new Date,G=z.getHours()*60+z.getMinutes(),[W,te]=N.inicio.split(":").map(Number),[ne,be]=N.fim.split(":").map(Number);return G>=W*60+te&&G<=ne*60+be})(),Pe=()=>{const F=_t(),N=ut(F);if(!N.ativo)return!1;const z=new Date,G=z.getHours()*60+z.getMinutes(),[W,te]=N.inicio.split(":").map(Number),[ne,be]=N.fim.split(":").map(Number);return G>=W*60+te&&G<=ne*60+be},Be=()=>{const F=["dom","seg","ter","qua","qui","sex","sab"],N=new Date().getDay(),z=new Date,G=z.getHours()*60+z.getMinutes(),W=F[N],te=ut(W);if(te.ativo){const[ne,be]=te.inicio.split(":").map(Number),He=ne*60+be;if(G<He)return`Hoje às ${te.inicio}`}for(let ne=1;ne<=7;ne++){const be=(N+ne)%7,He=F[be],We=ut(He);if(We.ativo)return ne===1?`Amanhã às ${We.inicio}`:`${je[He]} às ${We.inicio}`}return"em breve"},me=Pe(),rt=()=>{const F=_t(),N=ut(F);if(!N.ativo)return'<span style="color:#ef4444;"><i class="fa-solid fa-door-closed"></i> Fechado no momento</span>';const z=new Date,G=z.getHours()*60+z.getMinutes(),[W,te]=N.inicio.split(":").map(Number),[ne,be]=N.fim.split(":").map(Number),He=W*60+te,We=ne*60+be;return G>=He&&G<=We?`<span style="color:#10b981;"><i class="fa-solid fa-door-open"></i> Aberto agora</span> <span style="opacity:0.6;margin-left:4px;">• Fecha às ${N.fim}</span>`:G<He?`<span style="color:#ef4444;"><i class="fa-solid fa-door-closed"></i> Fechado no momento</span> <span style="opacity:0.6;margin-left:4px;">• Abre às ${N.inicio}</span>`:'<span style="color:#ef4444;"><i class="fa-solid fa-door-closed"></i> Fechado no momento</span>'},fe=()=>{let F="";return["dom","seg","ter","qua","qui","sex","sab"].forEach(N=>{const z=ut(N);z.ativo?F+=`<div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,0.05);"><span style="color:var(--text-muted);">${je[N]}</span><span style="font-weight:600;">${z.inicio} às ${z.fim}</span></div>`:F+=`<div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,0.05);"><span style="color:var(--text-muted);">${je[N]}</span><span style="color:#ef4444;font-size:0.8rem;font-weight:600;">Fechado</span></div>`}),F},ve=()=>{const F=document.getElementById("cart-badge"),N=document.getElementById("cart-total"),z=document.getElementById("cart-items"),G=document.getElementById("cart-float-btn"),W=document.getElementById("cart-total-float"),te=document.getElementById("cart-badge-float");try{localStorage.setItem(`cat_cart_${n}`,JSON.stringify(Array.from(P.entries())))}catch{}let ne=0;P.forEach(({qty:be})=>ne+=be),F&&(F.textContent=ne.toString()),te&&(te.textContent=ne.toString()),G&&(G.style.display=ne>0?"flex":"none"),N&&(N.textContent=`R$ ${Oe().toFixed(2)}`),W&&(W.textContent=`R$ ${Oe().toFixed(2).replace(".",",")}`),z&&(z.innerHTML=Ne())};window.openStoreInfo=()=>it("store-info-modal"),window.closeStoreInfo=()=>qe("store-info-modal"),window.catInit=()=>{const F=document.getElementById("checkout-name"),N=document.getElementById("checkout-phone"),z=document.getElementById("checkout-address");F&&Z.name&&(F.value=Z.name),N&&Z.phone&&(N.value=Z.phone),z&&Z.address&&(z.value=Z.address),N&&N.addEventListener("input",G=>{let W=G.target.value.replace(/\D/g,"");W.length>11&&(W=W.slice(0,11)),G.target.value=W})},setTimeout(()=>window.catInit(),500);const it=F=>{const N=document.getElementById(F);N&&(N.style.display="flex")},qe=F=>{const N=document.getElementById(F);N&&(N.style.display="none")};if(o){window.showClosedAlert=N=>{const z=document.getElementById("closed-alert-title"),G=document.getElementById("closed-alert-desc"),W=document.getElementById("closed-alert-time-section"),te=document.getElementById("next-open-time"),ne=document.getElementById("closed-alert-icon");N==="store"?(z&&(z.textContent="Loja Fechada"),G&&(G.textContent="No momento não estamos aceitando pedidos."),W&&(W.style.display="block"),te&&(te.textContent=Be()),ne&&(ne.className="fa-solid fa-store-slash")):N==="delivery"&&(z&&(z.textContent="Entrega Desativada"),G&&(G.textContent="O serviço de entrega está desativado no momento. Por favor, escolha a opção de Retirada se disponível."),W&&(W.style.display="none"),ne&&(ne.className="fa-solid fa-motorcycle")),it("closed-alert-modal")},window.catAddToCart=N=>{const z=f.find(ne=>ne.id===N);if(!z||z.stock===0)return;const G=P.get(N),W=z.stock??1/0;if((G?.qty||0)>=W){alert(`Estoque máximo atingido (${z.stock} un.)`);return}P.set(N,{product:z,qty:(G?.qty||0)+1}),ve();const te=document.getElementById(`btn-add-${N}`);te&&(te.textContent="✓ Adicionado",setTimeout(()=>{te&&(te.textContent="+ Adicionar")},1e3))},window.catQtyChange=(N,z)=>{const G=P.get(N);if(!G)return;const W=G.qty+z;W<=0?P.delete(N):G.qty=Math.min(W,G.product.stock??1/0),ve()},window.catRemoveItem=N=>{P.delete(N),ve()},window.openCart=()=>{ve(),it("cart-modal")},window.closeCart=()=>qe("cart-modal"),window.goToDelivery=async()=>{if(P.size===0)return;if(!me){window.showClosedAlert("store");return}const N=document.getElementById("btn-go-delivery");N&&(N.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Verificando...');let z=!1;for(const[G,{product:W,qty:te}]of Array.from(P.entries()))try{const ne=await B.get("products",G);if(!ne||ne.active===!1||ne.stock!=null&&ne.stock<te){z=!0,alert(`O produto "${W.name}" não possui quantidade suficiente em estoque ou está indisponível.`);break}}catch{}N&&(N.innerHTML='<i class="fa-solid fa-arrow-right"></i> Finalizar Pedido'),!z&&(qe("cart-modal"),it("delivery-modal"))},window.closeDelivery=()=>qe("delivery-modal"),window.selectDelivery=N=>{window.catDeliveryType=N,document.querySelectorAll(".delivery-card").forEach(W=>{W.style.borderColor="rgba(255,255,255,0.1)",W.style.background="transparent"});const z=document.getElementById(`delivery-card-${N}`);z&&(z.style.borderColor="#6366f1",z.style.background="rgba(99,102,241,0.08)");const G=document.getElementById("btn-go-customer");G&&(G.disabled=!1,G.style.opacity="1",G.style.cursor="pointer")},window.goToCustomer=()=>{const N=window.catDeliveryType;if(!N)return;if(N==="entrega"&&!ae){window.showClosedAlert("delivery");return}qe("delivery-modal");const z=document.getElementById("address-group");z&&(z.style.display=N==="entrega"?"block":"none"),it("customer-modal")},window.closeCustomer=()=>qe("customer-modal"),window.catFilterBairros=N=>{const z=document.getElementById("checkout-bairro-dropdown");if(!z)return;const G=N?j.filter(W=>W.nome.toLowerCase().includes(N.toLowerCase())):j;G.length===0?z.innerHTML='<div style="padding:12px;color:#ef4444;font-size:0.85rem;">Nenhum bairro encontrado</div>':z.innerHTML=G.map(W=>`<div onclick="window.catSelectBairro('${W.nome.replace(/'/g,"\\'")}', ${W.preco})" style="padding:12px;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.05);color:white;font-size:0.9rem;">${W.nome} - R$ ${W.preco.toFixed(2)}</div>`).join(""),z.style.display="block"},window.catSelectBairro=(N,z)=>{const G=document.getElementById("checkout-bairro");G&&(G.value=N,G.dataset.preco=z.toString());const W=document.getElementById("checkout-bairro-dropdown");W&&(W.style.display="none")},document.addEventListener("click",N=>{if(!N.target.closest("#bairro-input-wrapper")){const z=document.getElementById("checkout-bairro-dropdown");z&&(z.style.display="none")}}),window.goToPayment=()=>{const N=document.getElementById("checkout-name")?.value.trim(),z=document.getElementById("checkout-phone")?.value.trim(),G=document.getElementById("checkout-address")?.value.trim(),W=window.catDeliveryType;let te="",ne=0;if(W==="entrega"&&j.length>0){const gt=document.getElementById("checkout-bairro");if(!gt||!gt.value.trim()){alert("Selecione ou digite seu bairro para entrega.");return}te=gt.value.trim();const Re=j.find(Fe=>Fe.nome.toLowerCase()===te.toLowerCase());if(!Re){alert("Bairro selecionado não encontrado na lista. Por favor, escolha uma opção listada.");return}te=Re.nome,ne=Re.preco}if(!N||!z){alert("Preencha nome e telefone.");return}if(z.length<10){alert("Telefone inválido. Use o formato DD000000000");return}if(W==="entrega"&&!G){alert("Preencha o endereço de entrega completo.");return}window.catSelectedBairro=te,window.catTaxaBairro=ne;const be={name:N,phone:z,address:G||"",bairro:te};window.catCustomer=be,localStorage.setItem(J,JSON.stringify(be)),qe("customer-modal");const He=document.getElementById("payment-order-summary");He&&(He.innerHTML=ke());const We=document.getElementById("cat-coupon-section");We&&(We.style.display=Q.length>0?"block":"none");const Et=document.getElementById("btn-pay-delivery"),kt=document.getElementById("btn-pay-pix-manual"),Pt=document.getElementById("btn-pay-pix-mp"),Te=document.getElementById("mandatory-pay-msg"),Mt=u?.pagamentoObrigatorioRetirada===!0;Et&&(W==="retirada"&&Mt?Et.style.display="none":Et.style.display="flex"),Te&&(Te.style.display=W==="retirada"&&Mt?"block":"none"),kt&&(kt.style.display=v?"flex":"none"),Pt&&(Pt.style.display=A?"flex":"none"),it("payment-modal")},window.closePayment=()=>qe("payment-modal"),window.catApplyCoupon=()=>{const N=(document.getElementById("cat-coupon-input")?.value||"").trim().toUpperCase(),z=Q.find(be=>be.codigo===N&&be.ativo!==!1),G=ce(),W=document.getElementById("cat-coupon-msg");if(!z){W&&(W.textContent="Cupom inválido ou expirado.",W.style.color="#ef4444");return}if(z.valorMinimo>0&&G<z.valorMinimo){W&&(W.textContent=`Gasto mínimo de R$ ${z.valorMinimo.toFixed(2)} necessário.`,W.style.color="#ef4444");return}se=z;const te=ye(G);W&&(W.textContent=`✓ Cupom aplicado! Desconto: R$ ${te.toFixed(2)}`,W.style.color="#10b981");const ne=document.getElementById("payment-order-summary");ne&&(ne.innerHTML=ke())},window.catToggleCoupon=()=>{const N=document.getElementById("cat-coupon-input-wrapper"),z=document.getElementById("cat-coupon-toggle-label");if(N){const G=N.style.display==="block";N.style.display=G?"none":"block",z&&(z.textContent=G?"Tenho um cupom de desconto":"Ocultar cupom")}},window.catFilterClassic=N=>{document.querySelectorAll(".cat-selector-item").forEach(G=>{const W=G.getAttribute("onclick")||"";G.classList.toggle("active",W.includes("'"+N+"'"))});const z=document.getElementById("classic-promo-section");N==="all"?(z&&(z.style.display=m.length>0?"block":"none"),document.querySelectorAll("[data-classic-cat]").forEach(G=>G.style.display="block")):N==="promo"?(z&&(z.style.display="block"),document.querySelectorAll("[data-classic-cat]").forEach(G=>G.style.display="none")):(z&&(z.style.display="none"),document.querySelectorAll("[data-classic-cat]").forEach(G=>{G.style.display=G.dataset.classicCat===N?"block":"none"}))},window.catFilterCat=N=>{document.querySelectorAll(".cat-sidebar-link").forEach(W=>{W.classList.remove("active"),W.setAttribute("aria-pressed","false")});const z=document.querySelector(`.cat-sidebar-link[onclick*="'${N}'"]`);z&&(z.classList.add("active"),z.setAttribute("aria-pressed","true"));const G=N==="all";document.querySelectorAll("[data-catgroup]").forEach(W=>{W.style.display=G||W.dataset.catgroup===N?"":"none"})},window.catSearch=N=>{N=N.trim().toLowerCase(),document.querySelectorAll("[data-catgroup]").forEach(z=>{z.style.display=""}),N&&document.querySelectorAll(".product-card").forEach(z=>{const G=(z.querySelector("h3")?.textContent||"").toLowerCase();z.style.display=G.includes(N)?"":"none"})};const F=async(N,z)=>{const G=z.replace(/\D/g,"");let te=(await B.getAll("leads",[{field:"empresaId",operator:"==",value:i.id},{field:"whatsapp",operator:"==",value:G}]))[0];return te||(te=(await B.getAll("leads",[{field:"empresaId",operator:"==",value:i.id},{field:"telefone",operator:"==",value:G}]))[0]),te?(te.statusLead!=="cliente_ativo"&&await B.update("leads",te.id,{statusLead:"cliente_ativo"}),te.id):await B.create("leads",{nome:N,telefone:G,whatsapp:G,empresaId:i.id,lojaId:n,origem:"catalogo",statusLead:"cliente_ativo",criadoEm:new Date().toISOString()})};window.confirmOrderDelivery=async()=>{const N=document.getElementById("btn-pay-delivery");N&&(N.disabled=!0,N.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Processando...');try{const z=window.catCustomer;if(!z||!z.phone){alert("Seus dados de contato não foram salvos ou foram perdidos. Por favor, preencha novamente."),qe("payment-modal"),qe("pix-manual-modal"),it("customer-modal");return}const{name:G,phone:W,address:te}=z,ne=window.catDeliveryType,be=Array.from(P.entries()).map(([ze,{product:Ce,qty:lt}])=>{const It=Ce.promotionalActive&&Ce.promotionalPrice||Ce.price;return{productId:ze,name:Ce.name,qty:lt,price:It,subtotal:It*lt}});for(const[ze,{qty:Ce}]of Array.from(P.entries())){const lt=f.find(It=>It.id===ze);lt&&lt.stock!=null&&await B.update("products",ze,{stock:Math.max(0,lt.stock-Ce)})}const He=ce(),We=le(),Et=ye(He),kt=He+We-Et,Pt=await F(G,W),Te={lojaId:n,storeId:n,companyId:i.id,empresaId:i.id,clientName:G,clientPhone:W,endereco:te,entrega:ne,leadId:Pt,nome:G,items:be,total:kt,taxaAplicada:We,taxaNome:pe(),desconto:Et,codigoCupom:se?.codigo||null,paymentMethod:"na_entrega",pagamento:"na_entrega",status:"em_montagem",source:"catalog",criadoEm:new Date().toISOString()},Mt=await B.create("pedidos",Te);try{const{orderService:ze}=await _s(async()=>{const{orderService:Ce}=await Promise.resolve().then(()=>lx);return{orderService:Ce}},void 0);await ze.notifyNewOrder({id:Mt,...Te},i.id)}catch(ze){console.error("Error in order notification:",ze)}P.clear(),se=null,qe("payment-modal"),ve();const gt=document.getElementById("confirmation-modal"),Re=document.getElementById("order-id-display"),Fe=document.getElementById("pix-info-section");gt&&(gt.style.display="flex"),Re&&(Re.textContent=Mt.slice(0,8).toUpperCase()),Fe&&(Fe.style.display="none"),ve()}catch(z){console.error("Confirm Order Delivery Error:",z),alert("Erro ao processar pedido: "+(z.message||"Erro desconhecido")+". Por favor, tente novamente ou fale com a loja."),N&&(N.disabled=!1,N.innerHTML="🤝 Pagar na Entrega / Retirada")}},window.showPixManual=()=>{qe("payment-modal");const N=document.getElementById("pix-manual-summary");N&&(N.innerHTML=ke());const z=document.getElementById("pix-key-value");z&&(z.textContent=v),it("pix-manual-modal")},window.closePixManual=()=>qe("pix-manual-modal"),window.copyPixKey=()=>{navigator.clipboard.writeText(v).then(()=>{const N=document.getElementById("btn-copy-pix");N&&(N.textContent="✓ Copiado!",setTimeout(()=>{N.textContent="Copiar"},2e3))})},window.confirmPixManual=async()=>{const N=document.getElementById("btn-confirm-pix-manual");N&&(N.disabled=!0,N.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Confirmando...');try{const z=window.catCustomer;if(!z||!z.phone){alert("Seus dados de contato não foram salvos ou foram perdidos. Por favor, preencha novamente."),qe("payment-modal"),qe("pix-manual-modal"),it("customer-modal");return}const{name:G,phone:W,address:te}=z,ne=window.catDeliveryType,be=Array.from(P.entries()).map(([Ce,{product:lt,qty:It}])=>{const Ot=lt.promotionalActive&&lt.promotionalPrice||lt.price;return{productId:Ce,name:lt.name,qty:It,price:Ot,subtotal:Ot*It}});let He="";const We=document.getElementById("pix-comprovante-input");if(We?.files?.[0]){const Ce=We.files[0],lt=Date.now(),It=`comprovantes/${i.id}/${lt}_${Ce.name}`,Ot=un(pn,It);await Ni(Ot,Ce),He=await oi(Ot)}for(const[Ce,{qty:lt}]of Array.from(P.entries())){const It=f.find(Ot=>Ot.id===Ce);It&&It.stock!=null&&await B.update("products",Ce,{stock:Math.max(0,It.stock-lt)})}const Et=ce(),kt=le(),Pt=ye(Et),Te=Et+kt-Pt,Mt=await F(G,W),gt=await B.create("pedidos",{lojaId:n,storeId:n,companyId:i.id,empresaId:i.id,clientName:G,clientPhone:W,endereco:te,entrega:ne,leadId:Mt,nome:G,items:be,total:Te,taxaAplicada:kt,taxaNome:pe(),desconto:Pt,codigoCupom:se?.codigo||null,paymentMethod:"pix_manual",pagamento:"pagamento_no_pix",comprovanteUrl:He,status:"em_montagem",source:"catalog",criadoEm:new Date().toISOString()});P.clear(),se=null,qe("pix-manual-modal"),ve();const Re=document.getElementById("confirmation-modal"),Fe=document.getElementById("order-id-display");Re&&(Re.style.display="flex"),Fe&&(Fe.textContent=gt.slice(0,8).toUpperCase());const ze=document.getElementById("pix-info-section");ze&&(ze.style.display="none"),ve()}catch(z){console.error("Confirm Pix Manual Error:",z),alert("Erro ao confirmar pedido: "+(z.message||"Erro de conexão/permissão")+". Tente novamente."),N&&(N.disabled=!1,N.innerHTML='<i class="fa-solid fa-check"></i> Confirmar Pagamento PIX')}},window.confirmPixMercadoPago=async()=>{const N=document.getElementById("btn-pay-pix-mp");N&&(N.disabled=!0,N.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Gerando PIX...');try{const{name:z,phone:G,address:W}=window.catCustomer,te=window.catDeliveryType,ne=Array.from(P.entries()).map(([Re,{product:Fe,qty:ze}])=>{const Ce=Fe.promotionalActive&&Fe.promotionalPrice||Fe.price;return{productId:Re,name:Fe.name,qty:ze,price:Ce,subtotal:Ce*ze}}),be=ce(),He=le(),We=ye(be),Et=be+He-We,Pt=await fetch("https://n8n.vps.pequi.digital/webhook/autoqui-pix-catalog",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({companyId:i.id,storeId:n,items:ne,total:Et,clientName:z,clientPhone:G,accessToken:i.mercadoPagoToken})}),Te=Pt.ok?await Pt.json():null;for(const[Re,{qty:Fe}]of Array.from(P.entries())){const ze=f.find(Ce=>Ce.id===Re);ze&&ze.stock!=null&&await B.update("products",Re,{stock:Math.max(0,ze.stock-Fe)})}const Mt=await F(z,G),gt=await B.create("pedidos",{lojaId:n,storeId:n,companyId:i.id,empresaId:i.id,clientName:z,clientPhone:G,endereco:W,entrega:te,leadId:Mt,nome:z,items:ne,total:Et,taxaAplicada:He,taxaNome:pe(),desconto:We,codigoCupom:se?.codigo||null,paymentMethod:"pix_mercadopago",pagamento:"pagamento_no_pix",mpPaymentId:Te?.payment_id||"",status:"em_montagem",source:"catalog",criadoEm:new Date().toISOString()});if(P.clear(),se=null,qe("payment-modal"),ve(),Te?.qr_code_base64||Te?.qr_code_text){const Re=document.getElementById("mp-qr-img"),Fe=document.getElementById("mp-qr-code"),ze=document.getElementById("mp-pix-summary");Re&&Te.qr_code_base64&&(Re.src=`data:image/png;base64,${Te.qr_code_base64}`,Re.style.display="block"),Fe&&Te.qr_code_text&&(Fe.textContent=Te.qr_code_text,window._mpQrCodeText=Te.qr_code_text),ze&&(ze.innerHTML=ke()),it("mp-pix-modal")}else{const Re=document.getElementById("confirmation-modal"),Fe=document.getElementById("order-id-display");Re&&(Re.style.display="flex"),Fe&&(Fe.textContent=gt.slice(0,8).toUpperCase())}ve()}catch(z){console.error("Confirm Pix MP Error:",z),alert("Erro ao gerar PIX Mercado Pago: "+(z.message||"Erro de resposta")+". Tente novamente."),N&&(N.disabled=!1,N.innerHTML="⚡ Pagar via Mercado Pago (PIX)")}},window.closeMpPix=()=>qe("mp-pix-modal"),window.copyMpQrCode=()=>{const N=window._mpQrCodeText||"";navigator.clipboard.writeText(N).then(()=>{const z=document.getElementById("btn-copy-mp-qr");z&&(z.textContent="✓ Copiado!",setTimeout(()=>{z.textContent="Copiar código"},2e3))})},window.previewComprovante=N=>{const z=document.getElementById("comprovante-preview"),G=document.getElementById("comprovante-label");if(N.files?.[0]){const W=new FileReader;W.onload=te=>{z&&(z.src=te.target?.result,z.style.display="block"),G&&(G.textContent=N.files[0].name)},W.readAsDataURL(N.files[0])}}}const xt=(F,N=!1)=>{const z=N&&F.promotionalName||F.name,G=N&&F.promotionalPrice||F.price,W=N?F.price:null,te=F.stock===0;return o?`
                <div class="product-card" style="${te?"opacity:0.6;":""}">
                    <div class="card-image">
                        <img src="${L(F)}" alt="${z}" loading="lazy">
                ...
                </div>`},ot="display:none;position:fixed;inset:0;z-index:9000;background:rgba(0,0,0,0.75);align-items:center;justify-content:center;backdrop-filter:blur(4px);color:white;",Ze="background:#1e293b;border-radius:24px;width:92%;max-width:460px;padding:28px;",Gt=(F,N)=>`
            ...
            </div>`,Jn=(F,N,z,G="")=>`<button id="${F}" onclick="${N}" style="width:100%;padding:14px;border-radius:14px;background:#6366f1;color:white;border:none;cursor:pointer;font-weight:700;font-size:1rem;${G}">${z}</button>`,Gi=o?`
            <!-- CART MODAL -->
            ...
            <div class="catalog-body">
                ...
                ${y==="banner"?`
                    ...
                    <main class="section-container" style="padding-top:20px;">
                        ${m.length>0?`<div class="section-title"><i class="fa-solid fa-bolt-lightning" aria-hidden="true"></i><span>Ofertas do Dia</span><div class="line"></div></div><div class="product-grid" role="list">${m.map(F=>xt(F,!0)).join("")}</div>`:""}
                        ${g.map(F=>`<div class="section-title"><i class="fa-solid ${F.icon||"fa-tag"}" aria-hidden="true"></i><span>${F.name}</span><div class="line"></div></div><div class="product-grid" role="list">${F.products.map(N=>xt(N,!1)).join("")}</div>`).join("")}
                        ${_.length>0?`<div class="section-title"><i class="fa-solid fa-box" aria-hidden="true"></i><span>Outros</span><div class="line"></div></div><div class="product-grid" role="list">${_.map(F=>xt(F,!1)).join("")}</div>`:""}
                    ...
                    <div class="cat-modern-layout" style="padding-top:20px;">
                        <aside class="cat-sidebar-sticky" style="position:sticky;top:20px;height:fit-content;" aria-label="Categorias">
                            ...
                            <nav class="cat-sidebar">
                                ...
                                ${g.map(F=>`<button class="cat-sidebar-link" onclick="window.catFilterCat('${F.id}')"><i class="fa-solid ${F.icon||"fa-tag"}" aria-hidden="true"></i> ${F.name}</button>`).join("")}
                        ...
                        <div>
                            <div id="cat-moderno-content">
                                ${m.length>0?`<div class="section-title" data-catgroup="promo"><i class="fa-solid fa-bolt-lightning" aria-hidden="true"></i><span>Ofertas do Dia</span><div class="line"></div></div><div class="product-grid" data-catgroup="promo" role="list">${m.map(F=>xt(F,!0)).join("")}</div>`:""}
                                ${g.map(F=>`<div class="section-title" data-catgroup="${F.id}"><i class="fa-solid ${F.icon||"fa-tag"}" aria-hidden="true"></i><span>${F.name}</span><div class="line"></div></div><div class="product-grid" data-catgroup="${F.id}" role="list">${F.products.map(N=>xt(N,!1)).join("")}</div>`).join("")}
                                ${_.length>0?`<div class="section-title" data-catgroup="outros"><i class="fa-solid fa-box" aria-hidden="true"></i><span>Outros</span><div class="line"></div></div><div class="product-grid" data-catgroup="outros" role="list">${_.map(F=>xt(F,!1)).join("")}</div>`:""}
                ...
                `:`
                    ...
                    <main class="section-container">
                        ...
                        <div id="classic-promo-section" style="${m.length>0?"":"display:none;"}">
                            ...
                            <div class="product-grid" role="list">${m.map(F=>xt(F,!0)).join("")}</div>
                        </div>
                        ...
                        <div id="classic-categories-container">
                            ${g.map(F=>`
                                <div class="section-container-cat" data-classic-cat="${F.id}">
                                    ...
                                    <div class="product-grid" role="list">${F.products.map(N=>xt(N,!1)).join("")}</div>
                                </div>
                            `).join("")}
                            ${_.length>0?`
                                <div class="section-container-cat" data-classic-cat="outros">
                                    ...
                                    <div class="product-grid" role="list">${_.map(F=>xt(F,!1)).join("")}</div>
                                </div>
                            `:""}
                        </div>
        ...
        `}catch(e){return console.error("Catalog Error:",e),"<p>Erro ao carregar catálogo.</p>"}},au=async n=>(setTimeout(()=>{const e=document.getElementById("remote-qrcode"),t=document.getElementById("qr-content-active"),i=document.getElementById("qr-content-success");if(!e)return;let a=null,s=null;const o=()=>{a&&clearInterval(a),s&&clearInterval(s)},l=async()=>{try{const b=await(await fetch(`${Ft}/instance/connect/${n}`,{headers:{apikey:zt}})).json();if(b&&(b.base64||b.qrcode?.base64)){const R=b.base64||b.qrcode.base64;e.innerHTML=`<img src="${R}" style="width: 250px; height: 250px; display: block; border-radius: 8px;">`}else{const M=await(await fetch(`${Ft}/instance/connectionState/${n}`,{headers:{apikey:zt}})).json();(M.instance?.state==="open"||M.state==="open")&&u()}}catch(w){console.error("Error fetching QR:",w)}},c=async()=>{try{const b=await(await fetch(`${Ft}/instance/connectionState/${n}`,{headers:{apikey:zt}})).json();(b.instance?.state==="open"||b.state==="open")&&u()}catch(w){console.error("Error checking status:",w)}},u=()=>{o(),t&&(t.style.display="none"),i&&(i.style.display="flex")};l(),a=setInterval(l,4e4),s=setInterval(c,3e3);const h=setInterval(()=>{document.getElementById("remote-qrcode")||(o(),clearInterval(h))},1e3)},100),`
        <style>
            @import url('https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600;700&display=swap');
